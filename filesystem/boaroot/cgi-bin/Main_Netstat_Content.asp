...
<title><%tcWebApi_get("String_Entry","Network_Tools","s")%> - Netstat</title>
...
function hideCNT(obj){
	if(obj.value == "netstat-nat"){		
		...
		$("cmdDesc").innerHTML = "<%tcWebApi_get("String_Entry","NetworkTools_Info","s")%>";	
...
<form method="GET" name="form" action="Main_Netstat_Content.asp" target="hidden_frame"> 
						...
						<table width="760px" border="0" cellpadding="5" cellspacing="0" bordercolor="#6b8fa3"  class="FormTitle" id="FormTitle">		
							<tr>
								<td bgcolor="#4D595D" colspan="3" valign="top">
									<div>&nbsp;</div>
									<div class="formfonttitle"><%tcWebApi_get("String_Entry","Network_Tools","s")%> - Netstat</div>
									<div style="margin-left:5px;margin-top:10px;margin-bottom:10px"><img src="/images/New_ui/export/line_export.png"></div>
									<div class="formfontdesc" id="cmdDesc"><%tcWebApi_get("String_Entry","NetworkTools_Info","s")%></div>
									<table width="100%" border="1" align="center" cellpadding="4" cellspacing="0" bordercolor="#6b8fa3" class="FormTable">
										<tr>
											<th width="20%"><%tcWebApi_get("String_Entry","NetworkTools_Method","s")%></th>
											<td>
										...
										<tr>
													<!-- client info -->
											<th width="20%"><%tcWebApi_get("String_Entry","NetworkTools_option","s")%></th>
											<td>
										...
										<tr id="ExtOption_tr" style="display:none;">
											<th width="20%"><%tcWebApi_get("String_Entry","NetworkTools_extended_option","s")%></th>
											<td>
										...
										<tr id = "resolvename" style="">
											<th width="20%"><%tcWebApi_get("String_Entry","NetworkTools_ResolveName","s")%></th>
											<td>
									...
									<div style="margin-top:8px" id="logArea">
										<textarea cols="63" rows="27" wrap="off" readonly="readonly" id="textarea" style="width:99%;font-family:Courier New, Courier, mono; font-size:13px;background:#475A5F;color:#FFFFFF;"><% nvram_dump("syscmd.log","syscmd.sh"); %></textarea>
									</div>
								</td>
							</tr>
						</table>
