...
<title>ASUS <%tcWebApi_get("String_Entry","Web_Title2","s")%> <% tcWebApi_staticGet("SysInfo_Entry","ProductTitle","s") %> - <%tcWebApi_get("String_Entry","traffic_monitor","s")%> : <%tcWebApi_get("String_Entry","menu4_2_2","s")%></title>
...
var ref = new TomatoRefresh('updateBandwidth.asp', 'output=bandwidth&arg0=speed');
...
//		E('rbusy').style.display = '';
	...
	ref.initX();
	document.getElementById("faq0").href = "http://www.asus.com/support/Search-Result-Detail/69B50762-C9C0-15F1-A5B8-C7B652F50ACF/?keyword=ASUSWRT%20Traffic%20Monitor" ;
}
	      		...
	      		<tr>
     						...
     						<div align="right">
			    				<select onchange="switchPage(this.options[this.selectedIndex].value)" class="input_option" style="margin-top:8px;">
									<!--option><%tcWebApi_get("String_Entry","switchpage","s")%></option-->
											...
											<option value="2" selected><%tcWebApi_get("String_Entry","menu4_2_2","s")%></option>
        			...
        			<tr>
          				<td height="30" align="left" valign="middle" >
							<div class="formfontcontent"><p class="formfontcontent"><%tcWebApi_get("String_Entry","traffic_monitor_desc1","s")%></p></div>
          				</td>
        			</tr>
        			<tr>
        			...
        			<tr>
          				<td height="30" align="left" valign="middle" >
							<div class="formfontcontent"><p><%tcWebApi_get("String_Entry","traffic_monitor_desc2","s")%></p></div>
							<div class="formfontcontent"><p><a id="faq0" href="" target="_blank" style="font-weight: bolder;text-decoration:underline;"><% tcWebApi_Get("String_Entry", "traffic_monitor", "s") %> FAQ</a></p></div>
          				</td>
        			</tr>
						...
						<td>
				    	 	<table width="735px"   border="1" align="center" cellpadding="4" cellspacing="0" bordercolor="#6b8fa3" class="FormTable_NWM" style="margin-top:10px">
						  		<tr>
						  			...
						  			<th style="text-align:center;width:160px;height:25px;"><%tcWebApi_get("String_Entry","Current","s")%></th>
						  			<th style="text-align:center;width:160px;height:25px;"><%tcWebApi_get("String_Entry","Average","s")%></th>
						  			<th style="text-align:center;width:160px;height:25px;"><%tcWebApi_get("String_Entry","Maximum","s")%></th>
						  			<th style="text-align:center;width:160px;height:25px;"><%tcWebApi_get("String_Entry","Total","s")%></th>
						  		</tr>
						  		<tr>
						  			<!--td style="text-align:center; background-color:#111;">
										<div id='rx-sel'><%tcWebApi_get("String_Entry","tm_reception","s")%></div>
						  			</td-->
						    	...
						    	<tr>
						    		<!--td style="text-align:center; background-color:#111;">
										<div id='tx-sel'><%tcWebApi_get("String_Entry","tm_transmission","s")%></div>
						    		</td-->
