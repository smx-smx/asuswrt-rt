...
// huan shiou add no LARGE_INTEGER
//#define LARGE_INTEGER	unsigned int //conflict with tr_config.h,marked by hqfeng,2006.09.11
#if 0
...
//typedef  unsigned char  BOOL;//marked by hqfeng,2006.04.18
...
void
ixmlNode_free_new( IN IXML_Node * nodeptr );
...
ixmlDocument_free(IXML_Document* doc  
 ...
 void
ixmlDocument_free_new( IN IXML_Document * doc );
