...
function hideCNT(_val){
	if(_val == "ping"){
		...
		$("cmdDesc").innerHTML = "<%tcWebApi_get("String_Entry","NetworkTools_Ping","s")%>";
	}
...
<form method="GET" name="form" action="Main_Analysis_Content.asp" target="hidden_frame"> 
						...
						<table width="760px" border="0" cellpadding="5" cellspacing="0" bordercolor="#6b8fa3"  class="FormTitle" id="FormTitle">		
							<tr>
								<td bgcolor="#4D595D" colspan="3" valign="top">
									<div>&nbsp;</div>
									<div class="formfonttitle"><%tcWebApi_get("String_Entry","Network_Tools","s")%> - <%tcWebApi_get("String_Entry","Network_Analysis","s")%></div>
									<div style="margin-left:5px;margin-top:10px;margin-bottom:10px"><img src="/images/New_ui/export/line_export.png"></div>
									<div class="formfontdesc" id="cmdDesc"><%tcWebApi_get("String_Entry","NetworkTools_Ping","s")%></div>
		              			...
		              			<input type="text" name="pingCNT" class="input_3_table" maxlength="2" value="" onKeyPress="return validator.isNumber(this, event);" placeholder="5">
									...
									<div class="apply_gen">
										<span><input class="button_gen_long" id="cmdBtn" onClick="onSubmitCtrl(this, ' Refresh ')" type="button" value="<%tcWebApi_get("String_Entry","NetworkTools_Diagnose_btn","s")%>"></span>
