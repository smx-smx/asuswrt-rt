...
<title>ASUS <%tcWebApi_get("String_Entry","Web_Title2","s")%> <% tcWebApi_staticGet("SysInfo_Entry","ProductTitle","s") %> - VPN Status</title>
	...
	<!--===================================Beginning of Main Content===========================================-->
		...
		<td valign="top">
			...
			<td valign="top">
				...
				<div class="formfontdesc">This page shows the status of VPN connections.</div>
				...
				<table width="100%" border="1" align="center" cellpadding="4" cellspacing="0" bordercolor="#6b8fa3"  class="FormTable" style="display:none">
					<thead>
						<tr>
				...
				<div class="apply_gen">
					<input name="button" type="button" class="button_gen" onclick="applyRule();" value='<%tcWebApi_get("String_Entry", "CTL_refresh", "s")%>'/>
				</div>
			</td>
			</tr>
			</tbody>
