...
<title>ASUS <%tcWebApi_get("String_Entry","Web_Title2","s")%> <% tcWebApi_staticGet("SysInfo_Entry","ProductTitle","s") %> - Blocking Page</title>  
...
var block_domain = '<% get_parameter("domain"); %>';
...
*/
var category_info = [["Parental Controls", "1", "<%tcWebApi_get("String_Entry","AiProtection_filter_Adult","s")%>", "<%tcWebApi_get("String_Entry","AiProtection_filter_Adult1","s")%>", "Sites with profane or vulgar content generally considered inappropriate for minors; includes sites that offer erotic content or ads for sexual services, but excludes sites with sexually explicit images."],
				     ["Parental Controls", "2", "<%tcWebApi_get("String_Entry","AiProtection_filter_Adult","s")%>", "<%tcWebApi_get("String_Entry","AiProtection_filter_Adult1","s")%>", "Sites that provide information about or software for sharing and transferring files related to child pornography."],
				     ["Parental Controls", "3", "<%tcWebApi_get("String_Entry","AiProtection_filter_Adult","s")%>", "<%tcWebApi_get("String_Entry","AiProtection_filter_Adult1","s")%>", "Sites with sexually explicit imagery designed for sexual arousal, including sites that offer sexual services."],
				     ["Parental Controls", "4", "<%tcWebApi_get("String_Entry","AiProtection_filter_Adult","s")%>", "<%tcWebApi_get("String_Entry","AiProtection_filter_Adult1","s")%>", "Sites with or without explicit images that discuss reproduction, sexuality, birth control, sexually transmitted disease, safe sex, or coping with sexual trauma."],
				     ["Parental Controls", "5", "<%tcWebApi_get("String_Entry","AiProtection_filter_Adult","s")%>", "<%tcWebApi_get("String_Entry","AiProtection_filter_Adult1","s")%>", "Sites that sell swimsuits or intimate apparel with images of models wearing them."],
				     ["Parental Controls", "6", "<%tcWebApi_get("String_Entry","AiProtection_filter_Adult","s")%>", "<%tcWebApi_get("String_Entry","AiProtection_filter_Adult1","s")%>", "Sites showing nude or partially nude images that are generally considered artistic, not vulgar or pornographic."],
				     ["Parental Controls", "8", "<%tcWebApi_get("String_Entry","AiProtection_filter_Adult","s")%>", "<%tcWebApi_get("String_Entry","AiProtection_filter_Adult1","s")%>", "Sites that promote, sell, or provide information about alcohol or tobacco products."],			     
					 ["Parental Controls", "9", "<%tcWebApi_get("String_Entry","AiProtection_filter_Adult","s")%>", "<%tcWebApi_get("String_Entry","AiProtection_filter_Adult2","s")%>", "Sites that promote and discuss how to perpetrate nonviolent crimes, including burglary, fraud, intellectual property theft, and plagiarism; includes sites that sell plagiarized or stolen materials."],
					 ["Parental Controls", "10", "<%tcWebApi_get("String_Entry","AiProtection_filter_Adult","s")%>", "<%tcWebApi_get("String_Entry","AiProtection_filter_Adult2","s")%>", "Sites with content that is gratuitously offensive and shocking; includes sites that show extreme forms of body modification or mutilation and animal cruelty."],
					 ["Parental Controls", "14", "<%tcWebApi_get("String_Entry","AiProtection_filter_Adult","s")%>", "<%tcWebApi_get("String_Entry","AiProtection_filter_Adult2","s")%>", "Sites that promote hate and violence; includes sites that espouse prejudice against a social group, extremely violent and dangerous activities, mutilation and gore, or the creation of destructive devices."],
					 ["Parental Controls", "15", "<%tcWebApi_get("String_Entry","AiProtection_filter_Adult","s")%>", "<%tcWebApi_get("String_Entry","AiProtection_filter_Adult2","s")%>", "Sites about weapons, including their accessories and use; excludes sites about military institutions or sites that discuss weapons as sporting or recreational equipment."],
					 ["Parental Controls", "16", "<%tcWebApi_get("String_Entry","AiProtection_filter_Adult","s")%>", "<%tcWebApi_get("String_Entry","AiProtection_filter_Adult2","s")%>", "Sites that promote, encourage, or discuss abortion, including sites that cover moral or political views on abortion."],
					 ["Parental Controls", "25", "<%tcWebApi_get("String_Entry","AiProtection_filter_Adult","s")%>", "<%tcWebApi_get("String_Entry","AiProtection_filter_Adult2","s")%>", "Sites that promote, glamorize, supply, sell, or explain how to use illicit or illegal intoxicants."],
					 ["Parental Controls", "26", "<%tcWebApi_get("String_Entry","AiProtection_filter_Adult","s")%>", "<%tcWebApi_get("String_Entry","AiProtection_filter_Adult2","s")%>", "Sites that discuss the cultivation, use, or preparation of marijuana, or sell related paraphernalia."],				 
					 ["Parental Controls", "11", "<%tcWebApi_get("String_Entry","AiProtection_filter_Adult","s")%>", "<%tcWebApi_get("String_Entry","AiProtection_filter_Adult3","s")%>", "Sites that promote or provide information on gambling, including online gambling sites."],
				     ["Parental Controls", "24", "<%tcWebApi_get("String_Entry","AiProtection_filter_message","s")%>", "<%tcWebApi_get("String_Entry","AiProtection_filter_Adult4","s")%>", "Sites that provide web-based services or downloadable software for Voice over Internet Protocol (VoIP) calls"],				    
					 ["Parental Controls", "51", "<%tcWebApi_get("String_Entry","AiProtection_filter_message","s")%>", "<%tcWebApi_get("String_Entry","AiProtection_filter_Adult5","s")%>", "Sites that send malicious tracking cookies to visiting web browsers."],				    
 					 ["Parental Controls", "53", "<%tcWebApi_get("String_Entry","AiProtection_filter_message","s")%>", "<%tcWebApi_get("String_Entry","AiProtection_filter_Adult6","s")%>", "Sites that provide software for bypassing computer security systems."],
				     ["Parental Controls", "89", "<%tcWebApi_get("String_Entry","AiProtection_filter_message","s")%>", "<%tcWebApi_get("String_Entry","AiProtection_filter_Adult6","s")%>", "Malicious Domain or website, Domains that host malicious payloads."],				
					 ["Parental Controls", "42", "<%tcWebApi_get("String_Entry","AiProtection_filter_message","s")%>", "<%tcWebApi_get("String_Entry","AiProtection_filter_Adult7","s")%>", "Content servers, image servers, or sites used to gather, process, and present data and data analysis, including web analytics tools and network monitors."],
				     ["Parental Controls", "56", "<%tcWebApi_get("String_Entry","AiProtection_filter_p2p","s")%>", "<%tcWebApi_get("String_Entry","AiProtection_filter_p2p1","s")%>", "Sites that provide downloadable 'joke' software, including applications that can unsettle users."],
				     ["Parental Controls", "70", "<%tcWebApi_get("String_Entry","AiProtection_filter_p2p","s")%>", "<%tcWebApi_get("String_Entry","AiProtection_filter_p2p1","s")%>", "Sites that use scraped or copied content to pollute search engines with redundant and generally unwanted results."],
				     ["Parental Controls", "71", "<%tcWebApi_get("String_Entry","AiProtection_filter_p2p","s")%>", "<%tcWebApi_get("String_Entry","AiProtection_filter_p2p1","s")%>", "Sites dedicated to displaying advertisements, including sites used to display banner or popup advertisement."],	    
					 ["Parental Controls", "57", "<%tcWebApi_get("String_Entry","AiProtection_filter_p2p","s")%>", "<%tcWebApi_get("String_Entry","AiProtection_filter_p2p2","s")%>", "Sites that distribute password cracking software."],					
				     ["Parental Controls", "69", "<%tcWebApi_get("String_Entry","AiProtection_filter_stream","s")%>", "<%tcWebApi_get("String_Entry","AiProtection_filter_stream2","s")%>", "Sites that provide tools for remotely monitoring and controlling computers"],
					 ["Parental Controls", "23", "<%tcWebApi_get("String_Entry","AiProtection_filter_stream","s")%>", "<%tcWebApi_get("String_Entry","AiProtection_filter_stream3","s")%>", "Sites that primarily provide streaming radio or TV programming; excludes sites that provide other kinds of streaming content."],				 
...
function show_information(){
	...
	if(target_info.category_type == "Parental Controls")
		code += "<li><div><span class='desc_info'><%tcWebApi_get("String_Entry","AiProtection_filter_category","s")%> :</span>" + target_info.content_category + "</div></li>";	
...
/* not used
		...
		code_suggestion = "<ul>";
		if(bwdpi_support)
			parental_string = "<%tcWebApi_get("String_Entry","Time_Scheduling","s")%>";
		else
			parental_string = "<%tcWebApi_get("String_Entry","Parental_Control","s")%>";
...
<body class="wrapper" onload="initial();">
	<div class="div_table main_field_gap">
		...
		<div class="prod_madelName"><%tcWebApi_get("String_Entry","Web_Title2","s")%></div>
		...
		<div class="p1 title_gap"><%tcWebApi_get("String_Entry","w_r_suggestion0","s")%></div>	
		<div>
			<div class="p1 title_gap"></div>
			<div class="nologin">
		...
		<div id="go_btn" class='button' style="display:none;"><%tcWebApi_get("String_Entry","btn_go","s")%></div>		
	</div>
</body>
</html>
