...
If Request_Form("editFlag") = "1" then
	...
	tcWebApi_Set("IpMacFilter_Common","ListType","filter_lw_default_x")
	tcWebApi_Set("IpMacFilter_Entry","Active","fw_lw_enable_x")
	tcWebApi_Set("IpMacFilter_Entry","LtoW_date","filter_lw_date_x")
	tcWebApi_Set("IpMacFilter_Entry","LtoW_time","filter_lw_time_x")
	tcWebApi_Set("IpMacFilter_Entry","LtoW_ICMP","filter_lw_icmp_x")
	tcWebApi_Set("IpMacFilter_Entry","LtoW_List","filter_lwlist")

	/*commit changes*/
	tcWebApi_commit("IpMacFilter")
...
<title>ASUS <%tcWebApi_get("String_Entry","Web_Title2","s")%> <% tcWebApi_staticGet("SysInfo_Entry","ProductTitle","s") %> - <%tcWebApi_get("String_Entry","menu5_5_4","s")%></title>
...
function applyRule(){
	if(validForm()){
		...
		document.form.action = "/cgi-bin/Advanced_Firewall_Content.asp";
...
function showfilter_lwlist(){
	var filter_lwlist_row = filter_lwlist_array.split('<');
	var code = "";
	...
	if(filter_lwlist_row.length == 1)
		...
		for(var i = 1; i < filter_lwlist_row.length; i++){
			code +='<tr id="row'+i+'">';
			var filter_lwlist_col = filter_lwlist_row[i].split('>');
...
<input type="hidden" name="filter_lw_date_x" value="<% If tcWebApi_get("IpMacFilter_Entry","LtoW_date","h") <> "" then  tcWebApi_get("IpMacFilter_Entry","LtoW_date","s") else asp_Write("1111111") end if %>">
<input type="hidden" name="filter_lw_time_x" value="<% If tcWebApi_get("IpMacFilter_Entry","LtoW_time","h") <> "" then  tcWebApi_get("IpMacFilter_Entry","LtoW_time","s") else asp_Write("00002359") end if %>">
...
<thead>
<tr>
            					<td colspan="6" id="filter_lwlist"><%tcWebApi_get("String_Entry","menu5_5_4","s")%></td>
</tr>
</thead>
<tr>
          						<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(10,5);"><%tcWebApi_get("String_Entry","FC_LanWanFirewallEnable_in","s")%></a></th>
<td>
<input type="radio" value="1" name="fw_lw_enable_x" onClick="return change_common_radio(this, 'FirewallConfig', 'fw_lw_enable_x', '1')" <% if tcWebApi_get("IpMacFilter_Entry","Active","h") = "1" then asp_Write("checked") end if %>><%tcWebApi_get("String_Entry","checkbox_Yes","s")%>
<input type="radio" value="0" name="fw_lw_enable_x" onClick="return change_common_radio(this, 'FirewallConfig', 'fw_lw_enable_x', '0')" <% if tcWebApi_get("IpMacFilter_Entry","Active","h") = "0" then asp_Write("checked") end if %>><%tcWebApi_get("String_Entry","checkbox_No","s")%>
</td>
</tr>
<tr>
          						<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(10,3);"><%tcWebApi_get("String_Entry","FC_LanWanDefaultAct_in","s")%></a></th>
<td>
<select name="filter_lw_default_x" class="input_option" onChange="return change_common(this, 'FirewallConfig', 'filter_lw_default_x')">
<option value="DROP"   <% if tcWebApi_get("IpMacFilter_Common","ListType","h") = "DROP" then asp_Write("selected") end if %> ><%tcWebApi_get("String_Entry","WhiteList","s")%></option>
<option value="ACCEPT" <% if tcWebApi_get("IpMacFilter_Common","ListType","h") = "ACCEPT" then asp_Write("selected") end if %> ><%tcWebApi_get("String_Entry","BlackList","s")%></option>
</select>
</td>
</tr>
<tr>
          						<th><%tcWebApi_get("String_Entry","IPC_TriggerList_widzarddesc","s")%></th>
<td>
<select name="LWKnownApps" class="input_option" onChange="change_wizard(this, 'LWKnownApps');">
<option value="User Defined"><%tcWebApi_get("String_Entry","IPC_TriggerList_userdefined","s")%></option>
</select>
</td>
</tr>
<tr>
...
<tr>
          						<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(18,6);"><%tcWebApi_get("String_Entry","FC_LanWanSrcIP_in","s")%></a></th>
            					<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(18,2);"><%tcWebApi_get("String_Entry","FC_LanWanSrcPort_in","s")%></a></th>
            					<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(18,6);"><%tcWebApi_get("String_Entry","FC_LanWanDstIP_in","s")%></a></th>
            					<th><a class="hintstyle" href="javascript:void(0);" onClick="openHint(18,2);"><%tcWebApi_get("String_Entry","FC_LanWanSrcPort_in","s")%></a></th>
...
<td width="15%"><input type="button" class="add_btn" onClick="addRow_Group(8);" name="filter_lwlist2" value=""></td>
</tr>
</table>
