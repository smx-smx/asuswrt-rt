...
<link rel="icon" href="images/favicon.png"><title>ASUS <%tcWebApi_get("String_Entry","Web_Title2","s")%> <% tcWebApi_staticGet("SysInfo_Entry","ProductTitle","s") %> - Home Security</title>
		...
		<!--=====Beginning of Main Content=====-->
				<div class="app_table" id="applist_table">
					<table>
							...
							<td class="formfonttitle">
								<div style="width:730px">
									<table width="730px">
										<tr>
											<td align="left">
												<span class="formfonttitle"><%tcWebApi_get("String_Entry","AiProtection_title","s")%></span>
											</td>
										</tr>
									</table>
								</div>
						...
						<tr>
							<td>
								<div class="formfontdesc" style="font-size:14px;font-style:italic;"><%tcWebApi_get("String_Entry","AiProtection_desc","s")%></div>
							</td> 
						</tr>					
					<!-- Service table -->
						<tr>
										...
										<tbody>
											<tr>
												...
												<td class="app_table_radius_right" style="width:350px;height:120px;">
													<div class="app_name">
														<a style="text-decoration: underline;" href="AiProtection_HomeProtection.asp"><%tcWebApi_get("String_Entry","AiProtection_Home","s")%></a>
													</div>
													<div class="app_desc" style="height:60px;white-space:nowrap;">
														<li><%tcWebApi_get("String_Entry","AiProtection_scan","s")%></li>
														<li><%tcWebApi_get("String_Entry","AiProtection_sites_blocking","s")%></li>
														<li><%tcWebApi_get("String_Entry","AiProtection_Vulnerability","s")%></li>
														<li><%tcWebApi_get("String_Entry","AiProtection_detection_blocking","s")%></li>														
													</div>
												</td>
											</tr>
											...
											<tr>
												...
												<td class="app_table_radius_right" style="width:350px;height:120px;">
													<div class="app_name">
														<a style="text-decoration: underline;" href="ParentalControl.asp"><%tcWebApi_get("String_Entry","Parental_Control","s")%></a>
													</div>
													<div class="app_desc" style="height:60px;">
														<li><%tcWebApi_get("String_Entry","Time_Scheduling","s")%></li>
														<li><%tcWebApi_get("String_Entry","AiProtection_filter","s")%></li>											
													</div>
												</td>
											</tr>
											<tr style="height:50px;"></tr>
