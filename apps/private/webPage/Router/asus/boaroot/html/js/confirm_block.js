function confirm_asus(content){
	...
	*/
	...
	$j('body').append(code);	
	$j('.confirm_button_gen_long_left').bind("click", function(){return content.left_button_callback.call(content.left_button_args)});
	$j('.confirm_button_gen_long_right').bind("click", function(){return content.right_button_callback.call(content.right_button_args)});
}
