...
else if(document.forms[0].current_page.value == "/QIS_wizard.asp"){
...
document.redirectForm.action = "QIS_wizard.asp";
...
document.redirectForm.prev_page.value = "start_apply.asp";
}
document.redirectForm.submit();
}
