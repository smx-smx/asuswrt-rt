...
<script language="JavaScript" type='text/javascript'>
	...
	<tr>
		<td class="light-orange">&nbsp;</td>
		<td class="light-orange"></td>
		<td class="tabdata"><div align=right><font color="#000000"><%tcWebApi_get("String_Entry","WirelessStaNumText","s")%></font></div></td>
		<td class="tabdata"><div align=center>:</div></td>
		<td class="tabdata">
        ...
        <%tcWebApi_get("String_Entry","WirelessStaNumDisp1","s")%><%tcWebApi_get("Info_WLan","maxStaNumSupported","s")%><%tcWebApi_get("String_Entry","WirelessStaNumDisp2","s")%></td>
	</tr>
	<%End If%>
	</table>
...
<table width="760" border="0" align=center cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
	<tr>
      <td width="150" height="20" class="title-main"> <font color="#FFFFFF"><%tcWebApi_get("String_Entry","Wireless11nSettingsText","s")%></font>
      </td>
...
<% if tcWebApi_get("WebCustom_Entry","isPerSSIDSupport","h") = "Yes"  then %>
    ...
    <td class="light-orange"></td>
    <td class="light-orange"></td>
    <td class="tabdata"><div align=right><font color="#000000"></font></div></td>
    <td class="tabdata"><div align=center>:</div></td>
    <td class="tabdata">
	<INPUT TYPE="RADIO" NAME="ESSID_Enable_Selection" VALUE="1" <%If tcWebApi_get("WLan_Entry","EnableSSID","h") = "1" then asp_Write("checked") end if%> >
        <font color="#000000"><%tcWebApi_get("String_Entry","WirelessAccessPoint0Text","s")%></font> 
        ...
        <font color="#000000"><%tcWebApi_get("String_Entry","WirelessAccessPoint1Text","s")%></font> </td>
	</tr>
<%end if%>
	<tr>
		<td class="light-orange">&nbsp;</td>
    ...
    <td class="tabdata">
			...
			<INPUT TYPE="RADIO" NAME="ESSID_HIDE_Selection" VALUE="1" onClick="doBroadcastSSIDChange();" <%If tcWebApi_get("WLan_Entry","HideSSID","h") = "1" then asp_Write("checked") end if%> <%If tcWebApi_get("WLan_Entry","HideSSID","h") = "N/A" then asp_Write("checked") end if%> ><font color="#000000"><%tcWebApi_get("String_Entry","WirelessBroadcastSSID1Text","s")%></font>
		</td>
	</tr>
	</table>
...
<% if tcWebApi_get("WebCustom_Entry","isWPSSupported","h") = "Yes"  then %>
  ...
  <tr>
    <td width="150" class="light-orange"></td>
    <td width="10" class="light-orange"></td>
    <td width="150" class="tabdata"><div align="right"><%tcWebApi_get("String_Entry","WirelessUseWPSText","s")%></div></td>
    <td width="10" class="tabdata"><div align="center">:</div></td>
    <td width="440" class="tabdata"><input name="UseWPS_Selection" VALUE="1" <%If tcWebApi_get("WLan_Entry","WPSConfMode","h") <> "0" then asp_Write("checked") end if%> onClick="doWPSUseChange();" type="radio"><font color="#000000"><%tcWebApi_get("String_Entry","WirelessBroadcastSSID0Text","s")%></font>
	<input name="UseWPS_Selection" VALUE="0" <%If tcWebApi_get("WLan_Entry","WPSConfMode","h") = "0" then asp_Write("checked") end if%> <%If tcWebApi_get("WLan_Entry","WPSConfMode","h") = "N/A" then asp_Write("checked") end if%> onClick="doWPSUseChange();" type="radio"><font color="#000000"><%tcWebApi_get("String_Entry","WirelessBroadcastSSID1Text","s")%></font></td>
  </tr>
	</table>
  ...
  <tr>
    ...
    <font color="#ffffff"><%tcWebApi_get("String_Entry","WirelessWPSSettingsText","s")%></font></td>
  ...
  <tr>
    ...
    <td class="tabdata"> <div align="right"><%tcWebApi_get("String_Entry","WirelessWPSstateText","s")%></div></td>
    <td class="tabdata"><div align="center">:</div></td>
      <td class="tabdata">
	  ...
	  elseif tcWebApi_get("WLan_Entry", "WPSConfStatus", "h") = "N/A" then tcWebApi_get("String_Entry","WPSConfStatus0Text","s") end if%>
	</td>
  </tr>
  <tr>
    <td class="light-orange"></td>
    <td class="light-orange"></td>
    <td class="tabdata"><div align="right"><%tcWebApi_get("String_Entry","WirelessWPSmodeText","s")%></div></td>
    <td class="tabdata"><div align="center">:</div></td>
    <td class="tabdata"><input name="WPSMode_Selection" value="0" onClick="doWPSModeChange();" <%If tcWebApi_get("WLan_Entry","WPSMode","h") = "0" then asp_Write("checked") end if%> type="radio"><%tcWebApi_get("String_Entry","WirelessWPSmode0Text","s")%><input name="WPSMode_Selection" value="1" onClick="doWPSModeChange();" <%If tcWebApi_get("WLan_Entry","WPSMode","h") = "1" then asp_Write("checked") end if%> <%If tcWebApi_get("WLan_Entry","WPSMode","h") = "N/A" then asp_Write("checked") end if%>  type="radio"><%tcWebApi_get("String_Entry","WirelessWPSmode1Text","s")%></td>
  </tr>
  <%If tcWebApi_get("WLan_Entry","WPSMode","h") = "0" then %>
  <tr>
    <td class="light-orange">&nbsp;</td>
    <td class="light-orange">&nbsp;</td>
    <td class="tabdata"> <div align="right"><%tcWebApi_get("String_Entry","WirelessAPPINcodeText","s")%></div></td>
    <td class="tabdata"><div align="center">:</div></td>
    <td class="tabdata"><% tcWebApi_get("Info_WLan", "wlanSelfPinCode", "s") %>&nbsp;&nbsp;
	<input type="button" name="pin_generate" value="<%tcWebApi_get("String_Entry","ButtonGenerateText","s")%>" onClick="doGenerate()"></td>
  </tr>
  <tr>
    <td class="light-orange">&nbsp;</td>
    <td class="light-orange">&nbsp;</td>
    <td class="tabdata"> <div align="right"><%tcWebApi_get("String_Entry","WirelessenrolleePINcodeText","s")%></div></td>
    <td class="tabdata"><div align="center">:</div></td>
    <td class="tabdata"><input name="WPSEnrolleePINCode" size="9" maxlength="9" value="<%If tcWebApi_get("WLan_Entry","enrolleePinCode","h") = "N/A" then asp_Write("") else TCWebApi_get("WLan_Entry","enrolleePinCode","s") end if %>" onblur="doPINCodeCheck(this)" type="text"></td>
  </tr>
  <% end if %>
  <tr>
    <td class="light-orange">&nbsp;</td>
    ...
    <td class="tabdata"><div align="center"></div></td>
    <td class="tabdata"><input name="StartWPS" value="<%IF tcWebApi_get("Info_WLan","wlanWPStimerRunning","h") = "0" then tcWebApi_get("String_Entry","WlanWPStimerRunning0Text","s") end if%> <%IF tcWebApi_get("Info_WLan","wlanWPStimerRunning","h") = "1" then tcWebApi_get("String_Entry","WlanWPStimerRunning1Text","s") end if%><%IF tcWebApi_get("Info_WLan","wlanWPStimerRunning","h") = "N/A" then tcWebApi_get("String_Entry","WlanWPStimerRunning0Text","s") end if%>" onclick="doStartWPS();" type="button"></td>
  </tr>
  <tr>
    <td class="light-orange">&nbsp;</td><td class="light-orange">&nbsp;</td>
    <td class="tabdata"> <div align="right"><%tcWebApi_get("String_Entry","WirelessWPSprogressText","s")%></div></td>
    <td class="tabdata"><div align="center">:</div></td>
    <td class="tabdata">
  ...
  <tr>
    ...
    <td class="tabdata"><div align="right"></div></td>
    <td class="tabdata"><div align="center"></div></td>
    <td class="tabdata"><input name="ResetOOB" value="<%tcWebApi_get("String_Entry","ButtonResetOOBText","s")%>" onclick="doResetOOB();" type="button" ></td>
  </tr>
	</table>
	</div>
	<table width="760" border="0" align=center cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
...
<table width="760" border="0" align=center cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
	...
	<table width="760" border="0" align=center cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">	
	<tr>
        <td height="30" width="150" class="title-main"><font color="#FFFFFF"><%tcWebApi_get("String_Entry","WirelessRADIUSText","s")%></font></td>
        <td width="10" class="black">&nbsp;</td>
        <td width="150"><hr noshade></td>
        <td width="10"><hr noshade></td>
        <td width="440"><hr noshade></td>
	...
	<tr> 
	  ...
	  -->
	  <tr> 
        <td width="150" height="30" class="title-main"><font color="#FFFFFF"><%tcWebApi_get("String_Entry","WirelessRadiusWEP64Text","s")%></font></td>
        <td width="10" class="black">&nbsp;</td>
        <td width="150"><hr noshade></td>
		<td width="10" ><hr noshade></td>
		<td width="440"><hr noshade></td>
	...
	<tr>
		...
		<td class="tabdata"><div align=right>
            ...
            <font color="#000000"><%tcWebApi_get("String_Entry","WirelessDefaultKeyText","s")%></font>#1</div></td>
        <td class="tabdata"><div align=center>:</div></td>
      ...
      <tr> 
        ...
        <td class="tabdata"><div align=right> 
            ...
            <font color="#000000"><%tcWebApi_get("String_Entry","WirelessDefaultKeyText","s")%></font>#2</div></td>
		<td class="tabdata"><div align=center>:</div></td>
	...
	<tr>                                                                                      
		...
		<td class="tabdata"><div align=right>                                                                                                                                                                                     
            ...
            <font color="#000000"><%tcWebApi_get("String_Entry","WirelessDefaultKeyText","s")%></font>#3</div></td>
        <td class="tabdata"><div align=center>:</div></td>
      ...
      <tr> 
        ...
        <td class="tabdata"><div align=right> 
            ...
            <font color="#000000"><%tcWebApi_get("String_Entry","WirelessDefaultKeyText","s")%></font>#4</div></td>
		<td class="tabdata"><div align=center>:</div></td>
    ...
    <td class="light-orange"></td>
	  ...
	  -->
	  <tr> 
        <td width="150" height="30" class="title-main"><font color="#FFFFFF"><%tcWebApi_get("String_Entry","WirelessWEPStatus7Text","s")%></font></td>
        <td width="10" class="black">&nbsp;</td>
        <td width="150"><hr noshade></td>
        <td width="10" ><hr noshade></td>
        <td width="440"><hr noshade></td>
	...
	<tr>		
	  ...
	  -->
	  <tr> 
        <td height="30" class="title-main"><font color="#FFFFFF"><%tcWebApi_get("String_Entry","WirelessWEPStatus8Text","s")%></font></td>
        <td class="black">&nbsp;</td>
        <td><hr noshade></td>
        <td><hr noshade></td>
        <td><hr noshade></td>
	...
	<input type="text" id="WPARekeyInter3" name="WPARekeyInter3" size="7" maxlength="7"  onBlur="checkRekeyinteral(this.value, 1)">
        <font color="#000000"><%tcWebApi_get("String_Entry","WirelessIntervalSecText","s")%></font>
	<script language="JavaScript" type="text/JavaScript">
	...
	<tr>
		...
		<td class="tabdata"><div align=center>:</div></td>
		<td class="tabdata">
			<INPUT TYPE="TEXT" NAME="PreSharedKey1" SIZE="48" MAXLENGTH="64" VALUE="<%If tcWebApi_get("WLan_Entry","WPAPSK","h") <> "N/A" then tcWebApi_get("WLan_Entry","WPAPSK","s") end if%>" onBlur="wpapskCheck(this)"><font color="#000000"><%tcWebApi_get("String_Entry","WirelessSharedKeyCommText","s")%></font>
		</td>
	</tr>
	<tr>
		<td class="light-orange">&nbsp;</td><td class="light-orange"></td>
		<td class="tabdata"><div align=right><font color="#000000"><%tcWebApi_get("String_Entry","WirelessRenewalIntervalText","s")%></font></div></td>
		<td class="tabdata"><div align=center>:</div></td>
		<td class="tabdata">
			<INPUT TYPE="TEXT" id="keyRenewalInterval1" NAME="keyRenewalInterval1" SIZE="7" MAXLENGTH="7" onBlur="checkRekeyinteral(this.value, 0)">
          	<font color="#000000"> <%tcWebApi_get("String_Entry","WirelessSecondsTipText","s")%></font>
		  	<script language="JavaScript" type="text/JavaScript">
				var rekeystr = "<% tcWebApi_get("WLan_Entry","RekeyInterval","s") %>";
				if("N/A" == rekeystr || "" == rekeystr){
	...
	<% if tcWebApi_get("Info_WLan","isWDSSupported","h") = "Yes" then %>
		<td width="150" height="30" class="title-main"><font color="#FFFFFF"><%tcWebApi_get("String_Entry","WirelessWDSSettingsText","s")%></font></td>
		<td width="10" class="black">&nbsp;</td>
		<td width="150"><hr noshade></td>
		<td width="10"><hr noshade></td>
		<td width="440"><hr noshade></td>
    ...
    <tr>
		<td class="light-orange">&nbsp;</td>
		<td class="light-orange"></td>
		<td class="tabdata"><div align=right><font color="#000000"><%tcWebApi_get("String_Entry","WirelessWDSModeText","s")%></font></div></td>
		<td class="tabdata"><div align=center>:</div></td>
		<td class="tabdata">
		  ...
		  <font color="#000000"><%tcWebApi_get("String_Entry","WirelessAccessPoint1Text","s")%></font>
		</td>
	</tr>
	</table>
	<div id="else_div">
	...
	<tr>
		<td width="150" class="light-orange">&nbsp;</td>
		<td width="10" class="light-orange"></td>
		<td width="150" class="tabdata"><div align=right><font color="#000000"><%tcWebApi_get("String_Entry","WirelessWDSEncrypTypeText","s")%></font></div></td>
		<td width="10" class="tabdata"><div align=center>:</div></td>
		<td width="440" class="tabdata">
			<SELECT NAME="WDS_EncrypType_Selection" SIZE="1" onChange="doWDSEncrypTypeChange()">
				<OPTION value="TKIP" <%If tcWebApi_get("WLan_Entry","EncrypType","h") = "TKIP" then asp_Write("selected") end if%> ><%tcWebApi_get("String_Entry","WirelessEncryption0Text","s")%>
				<OPTION value="AES" <% if tcWebApi_get("WLan_Entry","EncrypType","h") = "AES" then asp_Write("selected") end if %>><%tcWebApi_get("String_Entry","WirelessEncryption1Text","s")%> 
			</SELECT>
		</td>
	</tr>
	<tr>
		<td class="light-orange">&nbsp;</td><td class="light-orange"></td>
		<td class="tabdata"><div align=right><font color="#000000"><%tcWebApi_get("String_Entry","WirelessWDSKeyText","s")%></font></div></td>
		<td class="tabdata"><div align=center>:</div></td>
		<td class="tabdata">
			<INPUT TYPE="TEXT" NAME="WDS_Key" SIZE="48" MAXLENGTH="64" VALUE="<%If tcWebApi_get("WLan_WDS","WdsKey","h") <> "N/A" then tcWebApi_get("WLan_WDS","WdsKey","s") end if%>" onBlur="WDSKeyCheck(this)"><font color="#000000"><%tcWebApi_get("String_Entry","WirelessWDSKeyCommText","s")%></font>
		</td>
    </tr>
	</table>
	</div>
    ...
    <tr>
        ...
        <%tcWebApi_get("String_Entry","WirelessWDSFilter0Text","s")%></div>
		</td>
		<td width="10" class="tabdata"><div align="center">:</div></td>
    	<td width="440" class="tabdata">
    ...
    <tr>
    	...
    	<td class="light-orange"></td>
    	<td class="tabdata"><div align="right">
       	 	<%tcWebApi_get("String_Entry","WirelessWDSFilter1Text","s")%></div>
		</td>
		<td class="tabdata"><div align="center">:</div></td>
    	<td class="tabdata">
    ...
    <tr>
    	...
    	<td class="light-orange"></td>
    	<td class="tabdata"><div align="right">
       		 <%tcWebApi_get("String_Entry","WirelessWDSFilter2Text","s")%></div>
		</td>
		<td class="tabdata"><div align="center">:</div></td>
    	<td class="tabdata">
    ...
    <tr>
    	...
    	<td class="light-orange"></td>
    	<td class="tabdata"><div align="right">
        	<%tcWebApi_get("String_Entry","WirelessWDSFilter3Text","s")%></div>
		</td>
		<td class="tabdata"><div align="center">:</div></td>
    	<td class="tabdata">
  	...
  	<tr>
	<%End If%>
		<td width="150" height="30" class="title-main"><font color="#FFFFFF"><%tcWebApi_get("String_Entry","WirelessWDSMACFilterText","s")%></font></td>
		<td width="10" class="black">&nbsp;</td>
		<td width="150"><hr noshade></td>
		<td width="10"><hr noshade></td>
		<td width="440"><hr noshade></td>
