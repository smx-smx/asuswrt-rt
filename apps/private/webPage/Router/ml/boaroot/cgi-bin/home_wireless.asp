...
function wpapskCheck() {
    ...
    alert('<%tcWebApi_get("String_Entry","WirelessJS27Text","s")%>');		return true;
	}	
	...
	<tr>
		...
		<td class="tabdata">
			<SELECT NAME="WirelessMode" SIZE="1">
				...
				<OPTION value="2" <% if tcWebApi_get("WLan_Common","WirelessMode","h") = "2" then asp_Write("selected") end if %> <%If tcWebApi_get("WLan_Common","WirelessMode","h") = "N/A" then asp_Write("checked") end if%>><%tcWebApi_get("String_Entry","WirelessMode1Text","s")%>
			</SELECT>
		</td>
	</tr>
	<tr>
...
<%end if%>
	...
	<tr>
		<td  class="light-orange">&nbsp;</td>
		<td class="light-orange"></td>
		<td class="tabdata"><div align=right><font color="#000000"><%tcWebApi_get("String_Entry","WirelessAuthTypeText","s")%></font></div></td>
		<td class="tabdata"><div align=center>:</div></td>
		<td class="tabdata">
...
<table width="760" border="0" align=center cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
	...
	<tr>
		...
		<td class="tabdata"><div align=right>
			<INPUT TYPE="RADIO" NAME="DefWEPKey" VALUE="1" <%If tcWebApi_get("WLan_Entry","DefaultKeyID","h") = "1" then asp_Write("checked") elseif tcWebApi_get("WLan_Entry","DefaultKeyID","h") = "N/A" then asp_Write("checked") end if%> ><font color="#000000"><%tcWebApi_get("String_Entry","WirelessDefaultKeyText","s")%></font>#1</div>
		</td>
		<td class="tabdata"><div align=center>:</div></td>
		<td class="tabdata">   
	...
	<tr>                                                                                      
		...
		<td class="light-orange"></td>
		<td class="tabdata"><div align=right>                                                                                                                                                                                     
			<INPUT TYPE="RADIO" NAME="DefWEPKey" VALUE="2" <%If tcWebApi_get("WLan_Entry","DefaultKeyID","h") = "2" then asp_Write("checked") end if%> ><font color="#000000"><%tcWebApi_get("String_Entry","WirelessDefaultKeyText","s")%></font>#2</div>
		</td>
		<td class="tabdata"><div align=center>:</div></td>
		<td class="tabdata">           
    ...
    <td class="light-orange"></td>
    <td class="tabdata"><div align=right>                                                                                                                                                                                     
			<INPUT TYPE="RADIO" NAME="DefWEPKey" VALUE="3" <%If tcWebApi_get("WLan_Entry","DefaultKeyID","h") = "3" then asp_Write("checked") end if%> ><font color="#000000"><%tcWebApi_get("String_Entry","WirelessDefaultKeyText","s")%></font>#3</div>
		</td>
		<td class="tabdata"><div align=center>:</div></td>
		<td class="tabdata">           
	...
	<tr>                                                                                      
		...
		<td class="tabdata"><div align=right>                                                                                                                                                                                     
			<INPUT TYPE="RADIO" NAME="DefWEPKey" VALUE="4" <%If tcWebApi_get("WLan_Entry","DefaultKeyID","h") = "4" then asp_Write("checked") end if%> ><font color="#000000"><%tcWebApi_get("String_Entry","WirelessDefaultKeyText","s")%></font>#4</div>
		</td>
		<td class="tabdata"><div align=center>:</div></td>
		<td class="tabdata">           
	...
	<tr>
		<td class="light-orange">&nbsp;</td><td class="light-orange"></td>
		<td class="tabdata"><div align=right>
			<INPUT TYPE="RADIO" NAME="DefWEPKey" VALUE="1" <%If tcWebApi_get("WLan_Entry","DefaultKeyID","h") = "1" then asp_Write("checked") end if%> <% If tcWebApi_get("WLan_Entry","DefaultKeyID","h") = "N/A" then asp_Write("checked") end if%> ><font color="#000000"><%tcWebApi_get("String_Entry","WirelessDefaultKeyText","s")%></font>#1</div></td>
		<td class="tabdata"><div align=center>:</div></td>
		<td class="tabdata">   
			<INPUT TYPE="TEXT" NAME="WEP_Key1" SIZE="30" MAXLENGTH="28" VALUE="<%If tcWebApi_get("WLan_Entry","Key1Str","h") <> "N/A" then tcWebApi_get("WLan_Entry","Key1Str","s") end if%>" onBlur="doKEYcheck(this);" >
		</td>
	...
	<% elseif tcWebApi_get("WLan_Entry","AuthMode","h") = "WPA2PSK"  then %>
		<td height="30" class="title-main"><font color="#FFFFFF"><%tcWebApi_get("String_Entry","WirelessWPAPSKText","s")%></font></td>
	...
	<tr>
		...
		<td class="tabdata"><div align=center>:</div></td>
		<td class="tabdata">
			<INPUT TYPE="TEXT" NAME="PreSharedKey" SIZE="48" MAXLENGTH="63" VALUE="<%If tcWebApi_get("WLan_Entry","WPAPSK","h") <> "N/A" then tcWebApi_get("WLan_Entry","WPAPSK","s") end if%>" onBlur="wpapskCheck()"><font color="#000000"><%tcWebApi_get("String_Entry","WirelessSharedKeyCommText","s")%></font>
		</td>
	</tr>
	<tr>
