...
<table width="760" border="0" align=center cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
  <tr>
    ...
    <font color="#FFFFFF"><%tcWebApi_get("String_Entry","SystemRestartText","s")%></font>    </td><td width="10" class="black">&nbsp;</td><td width="150"></td><td width="10"> </td><td width="440"></td></tr><tr>
    <td class="light-orange">&nbsp;</td><td class="light-orange"></td><td class="tabdata"><div align=right>
    <font color="#000000"><%tcWebApi_get("String_Entry","SystemRestartwithText","s")%></font>    </div></td><td class="tabdata"><div align=center>:</div></td><td class="tabdata">
		<INPUT TYPE="RADIO" NAME="restoreFlag" VALUE="1" CHECKED>      	<font color="#000000"><%tcWebApi_get("String_Entry","SystemSettingsText","s")%></font>		</td></tr><tr>
    <td class="light-orange">&nbsp;</td><td class="light-orange"></td><td class="tabdata">&nbsp;</td><td class="tabdata">&nbsp;</td><td class="tabdata">
		<INPUT TYPE="RADIO" NAME="restoreFlag" VALUE="2">		<font color="#000000"><%tcWebApi_get("String_Entry","SystemFactoryText","s")%></font>		</td></tr><tr>
  ...
  <tr>
    <td width="160" class="black" height="42" >&nbsp;</td><td width="160" class="orange">&nbsp;</td><td width="440" class="orange">
	    ...
	    <INPUT TYPE="SUBMIT" NAME="RestartBtn" VALUE="<%tcWebApi_get("String_Entry","ButtonRestartText","s")%>" onClick="restart();">	</td></tr></table></div></form>
</body>
...
<table width="760" border="0" align=center cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
  <tr>
    ...
    <td class="light-orange">&nbsp;</td><td class="light-orange"></td><td class="tabdata"><div align=right>
    <font color="#000000"><%tcWebApi_get("String_Entry","SystemRestartwithText","s")%></font>    </div></td><td class="tabdata"><div align=center>:</div></td><td class="tabdata">
		<INPUT TYPE="RADIO" NAME="restoreFlag" VALUE="1" CHECKED><font color="#000000"><%tcWebApi_get("String_Entry","SystemSettingsText","s")%></font>		</td></tr>
	...
	<td class="tabdata"><INPUT TYPE="RADIO" NAME="restoreFlag" VALUE="2"><font color="#000000"><%tcWebApi_get("String_Entry","SystemFactoryText","s")%></font></td>
	</tr>
	<%end if%>
	<tr>
    <td class="light-orange">&nbsp;</td><td class="light-orange"></td><td width="150">&nbsp;</td><td width="10">&nbsp;</td><td width="440">&nbsp;</td></tr></table><table width="760" border="0" align=center cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
...
<FORM METHOD="POST" ACTION="/cgi-bin/tools_system.asp" name="tools_System_Restore">
	<table width="760" border="0" align=center cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
		 ...
		 <tr>
			<td width="150" height="30" class="title-main"><font color="#FFFFFF"><%tcWebApi_get("String_Entry","SystemRestartText","s")%></font></td>
		...
		<tr>
			 ...
			 <td class="light-orange"></td>
			 <td class="tabdata"><div align=center><font color=red><%tcWebApi_get("String_Entry","SystemRebootText","s")%></font></div></td>
			 </tr>
		<tr>
			<td class="light-orange">&nbsp;</td>
			<td class="light-orange"></td>
