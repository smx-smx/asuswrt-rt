...
class=\"tabdata\"><strong><script>document.writeln(vir_obj[\"VoIPMediaCGI0\"]);</script></strong></td><td width=\"120\" align=\"center\"
class=\"tabdata\"><strong><script>document.writeln(vir_obj[\"VoIPMediaCGI1\"]);</script></strong></td>\n<td width=\"100\" align=\"center\"
class=\"tabdata\"><strong><script>document.writeln(vir_obj[\"VoIPMediaCGI2\"]);</script></strong></td>\n<td width=\"70\" align=\"center\"
class=\"tabdata\"><strong><script>document.writeln(vir_obj[\"VirsvrCgiEdit\"]);</script></strong></td><td width=\"70\" align=\"center\" class=\"tabdata\"><strong><script>document.writeln(vir_obj[\"VirsvrCgiDrop\"]);</script></strong></td></tr>"
tcapi_path=/userfs/bin/
java_str=
for j in 0 1 2 3 4
do 
	node_name="VoIPMedia_Entry0"
