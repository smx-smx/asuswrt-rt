...
function doValidateIP(Address, option) 
{
    ...
    { 
  	    ...
  	    alert("<%tcWebApi_get("String_Entry","NatIPAddrJS0Text","s")%>");
    ...
    for(i=0; i < 4; i++) 
    {
        ...
        { 
          	...
          	alert("<%tcWebApi_get("String_Entry","NatIPAddrJS1Text","s")%>" + Address);
...
function doValidateRange(startIP,endIP) 
{
    ...
    for(cnt=0; cnt < 4; cnt++) 
    {
        if(Number(edaddress[cnt])<Number(staddress[cnt])) 
        {
            ...
            alert("<%tcWebApi_get("String_Entry","NatIPAddrJS2Text","s")%>");
		...
		case 3:
			...
			if(form.MapEditType.selectedIndex == 3)
			{
				...
				if(IPValues[1] - IPValues[0] <= 0)
				{
					...
					alert("<%tcWebApi_get("String_Entry","NatIPAddrJS3Text","s")%>");
				...
				else if(IPValues[3] - IPValues[2] <= 0)
				{
					...
					alert("<%tcWebApi_get("String_Entry","NatIPAddrJS5Text","s")%>");
				...
				{
      	            alert("<%tcWebApi_get("String_Entry","NatIPAddrJS4Text","s")%>");
...
<table width="760" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
  ...
  <tr>
    ...
    <%tcWebApi_get("String_Entry","NatIPAddrMappingText","s")%></td>
  ...
  <tr>
    ...
    <%tcWebApi_get("String_Entry","NatIPAddrMappingRuleText","s")%>
    
    </div></td>
    <td class="tabdata"><div align="center">:</div></td>
    <td class="tabdata" colspan="2">
		<%If tcWebApi_get("Nat_PVC","IPMODE","h") = "Single" Then%>
    	<%tcWebApi_get("String_Entry","NatIPAddrSingleText","s")%><%tcWebApi_get("WebCurSet_Entry","nat_pvc","s")%>
    <%Else%>
    	<%tcWebApi_get("String_Entry","NatIPAddrMultipleText","s")%><%tcWebApi_get("WebCurSet_Entry","nat_pvc","s")%>
    <%End If%>	</td>
  </tr>
  <tr>
    <td class="light-orange"></td>
    ...
    <%tcWebApi_get("String_Entry","NatIPAddrRuleTypeText","s")%>
    
    </div></td>
    <td class="tabdata"><div align="center">:</div></td>
       
      <td class="tabdata" colspan="2"> <select onChange="chkNATtype(1)" id="uiViewFlanRIPState" name="MapEditType">
          <option value="One-to-One"><%tcWebApi_get("String_Entry","NatIPAddrMapEditType0Text","s")%></option>
          <option value="Many-to-One"><%tcWebApi_get("String_Entry","NatIPAddrMapEditType1Text","s")%></option>
          <option value="Many-to-Many-Overload" ><%tcWebApi_get("String_Entry","NatIPAddrMapEditType2Text","s")%></option>
          <option value="Many-to-Many-No-Overload"><%tcWebApi_get("String_Entry","NatIPAddrMapEditType3Text","s")%></option>
          <option value="Server" ><%tcWebApi_get("String_Entry","NatIPAddrMapEditType4Text","s")%></option>
        </select></td>
    </tr>
  <tr>
    ...
    <%tcWebApi_get("String_Entry","NatIPAddrStartIPText","s")%>
	...
	<td class="tabdata" id="localSIP_Div"><div><%tcWebApi_get("String_Entry","NatIPAddrCommentText","s")%></div></td> 
  </tr>
  <tr>
    <td class="light-orange" width="150">&nbsp;</td>
    <td class="light-orange" width="10">&nbsp;</td>
    ...
    <%tcWebApi_get("String_Entry","NatIPAddrEndIPText","s")%>
    ...
    <td class="tabdata" width="10"><div align="center">:</div></td>
	  ...
	  <td class="tabdata" id="localEIP_Div"><div><%tcWebApi_get("String_Entry","NatIPAddrComment1Text","s")%></div></td> 
  </tr>
  <tr>
    <td class="light-orange" width="150">&nbsp;</td>
    <td class="light-orange" width="10">&nbsp;</td>
    ...
    <%tcWebApi_get("String_Entry","NatIPAddrPublicStartIPText","s")%>
    ...
    <td class="tabdata" width="110">
	   ...
	   <td class="tabdata" id="publicSIP_Div"><div><%tcWebApi_get("String_Entry","NatIPAddrComment2Text","s")%></div></td>   
  </tr>
  <tr>
    <td class="light-orange" width="150">&nbsp;</td>
    <td class="light-orange" width="10">&nbsp;</td>
    ...
    <%tcWebApi_get("String_Entry","NatIPAddrPublicEndIPText","s")%> 
...
<table width="760" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
  <tr>
    ...
    <%tcWebApi_get("String_Entry","NatIPAddrMappingListText","s")%>  
    </td>
...
<table width="760" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
  <tr>
    ...
    <input type="hidden" name="IPADDRMAP_Flag">
		...
		<input type="button" name="BackBtn"   value="<%tcWebApi_get("String_Entry","ButtonSaveText","s")%>"   onClick="javascript:window.location='/cgi-bin/adv_nat_top.asp'">
		<input type="button" name="CancelBtn" value="<%tcWebApi_get("String_Entry","ButtonBackText","s")%>" onClick="javascript:window.location='/cgi-bin/adv_nat_ipaddrmap.asp'">
	</td>
  </tr>
</table>
</form>
