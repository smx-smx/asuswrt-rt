...
function dosave(){
	...
	if(form.VoIPCallForward[0].checked) {
		if(form.VoIPCFUNumber.value.length <= 0){
			alert("<%tcWebApi_get("String_Entry","VoIPCallJS0Text","s")%>");
			return;
		} else {
			for(i = 0; i < form.VoIPCFUNumber.value.length; i++) {
				tmp = form.VoIPCFUNumber.value.charCodeAt(i);
				if(checkDigit(tmp) != 0) {
					alert("<%tcWebApi_get("String_Entry","VoIPCallJS1Text","s")%>");
					return;
				}
			}
		...
		if(form.VoIPCFBNumber.value.length <= 0){
			alert("<%tcWebApi_get("String_Entry","VoIPCallJS2Text","s")%>");
			return;
		} else {
			for(i = 0; i < form.VoIPCFBNumber.value.length; i++) {
				tmp = form.VoIPCFBNumber.value.charCodeAt(i);
				if(checkDigit(tmp) != 0) {
					alert("<%tcWebApi_get("String_Entry","VoIPCallJS3Text","s")%>");
					return;
				}
			}
		...
		if(form.VoIPCFNRNumber.value.length <= 0){
			alert("<%tcWebApi_get("String_Entry","VoIPCallJS4Text","s")%>");
			return;
		} else {
			for(i = 0; i < form.VoIPCFNRNumber.value.length; i++) {
				tmp = form.VoIPCFNRNumber.value.charCodeAt(i);
				if(checkDigit(tmp) != 0) {
					alert("<%tcWebApi_get("String_Entry","VoIPCallJS5Text","s")%>");
					return;
				}
			}
...
<%end if%>
	...
	if(form.VoIP3wayConf[0].checked) {
		if(form.VoIP3wayConfNumber.value.length <= 0){
			alert("<%tcWebApi_get("String_Entry","VoIPCallJS10Text","s")%>");
			return;
		} else {
			for(i = 0; i < form.VoIP3wayConfNumber.value.length; i++) {
				tmp = form.VoIP3wayConfNumber.value.charCodeAt(i);
				if(checkDigit(tmp) != 0) {
					alert("<%tcWebApi_get("String_Entry","VoIPCallJS11Text","s")%>");
					return;
				}
			}
	...
	if(form.VoIPCallReturn[0].checked) {
		if(form.VoIPCallReturnNumber.value.length <= 0){
			alert("<%tcWebApi_get("String_Entry","VoIPCallJS12Text","s")%>");
			return;
		} else {
			for(i = 0; i < form.VoIPCallReturnNumber.value.length; i++) {
				tmp = form.VoIPCallReturnNumber.value.charCodeAt(i);
				if(checkDigit(tmp) != 0) {
					alert("<%tcWebApi_get("String_Entry","VoIPCallJS13Text","s")%>");
					return;
				}
			}
	...
	if(form.VoIPDNDEnable[0].checked) {
		if(form.VoIPDNDEnableNumber.value.length <= 0){
			alert("<%tcWebApi_get("String_Entry","VoIPCallJS14Text","s")%>");
			return;
		} else {
			for(i = 0; i < form.VoIPDNDEnableNumber.value.length; i++) {
				tmp = form.VoIPDNDEnableNumber.value.charCodeAt(i);
				if(checkDigit(tmp) != 0) {
					alert("<%tcWebApi_get("String_Entry","VoIPCallJS15Text","s")%>");
					return;
				}
			}
		...
		if(form.VoIPDNDDisableNumber.value.length <= 0){
			alert("<%tcWebApi_get("String_Entry","VoIPCallJS16Text","s")%>");
			return;
		} else {
			for(i = 0; i < form.VoIPDNDDisableNumber.value.length; i++) {
				tmp = form.VoIPDNDDisableNumber.value.charCodeAt(i);
				if(checkDigit(tmp) != 0) {
					alert("<%tcWebApi_get("String_Entry","VoIPCallJS17Text","s")%>");
					return;
				}
			}
	...
	if(form.VoIPDODEnable[0].checked) {
		if(form.VoIPDODNumber.value.length <= 0){
			...
			for(i = 0; i < form.VoIPDODNumber.value.length; i++) {
				...
				if(checkDigit(tmp) != 0) {
					alert("<%tcWebApi_get("String_Entry","VoIPCallJS18Text","s")%>");
					return;
				}
			}
	...
	for(i = 0; i < count; i++){
		for(j = 0; j < i; j++){
			if(numbers[i]==numbers[j]){
				alert("<%tcWebApi_get("String_Entry","VoIPCallJS19Text","s")%>");
				return;
			}
...
<FORM METHOD="POST" ACTION="/cgi-bin/voip_call_ctrl.asp" name="VOIP_CALL_CTRL_form"><table width="760" border="0" align=center cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
	...
	<font color="#FFFFFF"><%tcWebApi_get("String_Entry","VoIPCallControlText","s")%></font></td>
	...
	<tr>
		...
		<td class="light-orange">&nbsp;</td>
		<td class="tabdata"><div align=right><font color="#000000"><%tcWebApi_get("String_Entry","VoIPCallLineText","s")%></font></div></td>
...
<%end if%>
	...
	<tr>
		<td class="light-orange">&nbsp;</td>
		<td class="light-orange"></td>
		<td class="tabdata" align=right><font color="#000000"><%tcWebApi_get("String_Entry","VoIPCallAnonymousText","s")%></font></td>
		<td class="tabdata" align=center>:</td>
		<td class="tabdata">
			<INPUT TYPE="RADIO" NAME="Anonymous_call_blocking" VALUE="Yes" <%if TCWebAPI_get("VoIPCallCtrl_Entry", "AnonymousCallBlock", "h") = "Yes" then asp_write("checked") end if%>><font color="#000000"><%tcWebApi_get("String_Entry","VoIPCallAnonymous0Text","s")%></font>
			<INPUT TYPE="RADIO" NAME="Anonymous_call_blocking" VALUE="No" <%if TCWebAPI_get("VoIPCallCtrl_Entry", "AnonymousCallBlock", "h") <> "Yes" then asp_write("checked") end if%>><font color="#000000"><%tcWebApi_get("String_Entry","VoIPCallAnonymous1Text","s")%></font>
		</td></tr>

	<tr>
		<td class="light-orange">&nbsp;</td>
		<td class="light-orange"></td>
		<td class="tabdata" align=right><font color="#000000"><%tcWebApi_get("String_Entry","VoIPCallAnonycallingText","s")%></font></td>
		<td class="tabdata" align=center>:</td>
		<td class="tabdata">
			<INPUT TYPE="RADIO" NAME="Anonymous_calling" VALUE="Yes" <%if TCWebAPI_get("VoIPCallCtrl_Entry", "AnonymousCall", "h") = "Yes" then asp_write("checked") end if%>><font color="#000000"><%tcWebApi_get("String_Entry","VoIPCallAnonymous0Text","s")%></font>
			<INPUT TYPE="RADIO" NAME="Anonymous_calling" VALUE="No" <%if TCWebAPI_get("VoIPCallCtrl_Entry", "AnonymousCall", "h") <> "Yes" then asp_write("checked") end if%>><font color="#000000"><%tcWebApi_get("String_Entry","VoIPCallAnonymous1Text","s")%></font>
		</td></tr>
	...
	<tr>
		<td class="light-orange">&nbsp;</td>
		<td class="light-orange"></td>
		<td class="tabdata" align=right><font color="#000000"><%tcWebApi_get("String_Entry","VoIPCallCallerIdText","s")%></font></td>
		<td class="tabdata" align=center>:</td>
		<td class="tabdata">
		<INPUT TYPE="RADIO" NAME="VoIPCallerId" VALUE="Yes" <%if TCWebAPI_get("VoIPCallCtrl_Entry", "SIPCallerIdEnable", "h") = "Yes" then asp_write("checked") end if%>><font color="#000000"><%tcWebApi_get("String_Entry","VoIPCallAnonymous0Text","s")%></font>
		<INPUT TYPE="RADIO" NAME="VoIPCallerId" VALUE="No" <%if TCWebAPI_get("VoIPCallCtrl_Entry", "SIPCallerIdEnable", "h") <> "Yes" then asp_write("checked") end if%>><font color="#000000"><%tcWebApi_get("String_Entry","VoIPCallAnonymous1Text","s")%></font>
		<font color="#000000"><%tcWebApi_get("String_Entry","VoIPCallCallerIdCommText","s")%></font>
		</td></tr>
	<% if TCWebAPI_get("VoIPMedia_Common", "VOIP_switch", "h") = "Yes" then%>
	<tr>
		<td class="light-orange">&nbsp;</td>
		<td class="light-orange"></td>
		<td class="tabdata" align=right><font color="#000000"><%tcWebApi_get("String_Entry","VoIPCallCallWaitingText","s")%></font></td>
		<td class="tabdata" align=center>:</td>
		<td class="tabdata">
			<INPUT TYPE="RADIO" NAME="VoIPCallWaiting" VALUE="Yes" <%if TCWebAPI_get("VoIPCallCtrl_Entry", "SIPCallWaitingEnable", "h") = "Yes" then asp_write("checked") end if %> onclick="waitingOn(false)"><font color="#000000"><%tcWebApi_get("String_Entry","VoIPCallAnonymous0Text","s")%></font>
			<INPUT TYPE="RADIO" NAME="VoIPCallWaiting" VALUE="No" <%if TCWebAPI_get("VoIPCallCtrl_Entry", "SIPCallWaitingEnable", "h") <> "Yes" then asp_write("checked") end if%> onclick="waitingOn(true)"><font color="#000000"><%tcWebApi_get("String_Entry","VoIPCallAnonymous1Text","s")%></font>
		</td></tr>
	<%end if%>
	<tr>
		<td class="light-orange">&nbsp;</td>
		<td class="light-orange"></td>
		<td class="tabdata" align=right><font color="#000000"><%tcWebApi_get("String_Entry","VoIPCallSIPReplyText","s")%></font></td>
		<td class="tabdata" align=center>:</td>
		<td class="tabdata">
		<INPUT TYPE="RADIO" NAME="VoIPCallWaitingReply" VALUE="Ringing" <%if TCWebAPI_get("VoIPCallCtrl_Entry", "SIPCallWaitingReply", "h") = "Ringing" then asp_write("checked") end if %>><font color="#000000"><%tcWebApi_get("String_Entry","VoIPCallSIPReply0Text","s")%></font>
		<INPUT TYPE="RADIO" NAME="VoIPCallWaitingReply" VALUE="Queued" <%if TCWebAPI_get("VoIPCallCtrl_Entry", "SIPCallWaitingReply", "h") = "Queued" then asp_write("checked") elseif TCWebAPI_get("VoIPCallCtrl_Entry", "SIPCallWaitingReply", "h") = "N/A" then asp_write("checked") end if%>><font color="#000000"><%tcWebApi_get("String_Entry","VoIPCallSIPReply1Text","s")%></font>
		</td></tr>
<% if TCWebAPI_get("VoIPMedia_Common", "VOIP_switch", "h") = "Yes" then%>
	<tr>
		<td class="light-orange">&nbsp;</td>
		<td class="light-orange"></td>
		<td class="tabdata" align=right><font color="#000000"><%tcWebApi_get("String_Entry","VoIPCallHoldText","s")%></font></td>
		<td class="tabdata" align=center>:</td>
		<td class="tabdata">
			<INPUT TYPE="RADIO" NAME="VoIPCallHold" VALUE="Yes" <%if TCWebAPI_get("VoIPCallCtrl_Entry", "SIPCallHold", "h") = "Yes" then asp_write("checked") end if%>><font color="#000000"><%tcWebApi_get("String_Entry","VoIPCallAnonymous0Text","s")%></font>
			<INPUT TYPE="RADIO" NAME="VoIPCallHold" VALUE="No" <%if TCWebAPI_get("VoIPCallCtrl_Entry", "SIPCallHold", "h") <> "Yes" then asp_write("checked") end if%>><font color="#000000"><%tcWebApi_get("String_Entry","VoIPCallAnonymous1Text","s")%></font>
		</td></tr>
	<tr>
		<td class="light-orange">&nbsp;</td>
		<td class="light-orange"></td>
		<td class="tabdata" align=right><font color="#000000"><%tcWebApi_get("String_Entry","VoIPCallMWIText","s")%></font></td>
		<td class="tabdata" align=center>:</td>
		<td class="tabdata">
			<INPUT TYPE="RADIO" NAME="VoIPMWIEnable" VALUE="Yes" <%if TCWebAPI_get("VoIPCallCtrl_Entry", "SIPMWIEnable", "h") = "Yes" then asp_write("checked") end if%>><font color="#000000"><%tcWebApi_get("String_Entry","VoIPCallAnonymous0Text","s")%></font>
			<INPUT TYPE="RADIO" NAME="VoIPMWIEnable" VALUE="No" <%if TCWebAPI_get("VoIPCallCtrl_Entry", "SIPMWIEnable", "h") <> "Yes" then asp_write("checked") end if%>><font color="#000000"><%tcWebApi_get("String_Entry","VoIPCallAnonymous1Text","s")%></font>
		</td></tr>
	<tr>
<%end if%>

	<tr>
		<td width="150" height="30" class="title-main"><font color="#FFFFFF"><%tcWebApi_get("String_Entry","VoIPCallForwardText","s")%></font></td>
	...
	<tr>
		...
		<td class="light-orange" style="height: 22px"></td>
		<td class="tabdata" align=right style="height: 22px"><font color="#000000"><%tcWebApi_get("String_Entry","VoIPCallForwardText","s")%></font></td>
		<td class="tabdata" align=center style="height: 22px">:</td>
		<td class="tabdata" style="height: 22px">
			<INPUT TYPE="RADIO" NAME="VoIPCallForward" VALUE="Yes" <%if TCWebAPI_get("VoIPCallCtrl_Entry", "SIPCallForwardEnable", "h") = "Yes" then asp_write("checked") end if %> onclick="forwardOn(false)"><font color="#000000"><%tcWebApi_get("String_Entry","VoIPCallAnonymous0Text","s")%></font>
			<INPUT TYPE="RADIO" NAME="VoIPCallForward" VALUE="No" <%if TCWebAPI_get("VoIPCallCtrl_Entry", "SIPCallForwardEnable", "h") <> "Yes" then asp_write("checked") end if%> onclick="forwardOn(true)"><font color="#000000"><%tcWebApi_get("String_Entry","VoIPCallAnonymous1Text","s")%></font>
		</td></tr>
	<tr>
		<td class="light-orange">&nbsp;</td>
		<td class="light-orange"></td>
		<td class="tabdata" align=right><font color="#000000"><%tcWebApi_get("String_Entry","VoIPCallForwardNumberText","s")%></font></td>
		<td class="tabdata" align=center>:</td>
		<td class="tabdata">
	...
	<tr>
		<td class="light-orange">&nbsp;</td>
		<td class="light-orange"></td>
		<td class="tabdata" align=right><font color="#000000"><%tcWebApi_get("String_Entry","VoIPCallBusyForNumberText","s")%></font></td>
		<td class="tabdata" align=center>:</td>
		<td class="tabdata">
	...
	<tr>
		<td class="light-orange">&nbsp;</td>
		<td class="light-orange"></td>
		<td class="tabdata" align=right><font color="#000000"><%tcWebApi_get("String_Entry","VoIPCallReplyForNumberText","s")%></font></td>
		<td class="tabdata" align=center>:</td>
		<td class="tabdata">
	...
	<tr>
		<td width="150" height="30" class="title-main"><font color="#FFFFFF"><%tcWebApi_get("String_Entry","VoIPCallTransferText","s")%></font></td>
		<td width="10" class="black">&nbsp;</td>
		<td><hr noshade class="light-orange-line"></td>
		<td><hr noshade class="light-orange-line"></td>
		<td><hr noshade class="light-orange-line"></td></tr>
	...
	<tr>
		<td class="light-orange">&nbsp;</td>
		<td class="light-orange"></td>
		<td class="tabdata" align=right><font color="#000000"><%tcWebApi_get("String_Entry","VoIPCallTransferText","s")%></font></td>
		<td class="tabdata" align=center>:</td>
		<td class="tabdata">
			<INPUT TYPE="RADIO" NAME="VoIPCallTransfer" VALUE="Yes" <%if TCWebAPI_get("VoIPCallCtrl_Entry", "SIPCallTransfer", "h") = "Yes" then asp_write("checked") end if%> onclick="transferOn(false)" ><font color="#000000"><%tcWebApi_get("String_Entry","VoIPCallAnonymous0Text","s")%></font>
			<INPUT TYPE="RADIO" NAME="VoIPCallTransfer" VALUE="No" <%if TCWebAPI_get("VoIPCallCtrl_Entry", "SIPCallTransfer", "h") <> "Yes" then asp_write("checked") end if%> onclick="transferOn(true)" ><font color="#000000"><%tcWebApi_get("String_Entry","VoIPCallAnonymous1Text","s")%></font>
		</td></tr>
<% if TCWebAPI_get("VoIPMedia_Common", "VOIP_switch", "h") = "Yes" then%>
	<tr>
		<td class="light-orange">&nbsp;</td>
		<td class="light-orange"></td>
		<td class="tabdata" align=right><font color="#000000"><%tcWebApi_get("String_Entry","VoIPCallBlindTransferNoText","s")%></font></td>
		<td class="tabdata" align=center>:</td>
		<td class="tabdata">
...
<%end if%>
	<tr>
		<td class="light-orange">&nbsp;</td>
		<td class="light-orange"></td>
		<td class="tabdata" align=right><font color="#000000"><%tcWebApi_get("String_Entry","VoIPCallAttendedTransferNoText","s")%></font></td>
		<td class="tabdata" align=center>:</td>
		<td class="tabdata">
	...
	<tr>
		<td width="150" height="30" class="title-main"><font color="#FFFFFF"><%tcWebApi_get("String_Entry","VoIPCallConferenceText","s")%></font></td>
		<td width="10" class="black">&nbsp;</td>
		<td><hr noshade class="light-orange-line"></td>
		<td><hr noshade class="light-orange-line"></td>
		<td><hr noshade class="light-orange-line"></td></tr>
	...
	<tr>
		<td class="light-orange">&nbsp;</td>
		<td class="light-orange"></td>
		<td class="tabdata" align=right><font color="#000000"><%tcWebApi_get("String_Entry","VoIPCallConferenceText","s")%></font></td>
		<td class="tabdata" align=center>:</td>
		<td class="tabdata">
			<INPUT TYPE="RADIO" NAME="VoIP3wayConf" VALUE="Yes" <%if TCWebAPI_get("VoIPCallCtrl_Entry", "SIP3wayConf", "h") = "Yes" then asp_write("checked") end if%> onclick="conferenceOn(false)" ><font color="#000000"><%tcWebApi_get("String_Entry","VoIPCallAnonymous0Text","s")%></font>
			<INPUT TYPE="RADIO" NAME="VoIP3wayConf" VALUE="No" <%if TCWebAPI_get("VoIPCallCtrl_Entry", "SIP3wayConf", "h") <> "Yes" then asp_write("checked") end if%> onclick="conferenceOn(true)" ><font color="#000000"><%tcWebApi_get("String_Entry","VoIPCallAnonymous1Text","s")%></font>
		</td></tr>
	<tr>
		<td class="light-orange">&nbsp;</td>
		<td class="light-orange"></td>
		<td class="tabdata" align=right><font color="#000000"><%tcWebApi_get("String_Entry","VoIPCallConferenceNumberText","s")%></font></td>
		<td class="tabdata" align=center>:</td>
		<td class="tabdata">
		...
		<tr>
		<td width="150" height="30" class="title-main"><font color="#FFFFFF"><%tcWebApi_get("String_Entry","VoIPCallReturnText","s")%></font></td>
		<td width="10" class="black">&nbsp;</td>
		<td><hr noshade class="light-orange-line"></td>
		<td><hr noshade class="light-orange-line"></td>
		<td><hr noshade class="light-orange-line"></td></tr>
	...
	<tr>
		<td class="light-orange">&nbsp;</td>
		<td class="light-orange"></td>
		<td class="tabdata" align=right><font color="#000000"><%tcWebApi_get("String_Entry","VoIPCallReturnText","s")%></font></td>
		<td class="tabdata" align=center>:</td>
		<td class="tabdata">
			<INPUT TYPE="RADIO" NAME="VoIPCallReturn" VALUE="Yes" <%if TCWebAPI_get("VoIPCallCtrl_Entry", "SIPCallReturnEnable", "h") = "Yes" then asp_write("checked") end if%> onclick="callreturnOn(false)" ><font color="#000000"><%tcWebApi_get("String_Entry","VoIPCallAnonymous0Text","s")%></font>
			<INPUT TYPE="RADIO" NAME="VoIPCallReturn" VALUE="No" <%if TCWebAPI_get("VoIPCallCtrl_Entry", "SIPCallReturnEnable", "h") <> "Yes" then asp_write("checked") end if%> onclick="callreturnOn(true)" ><font color="#000000"><%tcWebApi_get("String_Entry","VoIPCallAnonymous1Text","s")%></font>
		</td></tr>
	<tr>
		<td class="light-orange">&nbsp;</td>
		<td class="light-orange"></td>
		<td class="tabdata" align=right><font color="#000000"><%tcWebApi_get("String_Entry","VoIPCallReturnNumberText","s")%></font></td>
		<td class="tabdata" align=center>:</td>
		<td class="tabdata">
	...
	<tr>
		<td width="150" height="30" class="title-main"><font color="#FFFFFF"><%tcWebApi_get("String_Entry","VoIPCalldonotDisturbText","s")%></font></td>
		<td width="10" class="black">&nbsp;</td>
		<td><hr noshade class="light-orange-line"></td>
		<td><hr noshade class="light-orange-line"></td>
		<td><hr noshade class="light-orange-line"></td></tr>
	...
	<tr>
		<td class="light-orange">&nbsp;</td>
		<td class="light-orange"></td>
		<td class="tabdata" align=right><font color="#000000"><%tcWebApi_get("String_Entry","VoIPCallDNDText","s")%></font></td>
		<td class="tabdata" align=center>:</td>
		<td class="tabdata">
			<INPUT TYPE="RADIO" NAME="VoIPDNDEnable" VALUE="Yes" <%if TCWebAPI_get("VoIPCallCtrl_Entry", "SIPDNDEnable", "h") = "Yes" then asp_write("checked") end if%> onclick="DNDOn(false)" ><font color="#000000"><%tcWebApi_get("String_Entry","VoIPCallAnonymous0Text","s")%></font>
			<INPUT TYPE="RADIO" NAME="VoIPDNDEnable" VALUE="No" <%if TCWebAPI_get("VoIPCallCtrl_Entry", "SIPDNDEnable", "h") <> "Yes" then asp_write("checked") end if%> onclick="DNDOn(true)" ><font color="#000000"><%tcWebApi_get("String_Entry","VoIPCallAnonymous1Text","s")%></font>
		</td></tr>
	<tr>
		<td class="light-orange">&nbsp;</td>
		<td class="light-orange"></td>
		<td class="tabdata" align=right><font color="#000000"><%tcWebApi_get("String_Entry","VoIPCallDNDenableText","s")%></font></td>
		<td class="tabdata" align=center>:</td>
		<td class="tabdata">
	...
	<tr>
		<td class="light-orange">&nbsp;</td>
		<td class="light-orange"></td>
		<td class="tabdata" align=right><font color="#000000"><%tcWebApi_get("String_Entry","VoIPCallDNDdisableText","s")%></font></td>
		<td class="tabdata" align=center>:</td>
		<td class="tabdata">
...
<%if TCWebAPI_get("VoIPBasic_Common", "SlicFXONum", "h") <> "0" then%>
	...
	<tr>
		<td class="light-orange">&nbsp;</td>
		<td class="light-orange"></td>
		<td class="tabdata" align=right><font color="#000000"><%tcWebApi_get("String_Entry","VoIPCallDODText","s")%></font></td>
		<td class="tabdata" align=center>:</td>
		<td class="tabdata">
	...
	<tr>
		<td class="light-orange">&nbsp;</td>
		<td class="light-orange"></td>
		<td class="tabdata" align=right><font color="#000000"><%tcWebApi_get("String_Entry","VoIPCallDODNumberText","s")%></font></td>
		<td class="tabdata" align=center>:</td>
		<td class="tabdata">
