...
<FORM METHOD="POST" ACTION="/cgi-bin/home_advancedwireless.asp" name="advancedwireless_form">
  <table width="760" border="0" align=center cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
    ...
    <tr> 
      <td width="150" height="30" class="title-main"> <font color="#FFFFFF"><%tcWebApi_get("String_Entry","AdvWirelessText","s")%></font> </td>
    ...
    <tr> 
      ...
      <td class="tabdata">&nbsp;</td>
      <td class="tabdata"><INPUT type=button style="width: 80px;" value="<%tcWebApi_get("String_Entry","ButtonBasicText","s")%>" name=btn_Basic onclick="onClickBasic()"></td>
      <td class="tabdata">&nbsp;</td>
      <td class="tabdata"><%tcWebApi_get("String_Entry","AdvWirelessPromptText","s")%> </td>
    </tr>
    <tr> 
    ...
    <tr> 
      ...
      <td class="light-orange"></td>
      <td class="tabdata">&nbsp;</td>
      <td class="tabdata"><INPUT type=button style="width: 80px;" value="<%tcWebApi_get("String_Entry","ButtonAdvancedText","s")%>" name=btn_Advanced onclick="onClickAdvanced()"></td>
      <td class="tabdata">&nbsp;</td>
      <td class="tabdata"><%tcWebApi_get("String_Entry","AdvWirelessPrompt1Text","s")%></td>
    </tr>
    <tr> 
      <td width="150" height="25" class="light-orange"><font color="#FFFFFF">&nbsp;</font></td>
      <td width="10" class="light-orange">&nbsp;</td>
	...
	<tr> 
      ...
      <td class="light-orange"></td>
      <td class="tabdata">&nbsp;</td>
      <td class="tabdata"><input type="button" style="width: 80px;" name="btn_Statistic" value="<%tcWebApi_get("String_Entry","ButtonStatisticsText","s")%>" onclick="onClickStatistic()"></td>
      <td class="tabdata">&nbsp;</td>
      <td class="tabdata"><%tcWebApi_get("String_Entry","AdvWirelessStatisticsText","s")%></td>
    </tr>
	<tr>
    	<td class="light-orange">&nbsp;</td>
		<td class="light-orange"></td>
