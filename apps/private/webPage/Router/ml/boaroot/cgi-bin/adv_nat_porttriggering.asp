	...
	<TBODY>
		...
		<TR>
			<TD class=title-main width=150 height=30>
				<FONT color=#ffffff><%tcWebApi_get("String_Entry","PortTriggerText","s")%></FONT>
			</TD>
...
<TABLE cellSpacing=0 cellPadding=0 width=760 align=center bgColor=#ffffff border=0>
	<TBODY>
		<TR>
			...
			<FONT color="black"><%tcWebApi_get("String_Entry","PortTriggerCommnetText","s")%></FONT>: 8</TD>
			<TD width=10>&nbsp;</TD>
		</TR>
		<TR>
					...
					<TBODY>
						<TR>
							<TD class=tabdata align=middle>
								<FONT color=#000000><%tcWebApi_get("String_Entry","PortTriggerApplicationText","s")%></FONT>&nbsp;:&nbsp; 
			...
			<TD align=middle><INPUT type=hidden value=8 name=PortTriggering_SubmitFlag>
				...
				<TBODY>
					<TR height=30>
						...
						<TD class=tabdata align=middle colSpan=3><STRONG><FONT color=#000000><%tcWebApi_get("String_Entry","PortTriggerRangeText","s")%></FONT></STRONG></TD>
						<TD class=tabdata align=middle colSpan=3><STRONG><FONT color=#000000><%tcWebApi_get("String_Entry","PortTriggerOpeningRangeText","s")%></FONT></STRONG></TD>
					</TR>
					<TR height=30>
						<TD class=tabdata align=middle>&nbsp;</TD>
						<TD class=tabdata align=middle><STRONG><FONT color=#000000><%tcWebApi_get("String_Entry","PortTriggerStartPort0Text","s")%></FONT></STRONG></TD>
						<TD class=tabdata align=middle><STRONG><FONT color=#000000><%tcWebApi_get("String_Entry","PortTriggerStartPort1Text","s")%></FONT></STRONG></TD>
						<TD class=tabdata align=middle><STRONG><FONT color=#000000><%tcWebApi_get("String_Entry","PortTriggerStartPort2Text","s")%></FONT></STRONG></TD>
						<TD class=tabdata align=middle><STRONG><FONT color=#000000><%tcWebApi_get("String_Entry","PortTriggerStartPort3Text","s")%></FONT></STRONG></TD>
						<TD class=tabdata align=middle><STRONG><FONT color=#000000><%tcWebApi_get("String_Entry","PortTriggerStartPort4Text","s")%></FONT></STRONG> </TD>
						<TD class=tabdata align=middle><STRONG><FONT color=#000000><%tcWebApi_get("String_Entry","PortTriggerStartPort5Text","s")%></FONT></STRONG> </TD>
					</TR>
					<TR>
						<TD class=tabdata align=middle>
