...
border=0>
  ...
  <TR>
    ...
    <TD class=light-orange>&nbsp;</TD>
    <TD class=tabdata>
      <DIV align=right><FONT color=#000000><% tcWebApi_get("String_Entry","AdvIP6SRouteRuleIndex","s") %></FONT> </DIV></TD>
    <TD class=tabdata>
  ...
  <TR>
    ...
    <TD class=light-orange>&nbsp;</TD>
    <TD class=tabdata>
      <DIV align=right><FONT color=#000000><% tcWebApi_get("String_Entry","AdvIP6SRouteAddPre","s") %></FONT> 
          </DIV></TD>
    <TD class=tabdata>
      <DIV align=center>:</DIV></TD>
  ...
  <TR>
    ...
    <TD class=light-orange>&nbsp;</TD>
    <TD class=tabdata>
      <DIV align=right><FONT color=#000000><% tcWebApi_get("String_Entry","AdvIP6SRouteGatewIP","s") %></FONT> </DIV></TD>
    <TD class=tabdata>
      <DIV align=center>:</DIV></TD>
    <TD class=tabdata>
  ...
  <TR>
	...
	<TR>
		...
		<TABLE cellSpacing=0 cellPadding=0 width=600 align=center bgColor=#ffffff border=1>
			<tr>
				<TD width=80 align="center" class="tabdata"><strong><% tcWebApi_get("String_Entry","AdvIP6SRouteIndex","s") %></strong></TD>
				<TD width=400 align="center" class="tabdata"><strong><% tcWebApi_get("String_Entry","AdvIP6SRouteGatewIP","s") %></strong></TD>
				<TD width=120 align="center" class="tabdata"><strong><% tcWebApi_get("String_Entry","AdvIP6SRouteGateway","s") %></strong></TD>
			</tr>
