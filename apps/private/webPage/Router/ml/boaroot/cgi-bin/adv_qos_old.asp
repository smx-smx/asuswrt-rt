...
if request_Form("QOS_Flag") = "0" then
	...
	TCWebAPI_set("QoS_Entry","eth0","QosPhyPortEth0")
/*
	TCWebAPI_set("QoS_Entry","eth1","QosPhyPortEth1")
	TCWebAPI_set("QoS_Entry","eth2","QosPhyPortEth2")	
	TCWebAPI_set("QoS_Entry","eth3","QosPhyPortEth3")
...
<form METHOD="POST" ACTION="/cgi-bin/adv_qos.asp" name="QoS_Form" onsubmit="return verifyForm()"><div align=center>
	<table width="760" align=center cellpadding="0" cellspacing="0">
		...
		<tr>
			<td width="150" height="30" class="title-main"><font color="#ffffff"><%tcWebApi_get("String_Entry","QosQualityServiceText","s")%></font></td>
		...
		<tr>
			...
			<td class="light-orange"></td>
			<td class="tabdata" align=right><font color="#000000"><%tcWebApi_get("String_Entry","QosText","s")%></font></td>
			<td class="tabdata" align=center>:</td>
			<td class="tabdata">
				<INPUT TYPE="RADIO" NAME="Qos_active" VALUE="Yes"
				<%if TCWebAPI_get("QoS_Common", "Active", "h") = "Yes" then asp_write("checked") end if %> onclick="enableAll();init();"><font color="#000000"><%tcWebApi_get("String_Entry","QosActivatedText","s")%></font>
				<INPUT TYPE="RADIO" NAME="Qos_active" VALUE="No"
				<%if TCWebAPI_get("QoS_Common", "Active", "h") = "No" then asp_write("checked") end if
				  if TCWebAPI_get("QoS_Common", "Active", "h") = "N/A" then asp_write("checked") end if%> onclick="disableAll();"><font color="#000000"><%tcWebApi_get("String_Entry","QosDeactivatedText","s")%></font>
			</td>
		</tr>			
<!--
		<tr>
...
-->
		<tr>
			<td class="light-orange">&nbsp;</td>
			<td class="light-orange"></td>
			<td class="tabdata" align=right><font color="#000000"><%tcWebApi_get("String_Entry","QosDisciplineText","s")%></font></td>
			<td class="tabdata" align=center>:</td>
			<td class="tabdata">
				<INPUT TYPE="RADIO" NAME="Qosdiscipline" VALUE="WRR"
				<%if TCWebAPI_get("QoS_Common", "Discipline", "h") = "WRR" then asp_write("checked") end if %>><font color="#000000"><%tcWebApi_get("String_Entry","QosWRRText","s")%></font>
				<INPUT TYPE="RADIO" NAME="Qosdiscipline" VALUE="SP"
				<%if TCWebAPI_get("QoS_Common", "Discipline", "h") = "SP" then asp_write("checked") end if
				  if TCWebAPI_get("QoS_Common", "Discipline", "h") = "N/A" then asp_write("checked") end if%>><font color="#000000"><%tcWebApi_get("String_Entry","QosPriorityText","s")%></font>
		...
		<tr>
			<td class="light-orange">&nbsp;</td>
			<td class="light-orange"></td>
			<td class="tabdata" align=right><font color="#000000"><%tcWebApi_get("String_Entry","QosWRRweightText","s")%></font></td>
			<td class="tabdata" align=center>:</td>
			<td class="tabdata">
				<font color="#000000"><%tcWebApi_get("String_Entry","QosWRRweight0Text","s")%></font><INPUT TYPE="TEXT" NAME="QosWRRweight1" SIZE="1" MAXLENGTH="2" VALUE="<%if TCWebAPI_get("QoS_Common", "WeightHighest", "h") <> "N/A" then TCWebAPI_get("QoS_Common", "WeightHighest", "s") else asp_Write("") end if %>">
				<font color="#000000"><%tcWebApi_get("String_Entry","QosWRRweight1Text","s")%></font><INPUT TYPE="TEXT" NAME="QosWRRweight2" SIZE="1" MAXLENGTH="2" VALUE="<%if TCWebAPI_get("QoS_Common", "WeightHigh", "h") <> "N/A" then TCWebAPI_get("QoS_Common", "WeightHigh", "s") else asp_Write("") end if %>">
				<font color="#000000"><%tcWebApi_get("String_Entry","QosWRRweight2Text","s")%></font><INPUT TYPE="TEXT" NAME="QosWRRweight3" SIZE="1" MAXLENGTH="2" VALUE="<%if TCWebAPI_get("QoS_Common", "WeightMedium", "h") <> "N/A" then TCWebAPI_get("QoS_Common", "WeightMedium", "s") else asp_Write("") end if %>">
				<font color="#000000"><%tcWebApi_get("String_Entry","QosWRRweight3Text","s")%></font><INPUT TYPE="TEXT" NAME="QosWRRweight4" SIZE="1" MAXLENGTH="2" VALUE="<%if TCWebAPI_get("QoS_Common", "WeightLow", "h") <> "N/A" then TCWebAPI_get("QoS_Common", "WeightLow", "s") else asp_Write("") end if %>"><font color="#000000"><%tcWebApi_get("String_Entry","QosValidText","s")%></font>
			</td>
		</tr>		
		<tr>
			<td class="light-orange">&nbsp;</td>
			...
			<td class="tabdata" align=center></td>
			<td class="tabdata">				
				<INPUT TYPE="BUTTON" NAME="Qosdisciplinesave" VALUE="<%tcWebApi_get("String_Entry","ButtonDiscSaveText","s")%>" onClick="onClickQosDiscipline();">
				<INPUT TYPE="BUTTON" NAME="Qos_Summary" VALUE="<%tcWebApi_get("String_Entry","ButtonRuleSumText","s")%>" onClick="onClickQosSummary();">				  
			</td>
		</tr>
		<tr>
			<td class="title-sub"><font color="#000000"><%tcWebApi_get("String_Entry","QosRuleText","s")%></font></td>
		...
		<tr>
			<td class="light-orange">&nbsp;</td>
			<td class="light-orange"></td>
			<td class="tabdata" align=right><font color="#000000"><%tcWebApi_get("String_Entry","QosRuleIndexText","s")%></font></td>
			<td class="tabdata" align=center>:</td>
			<td  class="tabdata">
		...
		<tr>
			<td class="light-orange">&nbsp;</td>
			<td class="light-orange"></td>
			<td class="tabdata" align=right><font color="#000000"><%tcWebApi_get("String_Entry","QosActiveText","s")%></font></td>
			<td class="tabdata" align=center>:</td>
			<td class="tabdata">
				<INPUT TYPE="RADIO" NAME="QosRuleActive" VALUE="Yes" 
				<%if TCWebAPI_get("QoS_Entry", "Active", "h") = "Yes" then asp_write("checked") end if %> onclick="formAppToPhyport(1);fromDMacToPriority(1);init();"><font color="#000000"><%tcWebApi_get("String_Entry","QosActivatedText","s")%></font>
				<INPUT TYPE="RADIO" NAME="QosRuleActive" VALUE="No" 
				<%if TCWebAPI_get("QoS_Entry", "Active", "h") = "No" then asp_write("checked") end if
				  if TCWebAPI_get("QoS_Entry", "Active", "h") = "N/A" then asp_write("checked") end if  %> onclick="formAppToPhyport(0);fromDMacToPriority(0);"><font color="#000000"><%tcWebApi_get("String_Entry","QosDeactivatedText","s")%></font>
			</td>
		</tr>
		<tr>
			<td class="light-orange">&nbsp;</td>
			<td class="light-orange"></td>
			<td class="tabdata" align=right><font color="#000000"><%tcWebApi_get("String_Entry","QosApplicationText","s")%></font></td>
			<td class="tabdata" align=center>:</td>
			<td class="tabdata">
		...
		<tr>
			...
			<td width="440" height="39" class="tabdata">
				<table border="1" cellpadding="0" cellspacing="0" bordercolor="#CCCCCC">
					<tr>
						<td width="40" align=center><INPUT TYPE="CHECKBOX" NAME="QosPhyPortEth0" <%if TCWebAPI_get("QoS_Entry", "eth0", "h") = "Yes" then asp_write("checked") end if %>></td>
<!--
						<td width="40" align=center><INPUT TYPE="CHECKBOX" NAME="QosPhyPortEth1" <%if TCWebAPI_get("QoS_Entry", "eth1", "h") = "Yes" then asp_write("checked") end if %>></td>
						<td width="40" align=center><INPUT TYPE="CHECKBOX" NAME="QosPhyPortEth2" <%if TCWebAPI_get("QoS_Entry", "eth2", "h") = "Yes" then asp_write("checked") end if %>></td>
						<td width="40" align=center><INPUT TYPE="CHECKBOX" NAME="QosPhyPortEth3" <%if TCWebAPI_get("QoS_Entry", "eth3", "h") = "Yes" then asp_write("checked") end if %>></td>
...
%>
		...
		<tr>
			...
			<td class="tabdata" align=right><font color="#000000"><%tcWebApi_get("String_Entry","QosDestinationMACText","s")%></font></td>
			<td class="tabdata" align=center>:</td>
			<td class="tabdata">
		...
		<tr>
			<td class="light-orange">&nbsp;</td>
			<td class="light-orange"></td>
			<td class="tabdata" align=right><font color="#000000"><%tcWebApi_get("String_Entry","QosIPText","s")%></font></td>
			<td class="tabdata" align=center>:</td>
			<td class="tabdata">
		...
		<tr>
			<td class="light-orange">&nbsp;</td>
			<td class="light-orange"></td>
			<td class="tabdata" align=right><font color="#000000"><%tcWebApi_get("String_Entry","QosMaskText","s")%></font></td>
			<td class="tabdata" align=center>:</td>
			<td class="tabdata">
		...
		<tr>
			<td class="light-orange">&nbsp;</td><td class="light-orange"></td>
			<td class="tabdata" align=right><font color="#000000"><%tcWebApi_get("String_Entry","QosPortRangeText","s")%></font></td>
			<td class="tabdata" align=center>:</td>
			<td class="tabdata">
		...
		<tr>
			<td class="light-orange">&nbsp;</td>
			<td class="light-orange"></td>
			<td class="tabdata" align=right><font color="#000000"><%tcWebApi_get("String_Entry","QosSourceMACText","s")%></font></td>
			<td class="tabdata" align=center>:</td>
			<td class="tabdata">
		...
		<tr>
			<td class="light-orange">&nbsp;</td>
			<td class="light-orange"></td><td class="tabdata" align=right><font color="#000000"><%tcWebApi_get("String_Entry","QosMaskText","s")%></font></td>
			<td class="tabdata" align=center>:</td>
			<td class="tabdata">
		...
		<tr>
			<td class="light-orange">&nbsp;</td>
			<td class="light-orange"></td>
			<td class="tabdata" align=right><font color="#000000"><%tcWebApi_get("String_Entry","QosProtocolIDText","s")%></font></td>
			<td class="tabdata" align=center>:</td>
			<td class="tabdata">
		...
		<tr>
			<td class="light-orange">&nbsp;</td>
			<td class="light-orange"></td>
			<td class="tabdata" align=right><font color="#000000"><%tcWebApi_get("String_Entry","QosVlanIDRangeText","s")%></font></td>
			<td class="tabdata" align=center>:</td>
			<td class="tabdata">
		...
		<tr>
			<td class="light-orange">&nbsp;</td>
			<td class="light-orange"></td>
			<td class="tabdata" align=right><font color="#000000"><%tcWebApi_get("String_Entry","QosFieldText","s")%></font></td>
			<td class="tabdata" align=center>:</td>
			<td class="tabdata">
				<INPUT TYPE="RADIO" NAME="Qos_IPP_DSCP1" VALUE="IPPTOS"
				<%if TCWebAPI_get("QoS_Entry", "IPPDSField", "h") = "IPPTOS" then asp_write("checked") end if %> onclick="ornIppTosDscp(2);"><font color="#000000"><%tcWebApi_get("String_Entry","QosField0Text","s")%></font>&nbsp;&nbsp;
				<INPUT TYPE="RADIO" NAME="Qos_IPP_DSCP1" VALUE="DSCP"
				<%if TCWebAPI_get("QoS_Entry", "IPPDSField", "h") = "DSCP" then asp_write("checked") end if
				  if TCWebAPI_get("QoS_Entry", "IPPDSField", "h") = "N/A" then asp_write("checked") end if %> onclick="ornIppTosDscp(3)"><font color="#000000"><%tcWebApi_get("String_Entry","QosField1Text","s")%></font>
			</td>
		</tr>
		<tr>
			<td class="light-orange">&nbsp;</td>
			<td class="light-orange"></td>
			<td class="tabdata" align=right><font color="#000000"><%tcWebApi_get("String_Entry","QosPrecedenceText","s")%></font></td>
			<td class="tabdata" align=center>:</td>
			<td class="tabdata">
		...
		<tr>
			<td class="light-orange">&nbsp;</td>
			<td class="light-orange"></td>
			<td class="tabdata" align=right><font color="#000000"><%tcWebApi_get("String_Entry","QosServiceText","s")%></font></td>
			<td class="tabdata" align=center>:</td>
			<td class="tabdata">
		...
		<tr>
			<td class="light-orange">&nbsp;</td>
			<td class="light-orange"></td>
			<td class="tabdata" align=right><font color="#000000"><%tcWebApi_get("String_Entry","QosDSCPRangeText","s")%></font></td>
			<td class="tabdata" align=center>:</td><td class="tabdata">
				...
				"<%if TCWebAPI_get("QoS_Entry", "DSCPRangeEnd", "h") <> "N/A" then TCWebAPI_get("QoS_Entry", "DSCPRangeEnd", "s") else asp_Write("") end if %>"><font color="#000000"><%tcWebApi_get("String_Entry","QosDSCPRangeCommText","s")%></font>
			</td>
		</tr>
		<tr>
			<td class="light-orange">&nbsp;</td><td class="light-orange"></td>
			<td class="tabdata" align=right><font color="#000000"><%tcWebApi_get("String_Entry","Qos8021pText","s")%></font></td>
			<td class="tabdata" align=center>:</td>
			<td class="tabdata">
		...
		<tr>
			<td class="title-sub"><font color="#000000"><%tcWebApi_get("String_Entry","QosActiveText","s")%></font></td>
			<td class="light-orange"></td>
			<td class="tabdata"><hr noshade class="light-orange-line"></td>
			<td class="tabdata"><hr noshade class="light-orange-line"></td>
			<td class="tabdata"><hr noshade class="light-orange-line"></td>
		...
		<tr>
			...
			<td class="tabdata">
				...
				<%if TCWebAPI_get("QoS_Entry", "ActIPPDSField", "h") = "IPPTOS" then asp_write("checked") end if %> onclick="reIppTosDscp(2);"><font color="#000000"><%tcWebApi_get("String_Entry","QosField0Text","s")%></font>&nbsp;&nbsp;
				...
				<%if TCWebAPI_get("QoS_Entry", "ActIPPDSField", "h") = "DSCP" then asp_write("checked") end if
				  if TCWebAPI_get("QoS_Entry", "ActIPPDSField", "h") = "N/A" then asp_write("checked") end if %> onclick="reIppTosDscp(3);"><font color="#000000"><%tcWebApi_get("String_Entry","QosField1Text","s")%></font>
			</td>
		</tr>
		<tr>
			<td class="light-orange">&nbsp;</td>
			<td class="light-orange"></td>
			<td class="tabdata" align=right><font color="#000000"><%tcWebApi_get("String_Entry","QosPrecedenceRemarkText","s")%></font></td>
			<td class="tabdata" align=center>:</td>
			<td class="tabdata">
		...
		<tr>
			<td class="light-orange">&nbsp;</td>
			<td class="light-orange"></td>
			<td class="tabdata" align=right><font color="#000000"><%tcWebApi_get("String_Entry","QosServiceRemarkText","s")%></font></td>
			<td class="tabdata" align=center>:</td>
			<td class="tabdata">
		...
		<tr>
			<td class="light-orange">&nbsp;</td>
			<td class="light-orange"></td>
			<td class="tabdata" align=right><font color="#000000"><%tcWebApi_get("String_Entry","QosDSCPRemarkingText","s")%></font></td>
			<td class="tabdata" align=center>:</td>
			<td class="tabdata">
				<INPUT TYPE="TEXT" NAME="QosReDSCPValue" SIZE="3" MAXLENGTH="2" VALUE=
				"<%if TCWebAPI_get("QoS_Entry", "ActDSCPRemarking", "h") <> "N/A" then TCWebAPI_get("QoS_Entry", "ActDSCPRemarking", "s") else asp_Write("") end if %>"><font color="#000000"><%tcWebApi_get("String_Entry","QosDSCPRemarkingCommText","s")%></font>
			</td>
		</tr>
	<!--
		<tr>
	...
	-->
		<tr>
			<td class="light-orange">&nbsp;</td>
			<td class="light-orange"></td>
			<td class="tabdata" align=right><font color="#000000"><%tcWebApi_get("String_Entry","QosQueueText","s")%></font></td>
			<td class="tabdata" align=center>:</td>
			<td class="tabdata">
	...
	<table width="760" border="0" align=center cellpadding="0" cellspacing="0">
		<tr>
			...
			<td width="440" class="orange">
				<INPUT TYPE="SUBMIT" NAME="QoS_Add" VALUE="<%tcWebApi_get("String_Entry","ButtonAddText","s")%>" onClick="doAdd();">
				<INPUT TYPE="SUBMIT" NAME="QoS_Del" VALUE="<%tcWebApi_get("String_Entry","ButtonDeleteText","s")%>" onClick="doDel();">
				<INPUT TYPE="SUBMIT" NAME="QoS_Cancel" VALUE="<%tcWebApi_get("String_Entry","ButtonCancelText","s")%>" onClick="document.forms[0].QOS_Flag.value = 3; javascript:window.location='adv_qos.htm'">
