...
function doSave()
{
	...
	with ( document.forms[0] ) 
	{
    	if (true == NAT_Session_mode[0].checked)
		{
			 ...
			 {
				alert("<%tcWebApi_get("String_Entry","NatSessionJS0Text","s")%>");
				return false;
			 }
		}
  	}
...
<FORM name=NAT_Session_form method=post>
	<TABLE cellSpacing=0 cellPadding=0 width=760 align=center bgColor=#ffffff border=0>
		<TBODY>
			...
			<TR>
				<TD class=title-main width=150 height=30><%tcWebApi_get("String_Entry","NatSessionText","s")%></TD>
			...
			<TR>
				...
				<TD>&nbsp;</TD>
				<TD class=tabdata>
					<DIV align=left><B><%tcWebApi_get("String_Entry","NatSessionLimitedText","s")%></B></DIV>
				</TD>
				<TD class=tabdata>
			...
			<TR>
				...
				<TD>&nbsp;</TD>
				<TD class=tabdata>
					<DIV align=left>&nbsp;&nbsp;&nbsp;&nbsp; <%tcWebApi_get("String_Entry","NatSessionCommentText","s")%> </DIV>
				</TD>
				<TD class=tabdata>
					<DIV align=center>:</DIV>
				</TD>
			...
			<TR>
				...
				<TD class=tabdata>
					<DIV align=left>
					<INPUT onclick=typeClick() type=radio <%if TCWebAPI_get("natSessions_setting", "SessionMode", "h") = "0" then asp_Write("CHECKED") elseif TCWebAPI_get("natSessions_setting", "SessionMode", "h") = "N/A" then asp_Write("CHECKED") end if %> value="0" name=NAT_Session_mode> &nbsp; <%tcWebApi_get("String_Entry","AdvSamSessPerUserText","s")%>
					</DIV>
				</TD>
				<TD class=tabdata>
					<DIV align=center></DIV>
			...
			<TR>
				...
				<TD>&nbsp;</TD>
				<TD class=tabdata>
				<DIV align=left>&nbsp;&nbsp;&nbsp;&nbsp; <%tcWebApi_get("String_Entry","AdvNATSessPerUserText","s")%></DIV>
				</TD>
				<TD class=tabdata>
					<DIV align=center>:</DIV>
				</TD>
			...
			<TR>
				...
				<TD class=tabdata colSpan=3>
					...
					&nbsp; <%tcWebApi_get("String_Entry","NatSessionComment1Text","s")%> 
					</DIV>
				</TD>
			</TR>
			<TR>
			...
			<TR>
				...
				<TD>&nbsp;</TD>
				<TD>
					<INPUT onclick="window.location='/cgi-bin/adv_nat_addsession.asp'" type=button value=<%tcWebApi_get("String_Entry","ButtonAddText","s")%> name=NATSession_AddBtn> 
				</TD>
			</TR>
			<TR>
				<TD class=light-orange>&nbsp;</TD>
		...
		<TBODY>
			<TR>
				...
				<TD class=orange width=440>
					<INPUT onclick=doSave(); type=button value=<%tcWebApi_get("String_Entry","ButtonSaveText","s")%> name=NATSession_SaveBtn> 
					<INPUT onclick="javascript:window.location='/cgi-bin/adv_nat_top.asp'" type=button value=<%tcWebApi_get("String_Entry","ButtonBackText","s")%> name=NATSession_BackBtn> 
				</TD>
			</TR>
		</TBODY>
	</TABLE>
