...
{
	window.open("/cgi-bin/portbinding_table.cgi","PortBind_List","toolbar=no,menubar=no,scrollbars=yes,height=400, width=600,location=0,left=100,top=100");
	return false;
}
</script>
...
<%end if%>
    ...
    <td height="25" class="light-orange">&nbsp;</td><td class="light-orange">&nbsp;</td><td height="80" class="tabdata">
      <div align=right>
      <font color="#000000"><%tcWebApi_get("String_Entry","PortbingdingWLanText","s")%></font>      </div></td><td class="tabdata"><div align=center>:</div></td><td height="25" class="tabdata">
	  <table border="1" cellpadding="0" cellspacing="0" bordercolor="#CCCCCC">
        <tr class="tabdata">
  ...
  <tr>
	...
	<input type="reset"  name="PortBind_group_cancel" value="<%tcWebApi_get("String_Entry","ButtonCancelText","s")%>">
	</td></tr></table></div>
	<INPUT TYPE="HIDDEN" NAME="ICIndex_Group" VALUE="1">
	<INPUT TYPE="HIDDEN" NAME="Add_or_Delete" VALUE="0">
	<INPUT TYPE="HIDDEN" NAME="MBSSIDNumber" ID="MBSSIDNumber" VALUE="<%tcWebApi_get("WLan_Common","BssidNum","s")%>"></form>
</body></html>
