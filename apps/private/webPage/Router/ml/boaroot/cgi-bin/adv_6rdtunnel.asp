...
border=0>
      <TBODY>
        ...
        <TR> 
          ...
          <TD class=light-orange></TD>
          <TD class=tabdata> <DIV align=right><FONT color=#000000><%tcWebApi_get("String_Entry","6RDTunnelText","s")%></FONT> 
            </DIV></TD>
          ...
          <TD class=tabdata> <INPUT type="radio" value="Yes" name="tunnelEnable"  <% if tcWebApi_get("ipv6rd_Entry","Active","h") = "Yes" then asp_Write("checked") elseif tcWebApi_get("ipv6rd_Entry","Active","h") = "N/A" then asp_Write("checked") end if %> onclick="init()"> 
            <FONT color=#000000><%tcWebApi_get("String_Entry","6RDEnabledText","s")%></FONT> <INPUT type="radio" value="No" name="tunnelEnable" <% if tcWebApi_get("ipv6rd_Entry","Active","h") = "No" then asp_Write("checked") end if %> onclick="init()"> 
            <FONT color=#000000><%tcWebApi_get("String_Entry","6RDDisabledText","s")%></FONT> </TD>
        </TR>
        <TR> 
          <TD class=light-orange>&nbsp;</TD>
          <TD class=light-orange></TD>
          <TD class=tabdata> <DIV align=right><font color="#000000"><%tcWebApi_get("String_Entry","6RDIPv6PrefixText","s")%></font> 
            </DIV></TD>
          <TD class=tabdata> <DIV align=center>:</DIV></TD>
        ...
        <TR> 
          <TD class=light-orange>&nbsp;</TD>
          <TD class=light-orange></TD>
          <TD class=tabdata> <DIV align=right><font color="#000000"><%tcWebApi_get("String_Entry","6RDIPv4MaskLengthText","s")%></font></DIV></TD>
          <TD class=tabdata> <DIV align=center>:</DIV></TD>
        ...
        <TR> 
          <TD class=light-orange>&nbsp;</TD>
          <TD class=light-orange></TD>
          <TD class=tabdata> <DIV align=right><font color="#000000"><%tcWebApi_get("String_Entry","6RDBorderRelayIPv4AddrText","s")%></font></DIV></TD>
          <TD class=tabdata> <DIV align=center>:</DIV></TD>
...
<td class="light-orange">&nbsp;</td><td class="light-orange">&nbsp;</td><td class="tabdata"><div align=right> 
              <font color="#000000"><%tcWebApi_get("String_Entry","6RDPrefixDelegationText","s")%></font></div></td><td class="tabdata"><div align=center>:</div></td><td class="tabdata">
  ...
  <tr height="42" >
    <td width="160" class="black">&nbsp;</td><td width="160" class="orange">&nbsp;</td><td width="440" class="orange">
        <INPUT TYPE="button" NAME="SaveBtn" VALUE="<%tcWebApi_get("String_Entry","ButtonSaveText","s")%>" onClick="uiSave()">
          ...
          <INPUT TYPE="reset" NAME="lan_cancel" VALUE="<%tcWebApi_get("String_Entry","ButtonCancelText","s")%>" ></td></tr>
      </tbody>
    </table>
  </DIV>
