...
<table width="760" border="0" align=center cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
  <tr>
      ...
      <font color="#FFFFFF"><%tcWebApi_get("String_Entry","LANLocalIPText","s")%></font>      </td><td width="10" class="black"></td><td width="150"></td><td width="10" ></td><td width="440"></td></tr>
     <tr>
    <td class="light-orange">&nbsp;</td><td class="light-orange">&nbsp;</td><td class="tabdata"><div align=right>
    <font color="#000000"><%tcWebApi_get("String_Entry","LANIPAddressText","s")%></font>    </div></td><td class="tabdata"><div align=center>:</div></td><td class="tabdata">
    ...
    <td class="light-orange">&nbsp;</td><td class="light-orange">&nbsp;</td><td class="tabdata"> <div align=right>
    <font color="#000000"><%tcWebApi_get("String_Entry","LANMaskText","s")%></font>    </div></td><td class="tabdata"><div align=center>:</div></td><td class="tabdata">
...
<% If tcWebApi_get("LanAlias_Entry","Active","h") = "Yes" Then%>
    ...
    <font color="#000000"><%tcWebApi_get("String_Entry","LANAliasIPText","s")%></font>    </div></td><td class="tabdata"><div align=center>:</div></td><td class="tabdata">
    ...
    <td class="light-orange">&nbsp;</td><td class="light-orange">&nbsp;</td><td class="tabdata"> <div align=right>
    <font color="#000000"><%tcWebApi_get("String_Entry","LANAliasMaskText","s")%></font>    </div></td><td class="tabdata"><div align=center>:</div></td><td class="tabdata">
...
<tr>
    <td class="light-orange">&nbsp;</td><td class="light-orange"></td><td class="tabdata"><div align=right>
    <font color="#000000"><%tcWebApi_get("String_Entry","LANIgmpSnoopText","s")%></font>    </div></td><td class="tabdata"><div align=center>:</div></td><td class="tabdata">
		<INPUT NAME="lan_Igmpsnoop" TYPE="RADIO" VALUE="Yes" <% If TCWebApi_get("Lan_IgmpSnoop","igmpsnoopEnable","h") = "Yes" then asp_Write("checked") end if%> >		<font color="#000000"><%tcWebApi_get("String_Entry","LANStatus0Text","s")%></font>		
		<INPUT TYPE="RADIO" NAME="lan_Igmpsnoop" VALUE="No" <% If TCWebApi_get("Lan_IgmpSnoop","igmpsnoopEnable","h") = "No" then asp_Write("checked") end if%> >		<font color="#000000"><%tcWebApi_get("String_Entry","LANStatus1Text","s")%></font>	</td></tr>
<%end if%>	
<%if tcwebApi_get("WebCustom_Entry","isMLDSupported","h") = "Yes" then%>
	<tr>
    <td class="light-orange">&nbsp;</td><td class="light-orange"></td><td class="tabdata"><div align=right>
    <font color="#000000"><%tcWebApi_get("String_Entry","LANMldSnoopText","s")%></font>    </div></td><td class="tabdata"><div align=center>:</div></td><td class="tabdata">
		<INPUT TYPE="RADIO" NAME="lan_Mldsnoop" VALUE="Yes" <% If TCWebApi_get("Lan_MldSnoop","mldsnoopEnable","h") = "Yes" then asp_Write("checked") end if%> >		<font color="#000000"><%tcWebApi_get("String_Entry","LANStatus0Text","s")%></font>		
		<INPUT TYPE="RADIO" NAME="lan_Mldsnoop" VALUE="No" <% If TCWebApi_get("Lan_MldSnoop","mldsnoopEnable","h") = "No" then asp_Write("checked") end if%> >		<font color="#000000"><%tcWebApi_get("String_Entry","LANStatus1Text","s")%></font>	</td></tr>
<%end if%>
  <tr>
    <td class="light-orange">&nbsp;</td><td class="light-orange"></td>
    <td class="tabdata"><div align=right><font color="#000000"><%tcWebApi_get("String_Entry","LANDynamicRouteText","s")%></font></div></td><td width="10" class="tabdata"><div align=center>:</div></td><td class="tabdata">
		...
		</SELECT><font color="#000000"><%tcWebApi_get("String_Entry","LANDirectionText","s")%></font>
	...
	<% If tcWebApi_get("WebCustom_Entry","isRipngSupported","h") = "Yes" Then %>
		...
		<td width="150" height="30" class="light-orange">&nbsp;</td>
                ...
                <td width="150" class="tabdata"><div align=right> <font color="#000000">
                         <%tcWebApi_get("String_Entry","LANRipngText","s")%>
                </font></div></td>
  ...
  <tr>
    <td width="150" height="30" class="title-main">
    <font color="#FFFFFF"><%tcWebApi_get("String_Entry","LANDHCPText","s")%></font>    </td><td width="10" class="black">&nbsp;</td><td width="150"><hr noshade></td><td width= "10"><hr noshade></td><td width="440"><hr noshade> </td></tr><tr>
    <td class="light-orange">&nbsp;</td><td class="light-orange"></td><td class="tabdata"><div align=right>
    <font color="#000000"><%tcWebApi_get("String_Entry","LANDHCPText","s")%></font>    </div></td><td class="tabdata"><div align=center>:</div></td><td class="tabdata">
        <INPUT TYPE="RADIO" NAME="dhcpTypeRadio" VALUE="0" <%If tcWebApi_get("Lan_Dhcp","type","h") = "0" then asp_Write("checked") elseIf tcWebApi_get("Lan_Dhcp","type","h") = "N/A" then asp_Write("checked") end if%> onClick="doReload()"><font color="#000000"><%tcWebApi_get("String_Entry","LANDHCP0Text","s")%></font>
        <INPUT TYPE="RADIO" NAME="dhcpTypeRadio" VALUE="1" <%If tcWebApi_get("Lan_Dhcp","type","h") = "1" then asp_Write("checked") end if%> onClick="doReload()"><font color="#000000"><%tcWebApi_get("String_Entry","LANDHCP1Text","s")%></font>
        <INPUT TYPE="RADIO" NAME="dhcpTypeRadio" VALUE="2" <%If tcWebApi_get("Lan_Dhcp","type","h") = "2" then asp_Write("checked") end if%> onClick="doReload()"><font color="#000000"><%tcWebApi_get("String_Entry","LANDHCP2Text","s")%></font>
<% If tcWebApi_get("GUI_Entry0","dhcpClientMode","h") = "support" Then%>		
		<INPUT TYPE="RADIO" NAME="dhcpTypeRadio" VALUE="3" <%If tcWebApi_get("Lan_Dhcp","type","h") = "3" then asp_Write("checked") end if%> onClick="doReload()"><font color="#000000"><%tcWebApi_get("String_Entry","LANDHCP3Text","s")%></font>
<% End If %>
    </td>
  </tr>
</table>
...
<table width="760" border="0" align=center cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
	<tr>
		...
		<td class="tabdata" width="150">
			<div align=right>
			<font color="#000000"><%tcWebApi_get("String_Entry","LANReservationIPText","s")%></font>
			</div>
		</td>
...
<div id="dhcp_enabled_div0">
    ...
    <font color="#000000"><%tcWebApi_get("String_Entry","LANStartIPText","s")%></font>    </div></td><td class="tabdata" width="10"><div align=center>:</div></td><td class="tabdata">
    ...
    <font color="#000000"><%tcWebApi_get("String_Entry","LANIPPoolText","s")%></font>    </div></td><td class="tabdata"><div align=center>:</div></td><td class="tabdata">
    ...
    <% If tcWebApi_get("Dhcpd_Option60","Active","h") = "Yes" Then%>
    		<tr><td class="light-orange">&nbsp;</td><td class="light-orange">&nbsp;</td><td class="tabdata"><div align=right>
    <font color="#000000"><%tcWebApi_get("String_Entry","LANConStartIPText","s")%></font>    </div></td><td class="tabdata"><div align=center>:</div></td><td class="tabdata">
        <INPUT TYPE="TEXT" NAME="ConPoolStartIp" SIZE="15" MAXLENGTH="15" VALUE="<%If tcWebApi_get("Dhcpd_Option60","start","h") <>"N/A" then tcWebApi_get("Dhcpd_Option60","start","s") end if%>" >	        
     		...
     		<tr><td class="light-orange">&nbsp;</td><td class="light-orange">&nbsp;</td><td class="tabdata"><div align=right>
    <font color="#000000"><%tcWebApi_get("String_Entry","LANConPoolCountText","s")%></font>    </div></td><td class="tabdata"><div align=center>:</div></td><td class="tabdata">
        <INPUT TYPE="TEXT" NAME="ConPoolPoolSize" SIZE="15" MAXLENGTH="3" VALUE="<%If tcWebApi_get("Dhcpd_Option60","pool_count","h") <>"N/A" then tcWebApi_get("Dhcpd_Option60","pool_count","s") end if%>" >	        
         	...
         	<tr><td class="light-orange">&nbsp;</td><td class="light-orange">&nbsp;</td><td class="tabdata"><div align=right>
    <font color="#000000"><%tcWebApi_get("String_Entry","LANVendorText","s")%></font>    </div></td><td class="tabdata"><div align=center>:</div></td><td class="tabdata">
    ...
    <tr><td class="light-orange">&nbsp;</td><td class="light-orange">&nbsp;</td><td class="tabdata"><div align=right>
    <font color="#000000"><%tcWebApi_get("String_Entry","LANLeaseTimeText","s")%></font>    </div></td><td class="tabdata"><div align=center>:</div></td><td class="tabdata">
 ...
 <%end if%>
	 ...
	 <tr>
			...
			<td width="150" class="tabdata" align=right><font color="#000000"><%tcWebApi_get("String_Entry","QosPhysicalPortsText","s")%></font></td>
...
<% end if %>
						...
						<tr class="tabdata">
						<td class="tabdata" align=center><font color="#000000"><%tcWebApi_get("String_Entry","Qoseth0Text","s")%></font></td>
						<td class="tabdata" align=center><font color="#000000"><%tcWebApi_get("String_Entry","Qoseth1Text","s")%></font></td>
						<% if tcWebApi_get("WebCustom_Entry","is2PSupported","h") <> "Yes" then %>
						<td class="tabdata" align=center><font color="#000000"><%tcWebApi_get("String_Entry","Qoseth2Text","s")%></font></td>
						<td class="tabdata" align=center><font color="#000000"><%tcWebApi_get("String_Entry","Qoseth3Text","s")%></font></td>
						<% end if %>
<!--
...
<%
	if TCWebAPI_get("WLan_Common","BssidNum","h") = "1" then
%>
						<td class="tabdata" align=center><font color="#000000"><%tcWebApi_get("String_Entry","Qosra0Text","s")%></font></td>
<%
	end if
%>				
					</tr>
...
%>
					...
					<tr class="tabdata">
					<td class="tabdata" align=center><font color="#000000"><%tcWebApi_get("String_Entry","Qosra0Text","s")%></font></td>
					<td class="tabdata" align=center><font color="#000000"><%tcWebApi_get("String_Entry","Qosra1Text","s")%></font></td>
					</tr>
<%
	elseif TCWebAPI_get("WLan_Common","BssidNum","h") = "3" then
%>
					...
					<td class="tabdata" align=center><font color="#000000"><%tcWebApi_get("String_Entry","Qosra0Text","s")%></font></td>
					<td class="tabdata" align=center><font color="#000000"><%tcWebApi_get("String_Entry","Qosra1Text","s")%></font></td>
					<td class="tabdata" align=center><font color="#000000"><%tcWebApi_get("String_Entry","Qosra2Text","s")%></font></td>
					</tr>
<%
	elseif TCWebAPI_get("WLan_Common","BssidNum","h") = "4" then
%>
					...
					<td class="tabdata" align=center><font color="#000000"><%tcWebApi_get("String_Entry","Qosra1Text","s")%></font></td>
					<td class="tabdata" align=center><font color="#000000"><%tcWebApi_get("String_Entry","Qosra2Text","s")%></font></td>
					<td class="tabdata" align=center><font color="#000000"><%tcWebApi_get("String_Entry","Qosra3Text","s")%></font></td>
					</tr>
...
<%if tcWebApi_get("WebCurSet_Entry","UserMode","h")<>"1" then%>
     <tr>
    <td width="150" height="30" class="title-main">
    <font color="#FFFFFF"><%tcWebApi_get("String_Entry","LANDNSText","s")%></font>    </td><td width="10" class="black">&nbsp;</td><td width="150"><hr noshade></td><td width= "10"><hr noshade></td><td width="440"><hr noshade> </td></tr>
    <tr><td class="light-orange">&nbsp;</td><td class="light-orange">&nbsp;</td><td class="tabdata"><div align=right>
    <font color="#000000"><%tcWebApi_get("String_Entry","LANDNSRelayText","s")%></font>   </div></td><td class="tabdata"><div align=center></div></td><td class="tabdata">
	    <INPUT TYPE="RADIO" NAME="dnsTypeRadio" VALUE="0" onClick="autoDNSRelay()" <%If tcWebApi_get("Dproxy_Entry","type","h") = "0" then asp_Write("checked") elseif  tcWebApi_get("Dproxy_Entry","type","h") = "N/A" then asp_Write("checked") end if%> ><font color="#000000"><%tcWebApi_get("String_Entry","LANAutomaticallyText","s")%></font>
	    <INPUT TYPE="RADIO" NAME="dnsTypeRadio" VALUE="1" onClick="manualDNSRelay()" <%If tcWebApi_get("Dproxy_Entry","type","h") = "1" then asp_Write("checked") end if%> ><font color="#000000"><%tcWebApi_get("String_Entry","LANManuallyText","s")%></font>
     </td></tr>
     
    <tr><td class="light-orange">&nbsp;</td><td class="light-orange">&nbsp;</td><td class="tabdata"><div align=right>
    <font color="#000000"><%tcWebApi_get("String_Entry","LANPrimaryDNSText","s")%></font>    </div></td><td class="tabdata"><div align=center>:</div></td><td class="tabdata">
    ...
    <tr><td class="light-orange">&nbsp;</td><td class="light-orange">&nbsp;</td><td class="tabdata"><div align=right>
    <font color="#000000"><%tcWebApi_get("String_Entry","LANSecondaryDNSText","s")%></font>    </div></td><td class="tabdata"><div align=center>:</div></td><td class="tabdata">
	...
	<%if tcwebApi_get("WebCustom_Entry","isDhcpStaticSupported","h")="Yes" then%>	 	 
	 	<tr>
    <td width="150" height="30" class="title-main">
    <font color="#FFFFFF"><%tcWebApi_get("String_Entry","LANReservationText","s")%></font>    </td><td width="10" class="black">&nbsp;</td><td width="150"><hr noshade></td><td width= "10"><hr noshade></td><td width="440"><hr noshade> </td></tr>
	<tr><td class="light-orange">&nbsp;</td><td class="light-orange">&nbsp;</td><td class="tabdata"><div align=right> 
            <font color="#000000"><%tcWebApi_get("String_Entry","LANReservationIPText","s")%></font> </div></td><td class="tabdata"><div align=center>:</div></td><td class="tabdata">
        <INPUT TYPE="TEXT" NAME="IpAddr" SIZE="15" MAXLENGTH="15" VALUE="" >
          <font color="#000000"> <%tcWebApi_get("String_Entry","LANReservationMACText","s")%></font><font color="#000000"> : </font>
<INPUT TYPE="TEXT" NAME="MACAddr" SIZE="15" MAXLENGTH="17" VALUE="" >	        
	...
	<tr height="30">
		<td width="50" align=center class="tabdata"><strong><font color="#000000"><%tcWebApi_get("String_Entry","LANSTABLEINDEXText","s")%></font></strong></td>
		<td width="150" align=center class="tabdata"><strong><font color="#000000"><%tcWebApi_get("String_Entry","LANSTABLEIPText","s")%></font></strong></td>
		<td width="150" align=center class="tabdata"><strong><font color="#000000"><%tcWebApi_get("String_Entry","LANSTABLEMACText","s")%></font></strong></td>
		<td width="50" align=center class="tabdata"><strong><font color="#000000"><%tcWebApi_get("String_Entry","LANSTABLEDROPText","s")%></font></strong></td>
	</tr>
...
<%End if%>		
	 <tr>
    <td width="150" height="30" class="title-main">
    <font color="#FFFFFF"><%tcWebApi_get("String_Entry","LANDHCPListText","s")%></font>    </td><td width="10" class="black">&nbsp;</td><td width="150"><hr noshade></td><td width= "10"><hr noshade></td><td width="440"><hr noshade> </td></tr>	 
	 <tr>
    <td width="150" class="light-orange">&nbsp;</td><td width="10"  class="light-orange"></td><td colspan="3" align=center>
 <!--
...
<div id="dhcp_relay_div">
	<table width="760" border="0" align=center cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
		<tr><td class="light-orange" width=150>&nbsp;</td><td class="light-orange" width=10>&nbsp;</td><td class="tabdata" width=150><div align=right>
    <font color="#000000"><%tcWebApi_get("String_Entry","LANServerIPText","s")%></font>    </div></td><td class="tabdata" width="10"><div align=center>:</div></td><td class="tabdata">
...
<table width="760" border="0" align=center cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
	<tr> 
		<td width="150" height="30" class="title-main"> <font color="#FFFFFF"><%tcWebApi_get("String_Entry","LANOUIText","s")%></font></td>
...
<% End If %>  
	...
	<table width="760" border="0" align=center cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
      <tr> 
        <td width="150" height="30" class="title-main"> <font color="#FFFFFF"><%tcWebApi_get("String_Entry","LANIPv6Text","s")%></font> 
        </td>
        <td width="10" class="black"></td>
        <td width="150"><hr noshade></td>
        <td width="12" ><hr noshade></td>
	  ...
	  <tr> 
        <td class="light-orange">&nbsp;</td>
        <td class="light-orange">&nbsp;</td>
        <td class="tabdata"><div align=right> <font color="#000000"><%tcWebApi_get("String_Entry","LANIPv6GlobalText","s")%></font></div></td>
        <td class="tabdata"><div align=center>:</div></td>
	  ...
	  <tr> 
        <td width="150" height="30" class="title-main"> <font color="#FFFFFF"><%tcWebApi_get("String_Entry","LANRadvdText","s")%></font> 
        </td>
        <td width="10" class="black"></td>
        <td width="150"><hr noshade></td>
        <td width="12" ><hr noshade></td>
     ...
     <tr>
        ...
        <td class="light-orange">&nbsp;</td>
        <td class="tabdata"><div align=right> <font color="#000000"><%tcWebApi_get("String_Entry","LANRadvdEnableText","s")%></font> 
          </div></td>
        <td class="tabdata"><div align=center>:</div></td>
        <td class="tabdata"> <INPUT TYPE="RADIO" NAME="radvdRadio" VALUE="0" onClick="radvdChanged()" <%If tcWebApi_get("Radvd_Entry","Enable","h") = "0" then asp_Write("checked") elseif  tcWebApi_get("Radvd_Entry","Enable","h") = "N/A" then asp_Write("checked") end if%> > 
          <font color="#000000"><%tcWebApi_get("String_Entry","LANRadvdEnable0Text","s")%></font> <INPUT TYPE="RADIO" NAME="radvdRadio" VALUE="1" onClick="radvdChanged()" <%If tcWebApi_get("Radvd_Entry","Enable","h") = "1" then asp_Write("checked") end if%> > 
          <font color="#000000"><%tcWebApi_get("String_Entry","LANRadvdEnable1Text","s")%></font> </td>
	...
	<tr id="div_radvdmode">
        <td width="150" height="30" class="light-orange">&nbsp;</td>
        <td width="10" class="light-orange">&nbsp;</td>
        <td width="150" class="tabdata"><div align=right> <font color="#000000"><%tcWebApi_get("String_Entry","LANRadvdModeText","s")%></font> </div></td>
        <td width="10" class="tabdata"><div align=center>:</div></td>
        <td width="440" class="tabdata"> <INPUT TYPE="RADIO" NAME="radvdModeRadio" VALUE="0" onClick="radvdModeChanged()" <%If tcWebApi_get("Radvd_Entry","Mode","h") = "0" then asp_Write("checked") elseif  tcWebApi_get("Radvd_Entry","Mode","h") = "N/A" then asp_Write("checked") end if%> >
          <font color="#000000"><%tcWebApi_get("String_Entry","LANRadvdMode0Text","s")%></font>
          ...
          <font color="#000000"><%tcWebApi_get("String_Entry","LANRadvdMode1Text","s")%></font> </td>
		  <INPUT TYPE="HIDDEN" NAME="radvdModeFlag" VALUE=<%  tcWebApi_get("Radvd_Entry","Mode","s") %> >
     </tr>	
	 <tr id="div_radvdprelen">
        <td class="light-orange">&nbsp;</td>
        <td class="light-orange">&nbsp;</td>
        <td class="tabdata"><div align=right> <font color="#000000"><%tcWebApi_get("String_Entry","LANPrefixText","s")%></font></div></td>
        <td class="tabdata"><div align=center>:</div></td>
	  ...
	  <tr id="div_radvdprelite">
        ...
        <td class="light-orange">&nbsp;</td>
        <td class="tabdata"><div align=right> <font color="#000000"><%tcWebApi_get("String_Entry","LANPreferredLifetimeText","s")%></font> </div></td>
        <td class="tabdata"><div align=center>:</div></td>
      ...
      <tr id="div_radvdvate"> 
        <td class="light-orange">&nbsp;</td>
        <td class="light-orange">&nbsp;</td>
        <td class="tabdata"><div align=right> <font color="#000000"><%tcWebApi_get("String_Entry","LANValidLifetimeText","s")%></font> 
          </div></td>
        <td class="tabdata"><div align=center>:</div></td>
...
<% if tcWebApi_get("WebCustom_Entry","isRaFlagSetSupported","h") = "Yes" then %>
	  	<tr>
    <td class="light-orange">&nbsp;</td><td class="light-orange"></td>
    <td class="tabdata"><div align=right><font color="#000000"><%tcWebApi_get("String_Entry","LANRAFlagSetText","s")%></font></div></td><td width="10" class="tabdata"><div align=center>:</div></td>
		...
		<OPTION value="on" <% if tcWebApi_get("Radvd_Entry","M_Flag","h") = "on" then asp_Write("selected") end if %>><%tcWebApi_get("String_Entry","LANonText","s")%>
            ...
            <font color="#000000"><%tcWebApi_get("String_Entry","LANOtherConfigText","s")%></font> 
...
<% End If %> 
	...
	<table width="760" border="0" align=center cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
      <tr> 
        <td width="150" height="30" class="title-main"> <font color="#FFFFFF"><%tcWebApi_get("String_Entry","LANDHCPv6Text","s")%></font> 
        </td>
        <td width="10" class="black"></td>
        <td width="150"><hr noshade></td>
      ...
      <tr>
        <td height="30" class="light-orange">&nbsp;</td>
        <td class="light-orange">&nbsp;</td>
        <td class="tabdata"><div align=right> <font color="#000000"><%tcWebApi_get("String_Entry","LANDHCPv6ServerText","s")%></font></div></td>
        <td class="tabdata"><div align=center>:</div></td>
        <td class="tabdata"> <INPUT TYPE="RADIO" NAME="dhcp6sEnableRadio" VALUE="0" onClick="dhcp6sChanged()" <%If tcWebApi_get("Dhcp6s_Entry","Enable","h") = "0" then asp_Write("checked") elseif  tcWebApi_get("Dhcp6s_Entry","Enable","h") = "N/A" then asp_Write("checked") end if%> > 
          <font color="#000000"><%tcWebApi_get("String_Entry","LANDHCPv6Server0Text","s")%></font> <INPUT TYPE="RADIO" NAME="dhcp6sEnableRadio" VALUE="1" onClick="dhcp6sChanged()" <%If tcWebApi_get("Dhcp6s_Entry","Enable","h") = "1" then asp_Write("checked") end if%> > 
          <font color="#000000"><%tcWebApi_get("String_Entry","LANDHCPv6Server1Text","s")%></font> </td>
	...
	<tr>
        <td width="150" height="30" class="light-orange">&nbsp;</td>
        <td width="10" class="light-orange">&nbsp;</td>
        <td width="150" class="tabdata"><div align=right> <font color="#000000"><%tcWebApi_get("String_Entry","LANDHCPv6ModeText","s")%></font></div></td>
        <td width="10" class="tabdata"><div align=center>:</div></td>
        <td width="440" class="tabdata"> <INPUT TYPE="RADIO" NAME="dhcp6sModeRadio" VALUE="0"  onClick="dhcp6sModeChanged()" <%If tcWebApi_get("Dhcp6s_Entry","Mode","h") = "0" then asp_Write("checked") elseif  tcWebApi_get("Dhcp6s_Entry","Mode","h") = "N/A" then asp_Write("checked") end if%> > 
          <font color="#000000"><%tcWebApi_get("String_Entry","LANDHCPv6Mode0Text","s")%></font> <INPUT TYPE="RADIO" NAME="dhcp6sModeRadio" VALUE="1"  onClick="dhcp6sModeChanged()" <%If tcWebApi_get("Dhcp6s_Entry","Mode","h") = "1" then asp_Write("checked") end if%> > 
          <font color="#000000"><%tcWebApi_get("String_Entry","LANDHCPv6Mode1Text","s")%></font>  </td>
      </tr>
	...
	<% end if %>
        ...
        <table width="760" border="0" align=center cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
        <tr>
                <td width="150" height="30" class="title-main"><font color="#FFFFFF"><%tcWebApi_get("String_Entry","LANMediaTypeText","s")%></font></td>
                <td width="10" class="black">&nbsp;</td>
                <td width="150"><hr noshade></td>
                <td width="10" ><hr noshade></td>
                <td width="440"><hr noshade></td>
        ...
        <tr>
                <td class="light-orange">&nbsp;</td>
                <td class="light-orange">&nbsp;</td>
                <td class="tabdata"><div align=right><font color="#000000"><%tcWebApi_get("String_Entry","LANMediaPort1Text","s")%></font></div></td>
                <td class="tabdata"><div align=center>:</div></td>
                <td class="tabdata">
        ...
        <tr>
                <td class="light-orange">&nbsp;</td>
                <td class="light-orange">&nbsp;</td>
                <td class="tabdata"><div align=right><font color="#000000"><%tcWebApi_get("String_Entry","LANMediaPort2Text","s")%></font></div></td>
                <td class="tabdata"><div align=center>:</div></td>
                <td class="tabdata">
        ...
        <tr>
                <td class="light-orange">&nbsp;</td>
                <td class="light-orange">&nbsp;</td>
                <td class="tabdata"><div align=right><font color="#000000"><%tcWebApi_get("String_Entry","LANMediaPort3Text","s")%></font></div></td>
                <td class="tabdata"><div align=center>:</div></td>
                <td class="tabdata">
        ...
        <tr>
                <td class="light-orange">&nbsp;</td>
                <td class="light-orange">&nbsp;</td>
                <td class="tabdata"><div align=right><font color="#000000"><%tcWebApi_get("String_Entry","LANMediaPort4Text","s")%></font></div></td>
                <td class="tabdata"><div align=center>:</div></td>
                <td class="tabdata">
  ...
  <tr height="42" >
    ...
    <td width="160" class="black">&nbsp;</td><td width="160" class="orange">&nbsp;</td><td width="440" class="orange">
        ...
        <INPUT TYPE="reset" NAME="lan_cancel" VALUE="<%tcWebApi_get("String_Entry","ButtonCancelText","s")%>">
