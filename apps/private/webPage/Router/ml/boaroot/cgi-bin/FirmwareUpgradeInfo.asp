...
<body topmargin="0" leftmargin="0">
	...
	<table border="0" width="700" align="center" cellspacing="0" cellpadding="0">
		<tr>
			<td width="300" height="50" align="center" valign="middle" bgcolor="#FFFFFF"><div align="left"><img src="/logo.gif" width="200" height="50"></div></td>
			<td width="400" height="50" align="right" valign="bottom" bgcolor="#FFFFFF" class="model">
			<font size="+1">
  	...
  	<table width="700" border="0" align="center" cellpadding="2" cellspacing="0">
		<tr> 		  		
			...
			<font size="+3">			
			<%tcWebApi_get("String_Entry","FirmwareUpgradeDeviceText","s")%>
			</font>
			</td>
		</tr>
  	</table>
	...
	<table width="700" height="300" border="0" align="center" cellpadding="0" cellspacing="0" color="#FF9933">
	  <tr>				
		...
		<%tcWebApi_get("String_Entry","FirmwareUpgradeMsgText","s")%>
		</td>
	  </tr>
	</table>
