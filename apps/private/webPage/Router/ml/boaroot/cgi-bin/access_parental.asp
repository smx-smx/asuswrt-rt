...
function checkSubmit() {
	...
	if(document.getElementById('tr_Active_Yes').checked) {
	  ...
	  <% End If %>    
                ...
                if(!checkMacAddr(document.TIME_form.tr_MacAddr.value)) {
                        alert("<%tcWebApi_get("String_Entry","ParentalJS0Text","s")%>");
                        return false;
                }
	<% if tcWebApi_get("WebCustom_Entry","isParental_Urlblock","h") = "Yes" then %>
	   }
	...
	document.TIME_form.SaveFlag.value = 1;
...
<table width="760" border="0" align=center cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
  ...
  <tr>
    <td width="150" height="30" class="title-main"><font color="#FFFFFF"><%tcWebApi_get("String_Entry","ParentalControlText","s")%></font>    </td>
  ...
  <tr>
    ...
    <td class="light-orange"></td>
    <td class="tabdata"><div align=right><font color="#000000"><%tcWebApi_get("String_Entry","ParentalEnableText","s")%></font></div></td>
    <td class="tabdata"><div align=center>:</div></td>
    <td class="tabdata">
      <INPUT NAME="tr_Active" TYPE="RADIO" onClick="timeSwitch(1)" id="tr_Active_Yes" VALUE="Yes" <% If TCWebApi_get("Parental_Entry","Enable","h") = "Yes" then asp_Write("checked") end if%> ><font color="#000000"><%tcWebApi_get("String_Entry","ParentalActivatedText","s")%></font>
      <INPUT NAME="tr_Active" TYPE="RADIO" onClick="timeSwitch(0)" id="tr_Active_No" VALUE="No" <% If TCWebApi_get("Parental_Entry","Enable","h") <> "Yes" then asp_Write("checked") end if%> ><font color="#000000"><%tcWebApi_get("String_Entry","ParentalDeactivatedText","s")%></font>
    </td>
  </tr>
<% if tcWebApi_get("WebCustom_Entry","isParental_Urlblock","h") = "Yes" then %>
  <tr>
  ...
  <tr>
    <td class="light-orange">&nbsp;</td>
    <td class="light-orange"></td>
    <td class="tabdata"><div align=right><font color="#000000"><%tcWebApi_get("String_Entry","ParentalBlockingTypeText","s")%></font></div></td>
    <td class="tabdata"><div align=center>:</div></td>
    <td class="tabdata"> 
	<input name="tr_BlockType" type="RADIO" onClick="typeSwitch(1)" id="tr_BlockType_MAC" value="MAC" <% If TCWebApi_get("Parental_Entry","BlockType","h") = "N/A" then asp_Write("checked") elseif TCWebApi_get("Parental_Entry","BlockType","h") = "MAC" then asp_Write("checked") end if%> ><font color="#000000"><%tcWebApi_get("String_Entry","ParentalMACText","s")%></font> 
    <INPUT NAME="tr_BlockType" TYPE="RADIO" onClick="typeSwitch(0)" id="tr_BlockType_URL" VALUE="URL" <% If TCWebApi_get("Parental_Entry","BlockType","h") <> "N/A" then If TCWebApi_get("Parental_Entry","BlockType","h") <> "MAC" then asp_Write("checked") end if end if%> ><font color="#000000"><%tcWebApi_get("String_Entry","ParentalURLText","s")%></font> 
	</td>
  </tr>
  <% End If %> 
  </table>
...
<table width="760" border="0" align=center cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">	
  ...
  <tr>
    <td class="light-orange">&nbsp;</td>
    <td class="light-orange"></td>
    <td class="tabdata"><div align=right><font color="#000000"><%tcWebApi_get("String_Entry","ParentalMACAddressText","s")%></font></div></td>
    <td class="tabdata"><div align=center>:</div></td>
    <td class="tabdata">
      ...
      <INPUT NAME="tr_Browser" TYPE="CHECKBOX" ID="tr_Browser" onClick="doGetBrowserMac()"><%tcWebApi_get("String_Entry","ParentalBrowserMACAddressText","s")%>
	</tr>
</table></div>
<% if tcWebApi_get("WebCustom_Entry","isParental_Urlblock","h") = "Yes" then %>
  <div id="div_url">
<table width="760" border="0" align=center cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">	
  ...
  <tr>
    <td class="light-orange">&nbsp;</td>
    <td class="light-orange"></td>
		<td class="tabdata"><div align=right><font color="#000000"><%tcWebApi_get("String_Entry","ParentalURLText","s")%></font></div></td>
		<td class="tabdata"><div align=center>:</div></td>
		<td class="tabdata">
...
<% End If %>   
  ...
  <tr>
    ...
    <tr class="tabdata">
      <td class="tabdata"></td>
      <td class="tabdata"><div align=center><%tcWebApi_get("String_Entry","ParentalMonText","s")%></div></td>
      <td class="tabdata"><div align=center><%tcWebApi_get("String_Entry","ParentalTueText","s")%></div></td>
      <td class="tabdata"><div align=center><%tcWebApi_get("String_Entry","ParentalWedText","s")%></div></td>
      <td class="tabdata"><div align=center><%tcWebApi_get("String_Entry","ParentalThuText","s")%></div></td>
      <td class="tabdata"><div align=center><%tcWebApi_get("String_Entry","ParentalFriText","s")%></div></td>
      <td class="tabdata"><div align=center><%tcWebApi_get("String_Entry","ParentalSatText","s")%></div></td>
      <td class="tabdata"><div align=center><%tcWebApi_get("String_Entry","ParentalSunText","s")%></div></td>
    </tr>
    <tr> 
      <td class="tabdata"><div align=right><%tcWebApi_get("String_Entry","ParentalWeekText","s")%></div></td>
    ...
    <tr class="tabdata"> 
      <td class="tabdata"><div align=right><%tcWebApi_get("String_Entry","ParentalBlockingTimeText","s")%></div></td>
    ...
    <tr class="tabdata"> 
      <td class="tabdata"><div align=right><%tcWebApi_get("String_Entry","ParentalIntervalTimeText","s")%></div></td>
