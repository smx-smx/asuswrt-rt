...
<table width="760" border="0" align=center cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
  <tr>
    ...
    <font color="#FFFFFF"><%tcWebApi_get("String_Entry","RoutingTableText","s")%></font>    </td><td width="10" class="black">&nbsp;</td><td width="150"></td><td width="10" ></td><td width="440"></td></tr>
  <tr>
    <td class="light-orange">&nbsp;</td><td class="light-orange"></td><td colspan="3" align=center>
		...
		<td width="110" align=center class="tabdata"><strong><font color="#000000"><%tcWebApi_get("String_Entry","RTCgiDestIPText","s")%></font></strong></td>
		<td width="100" align=center class="tabdata"><strong><font color="#000000"><%tcWebApi_get("String_Entry","RTCgiMaskText","s")%></font></strong></td>
		<td width="110" align=center class="tabdata"><strong><font color="#000000"><%tcWebApi_get("String_Entry","RTCgiGatewayIPText","s")%></font></strong></td>
		<td width="50"  align=center class="tabdata"><strong><font color="#000000"><%tcWebApi_get("String_Entry","RTCgiMetricText","s")%></font></strong></td>
		<td width="70" align=center class="tabdata"><strong><font color="#000000"><%tcWebApi_get("String_Entry","RTCgiDeviceText","s")%></font></strong></td>
		<td width="45" align=center class="tabdata"><strong><font color="#000000"><%tcWebApi_get("String_Entry","RTCgiEditext","s")%></font></strong></td>
		<td align=center class="tabdata"><strong><font color="#000000"><%tcWebApi_get("String_Entry","RTCgiDropext","s")%></font></strong></td>
		</tr>
  ...
  <tr height="42">
	...
	<input name="AddRoute" type="button" value="<%tcWebApi_get("String_Entry","ButtonAddRouteText","s")%>" onClick="doUserDefNumCheck()">
  </tr></table>
		</form>
</body></html>
