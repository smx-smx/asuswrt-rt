...
function SubnetCheckRouter(mask,IPAddr) {
	...
	if ( !((v == "0.0.0.0")||
		...
		(v == "255.255.255.255")) )
	{
		alert("<%tcWebApi_get("String_Entry","JSSubMaskInvalid","s")%>");mask.focus();
		v = "0.0.0.0";
		return false;
	}
	if((Number(addr[3])==0)&&(Number(digits[3])==255)){
		alert("<%tcWebApi_get("String_Entry","JSSubMaskInvalid","s")%>");return false;
	}
...
border=0>
  ...
  <TR>
    <TD class=title-main width=150 height=30><FONT color=#ffffff><%tcWebApi_get("String_Entry","StaticRouteText","s")%></FONT> </TD>
  ...
  <TR>
    ...
    <TD class=light-orange>&nbsp;</TD>
    <TD class=tabdata>
      <DIV align=right><FONT color=#000000><%tcWebApi_get("String_Entry","StaticRouteDestIPText","s")%></FONT> 
    </DIV></TD>
    <TD class=tabdata>
  ...
  <TR>
    ...
    <TD class=light-orange></TD>
    <TD class=tabdata>
      <DIV align=right><FONT color=#000000><%tcWebApi_get("String_Entry","StaticRouteDestMaskText","s")%></FONT> </DIV></TD>
    <TD class=tabdata>
      <DIV align=center>:</DIV></TD>
  ...
  <TR>
    ...
    <TD class=light-orange>&nbsp;</TD>
    <TD class=tabdata>
      <DIV align=right><FONT color=#000000><%tcWebApi_get("String_Entry","StaticRouteGatewayIPText","s")%></FONT> </DIV></TD>
    <TD class=tabdata>
      <DIV align=center>:</DIV></TD>
    <TD class=tabdata>
...
<%if tcWebApi_get("WebCustom_Entry","isMultiSerSupported","h") = "Yes" then%>
	<%if tcWebApi_get("WebCustom_Entry","havePtm","h") = "Yes" then%>
		...
		<option value="PVC9e0" <%if Request_form("pvc_index_num") = "16" then asp_Write("selected") end if%>><%tcWebApi_get("String_Entry","StaticRoutePVC9Serv0Text","s")%>
		<option value="PVC9e1" <%if Request_form("pvc_index_num") = "17" then asp_Write("selected") end if%>><%tcWebApi_get("String_Entry","StaticRoutePVC9Serv1Text","s")%>
		<option value="PVC9e2" <%if Request_form("pvc_index_num") = "18" then asp_Write("selected") end if%>><%tcWebApi_get("String_Entry","StaticRoutePVC9Serv2Text","s")%>
		<option value="PVC9e3" <%if Request_form("pvc_index_num") = "19" then asp_Write("selected") end if%>><%tcWebApi_get("String_Entry","StaticRoutePVC9Serv3Text","s")%>
		<option value="PVC9e4" <%if Request_form("pvc_index_num") = "20" then asp_Write("selected") end if%>><%tcWebApi_get("String_Entry","StaticRoutePVC9Serv4Text","s")%>
		<option value="PVC9e5" <%if Request_form("pvc_index_num") = "21" then asp_Write("selected") end if%>><%tcWebApi_get("String_Entry","StaticRoutePVC9Serv5Text","s")%>
		<option value="PVC9e6" <%if Request_form("pvc_index_num") = "22" then asp_Write("selected") end if%>><%tcWebApi_get("String_Entry","StaticRoutePVC9Serv6Text","s")%>
		<option value="PVC9e7" <%if Request_form("pvc_index_num") = "23" then asp_Write("selected") end if%>><%tcWebApi_get("String_Entry","StaticRoutePVC9Serv7Text","s")%>
	<%end if%>
	<%if tcWebApi_get("WebCustom_Entry","haveWan0","h") = "Yes" then%>
...
<%else%>
	<%if tcWebApi_get("WebCustom_Entry","havePtm","h") = "Yes" then%>
		...
		<option value="PVC9" <%if Request_form("pvc_index_num") = "9" then asp_Write("selected") end if%>><%tcWebApi_get("String_Entry","StaticRoutePVC9Text","s")%>
	<%end if%>
	<%if tcWebApi_get("WebCustom_Entry","haveWan0","h") = "Yes" then%>
...
<%end if%>
  ...
  <TR>
    ...
    <TD class=light-orange>&nbsp;</TD>
    <TD class=tabdata>
      <DIV align=right><FONT color=#000000><%tcWebApi_get("String_Entry","StaticRouteMetricText","s")%></FONT> </DIV></TD>
    <TD class=tabdata>
      <DIV align=center>:</DIV></TD>
...
border=0>
  ...
  <TR height=42>
	...
	<INPUT onClick="doSubmit(1);" type=button value="<%tcWebApi_get("String_Entry","ButtonSaveText","s")%>" name="StaticSubmit">&nbsp;&nbsp;  
	<INPUT type="button" value="<%tcWebApi_get("String_Entry","ButtonBackText","s")%>" name="StaticBack" onClick="javascript:window.location='/cgi-bin/adv_routing_table.asp'" >&nbsp;&nbsp; 
	<INPUT type="reset" value="<%tcWebApi_get("String_Entry","ButtonCancelText","s")%>" name="DTStaticReset">
