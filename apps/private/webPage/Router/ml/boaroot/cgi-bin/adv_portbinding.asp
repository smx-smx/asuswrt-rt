...
<table width="760" border="0" align=center cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
  <tr>
    ...
    <font color="#FFFFFF"><%tcWebApi_get("String_Entry","PortbingdingSettingText","s")%></font>    </td><td width="10" class="black">&nbsp;</td><td width="150"><hr noshade></td><td width="10" ><hr noshade></td><td width="440"><hr noshade></td></tr>
	<tr>
    <td class="light-orange">&nbsp;</td><td class="light-orange">&nbsp;</td><td class="tabdata"><div align=right>
    <font color="#000000"><%tcWebApi_get("String_Entry","PortbingdingActiveText","s")%></font>    </div></td><td class="tabdata"><div align=center>:</div></td><td class="tabdata">
    	<INPUT TYPE="RADIO" NAME="PortBind_active" VALUE="Yes" <% if tcWebApi_get("PortBind_Common", "Active", "h") = "Yes" then asp_Write("checked") end if%> onclick="init()"><font color="#000000"><%tcWebApi_get("String_Entry","PortbingdingActivatedText","s")%></font>
    	<INPUT TYPE="RADIO" NAME="PortBind_active" VALUE="No" <% if tcWebApi_get("PortBind_Common", "Active", "h") = "No" then asp_write("checked") end if%> onclick="init()"> <font color="#000000"><%tcWebApi_get("String_Entry","PortbingdingDeactivatedText","s")%></font></td></tr><tr>
    ...
    <font color="#000000"><%tcWebApi_get("String_Entry","PortbingdingGroupIndexText","s")%></font>    </div></td><td class="tabdata"><div align=center>:</div></td><td class="tabdata">
...
<%if tcWebApi_get("WebCustom_Entry","haveAtm","h") = "Yes" then%>
    ...
    <font color="#000000"><%tcWebApi_get("String_Entry","PortbingdingATMText","s")%></font>    </div></td><td class="tabdata"><div align=center>:</div></td><td width="440" height="80" class="tabdata">
      <table border="1" cellpadding="0" cellspacing="0" bordercolor="#CCCCCC">
            <tr> 
              <td rowspan="2" class="tabdata"><div align=right> <font color="#000000"><%tcWebApi_get("String_Entry","PortbingdingPortText","s")%></font> </div></td>
              <td><div align=center> 
...
<%end if%>
 ...
 <%if tcWebApi_get("WebCustom_Entry","havePtm","h") = "Yes" then%>
 	<%if tcWebApi_get("WebCustom_Entry","isMultiSerSupported","h") = "Yes" then%>
		...
		<%tcWebApi_get("String_Entry","PortbindingPTM0Text","s")%></font></div></td>
		<td class="tabdata"><div align=center>:</div></td><td width="440" height="80" class="tabdata">
      	<table border="1" cellpadding="0" cellspacing="0" bordercolor="#CCCCCC">
        <tr> 
        	<td rowspan="2" class="tabdata"><div align=right> <font color="#000000">
			<%tcWebApi_get("String_Entry","PortbingdingPortText","s")%></font></div></td>
	    ...
	    <td width="150" class="light-orange">&nbsp;</td><td class="light-orange"></td>
		<td width="150" class="tabdata"><div align=right><font color="#000000">
		<%tcWebApi_get("String_Entry","PortbindingPTM1Text","s")%></font></div></td>
		<td class="tabdata"><div align=center>:</div></td><td width="440" height="80" class="tabdata">
      	<table border="1" cellpadding="0" cellspacing="0" bordercolor="#CCCCCC">
        <tr> 
        	<td rowspan="2" class="tabdata"><div align=right> <font color="#000000">
	...
	<%else%>
	    <td width="150" class="light-orange">&nbsp;</td><td class="light-orange"></td><td width="150" class="tabdata"> <div align=right>
    	<font color="#000000"><%tcWebApi_get("String_Entry","PortbingdingPTMText","s")%></font>    </div></td><td class="tabdata"><div align=center>:</div></td><td width="440" height="80" class="tabdata">
      	<table border="1" cellpadding="0" cellspacing="0" bordercolor="#CCCCCC">
            <tr> 
              <td rowspan="2" class="tabdata"><div align=right> <font color="#000000">
			  <%tcWebApi_get("String_Entry","PortbingdingPortText","s")%></font> </div></td>
...
<%end if%>
 ...
 <%if tcWebApi_get("WebCustom_Entry","haveWan0","h") = "Yes" then%>
	    ...
	    <td width="150" class="light-orange">&nbsp;</td><td class="light-orange"></td><td width="150" class="tabdata"> <div align=right>
    	<font color="#000000"><%tcWebApi_get("String_Entry","PortbingdingWANText","s")%></font>    </div></td><td class="tabdata"><div align=center>:</div></td><td width="440" height="80" class="tabdata">
      	<table border="1" cellpadding="0" cellspacing="0" bordercolor="#CCCCCC">
            <tr> 
              <td rowspan="2" class="tabdata"><div align=right> <font color="#000000">
			  <%tcWebApi_get("String_Entry","PortbingdingPortText","s")%></font> </div></td>
...
<%end if%>
    ...
    <font color="#000000"><%tcWebApi_get("String_Entry","PortbingdingEthernetText","s")%></font>    </div></td><td class="tabdata"><div align=center>:</div></td><td width="440" height="70" class="tabdata"><table border="1" cellpadding="0" cellspacing="0" bordercolor="#CCCCCC">
      <tr>
        <td rowspan="2" class="tabdata"><div align=right>
	<font color="#000000"><%tcWebApi_get("String_Entry","PortbingdingPortText","s")%></font> </div></td><td><div align=center>
...
%>
		<tr>
    <td width="150" height="20" class="light-orange">&nbsp;</td><td class="light-orange"></td><td width="150" height="45" class="tabdata"> <div align=right>
    <font color="#000000"><%tcWebApi_get("String_Entry","PortbingdingWLanText","s")%></font>    </div></td><td class="tabdata"><div align=center>:</div></td><td width="440" height="70" class="tabdata"><table border="1" cellpadding="0" cellspacing="0" bordercolor="#CCCCCC">
      <tr>
        <td rowspan="2" class="tabdata"><div align=right>
        <font color="#000000"><%tcWebApi_get("String_Entry","PortbingdingPortText","s")%></font>        </div></td><td><div align=center>
...
%>
    ...
    <font color="#000000"><%tcWebApi_get("String_Entry","PortbingdingWLanText","s")%></font>    </div></td><td class="tabdata"><div align=center>:</div></td><td width="440" height="70" class="tabdata"><table border="1" cellpadding="0" cellspacing="0" bordercolor="#CCCCCC">
      <tr>
        <td rowspan="2" class="tabdata"><div align=right>
        <font color="#000000"><%tcWebApi_get("String_Entry","PortbingdingPortText","s")%></font>        </div></td>
		<td><div align=center>
            <INPUT TYPE="CHECKBOX" NAME="PortBind_Wireless_Port_0" ID="PortBind_Wireless_Port_0" <%if tcWebApi_get("PortBind_Entry", "w0", "h") = "Yes" then asp_write("checked") end if%> >            </div></td>
<%if tcWebApi_get("WebCustom_Entry","isC2TrueSupported","h")<>"Yes" then%>
			<td><div align=center>
...
<%if tcwebApi_get("Info_Ether","isUSBSupported","h")="Yes" then%>
    ...
    <td height="25" class="light-orange">&nbsp;</td><td class="light-orange">&nbsp;</td><td height="80" class="tabdata">
      <div align=right>
      <font color="#000000"><%tcWebApi_get("String_Entry","PortbingdingUSBText","s")%></font>      </div></td><td class="tabdata"><div align=center>:</div></td><td height="25" class="tabdata">
	  <table border="1" cellpadding="0" cellspacing="0" bordercolor="#CCCCCC">
        <tr class="tabdata">
        <td rowspan="2" class="tabdata">
          <div align=right>
          <font color="#000000"><%tcWebApi_get("String_Entry","PortbingdingPortText","s")%></font>          
		  </div></td>
		  <td>
		  <div align=center>
...
<%end if%>
	...
	<table width="760" border="0" align=center cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
        ...
        <td width="150" height="30" class="title-sub"> <font color="#000000"> 
          <%tcWebApi_get("String_Entry","PortbingdingSummaryText","s")%></font> </td>
        <td width="10" class="light-orange">&nbsp;</td>
		<td width="150"> </td>
		<td class="tabdata">				
				<INPUT TYPE="BUTTON" NAME="PortBind_Summary" VALUE="<%tcWebApi_get("String_Entry","ButtonBindingSumText","s")%>" onClick="onClickPortBindSummary();">				  
		</td>
  </table>	
  <table width="760" border="0" align=center cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
  <tr>
    <td width="160" height="42" class="black">&nbsp;</td><td width="160" class="orange">&nbsp;</td><td width="440" class="orange">
	<INPUT TYPE="SUBMIT" NAME="SaveBtn_PortBind_group" VALUE="<%tcWebApi_get("String_Entry","ButtonSaveText","s")%>" onClick="doAdd();">
	<INPUT TYPE="SUBMIT" NAME="DeleteBtn_PortBind_group" VALUE="<%tcWebApi_get("String_Entry","ButtonDeleteText","s")%>" onclick="document.PortBind_form.Add_or_Delete.value = 2">
	<input type="SUBMIT"  name="PortBind_group_cancel" value="<%tcWebApi_get("String_Entry","ButtonCancelText","s")%>" onClick="document.PortBind_form.Add_or_Delete.value = 3">
	</td></tr></table></div>
