...
<TABLE cellSpacing=0 cellPadding=0 width=760 align=center bgColor=#ffffff border=0>
	<TBODY>
		...
		<TR>
			<TD class=title-main width=150 height=30><FONT color=#ffffff><FONT color=#ffffff>Parent Control</FONT></FONT></TD>
		...
		<TR>
			...
			<TD class=light-orange></TD>
			<TD class=tabdata><DIV align=right><FONT color=#000000><FONT color=#000000>Status</FONT></FONT></DIV></TD>
			<TD class=tabdata><DIV align=center>:</DIV></TD>
			<TD class=tabdata>
			<INPUT type=radio value=1 name=TimeofDay_status <%if tcWebApi_get("timeOfDay_setting", "Active", "h") = "1" then asp_Write("checked") end if%>><FONT color=#000000> <FONT color=#000000>Activated</FONT></FONT> 
			<INPUT type=radio value=0 name=TimeofDay_status <%if tcWebApi_get("timeOfDay_setting", "Active", "h") = "0" then asp_Write("checked") elseif tcWebApi_get("timeOfDay_setting", "Active", "h") = "N/A" then asp_Write("checked") end if%>><FONT color=#000000> <FONT color=#000000>Deactivated</FONT></FONT></TD>
		</TR>
		<TR>
			<TD class=light-orange>&nbsp;</TD>
			<TD class=light-orange>&nbsp;</TD>
			<TD class=tabdata><DIV align=right><P><FONT color=#000000><FONT color=#000000>Select Rule</FONT></FONT></P></DIV></TD>
			<TD class=tabdata><DIV align=center>:</DIV></TD>
			<TD class=tabdata>
			...
			<FONT color=#000000>(Checked time will be allowed to visit Internet)</FONT>
			</TD>
		</TR>
		<TR>
			<TD class=title-sub><FONT color=#000000><FONT color=#000000>Application</FONT></FONT></TD>
			<TD class=light-orange>&nbsp;</TD>
			<TD><HR noShade></TD>
			<TD><HR noShade></TD>
			<TD><HR noShade></TD>
	...
	<TBODY>
		<TR>
			...
			<TD class=tabdata width=81>
				...
				<FONT color=#000000>URL Filter</FONT>
			</TD>
			<TD class=tabdata width=153>
				<INPUT onclick=RunTimeofDay_KeywordList() type=button value="Edit Keyword" name=TimeofDay_EditKeyword>
			</TD>
...
<TABLE cellSpacing=0 cellPadding=0 width=760 align=center bgColor=#ffffff border=0>
	<TBODY>
		<TR>
			<TD class=title-sub width=148><FONT color=#000000><FONT color=#000000>Time Rules</FONT></FONT></TD>
	...
	<TBODY>
		<TR>
			...
			<TD class=orange width=440>
				...
				<INPUT onclick=SaveTimeofDay(); type=button value=SAVE name=TimeOfDay_SaveBtn>
			</TD>
		</TR>
	</TBODY>
</TABLE>
