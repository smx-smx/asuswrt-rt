...
<table width="760" border="0" align=center cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
	...
	<tr>
		...
		<font color="#FFFFFF">Landing Page</font>
		</td>
	...
	<tr>
		...
		<td class="light-orange"></td>
		<td class="tabdata">
			<div align=right><font color="#000000">Landing Page</font></div>
		</td>
		<td class="tabdata"><div align=center>:</div></td>
		<td class="tabdata">
			<INPUT NAME="landingPageRadio" TYPE="RADIO" VALUE="Yes" <% If TCWebApi_get("GUI_Entry0","landingPageEnable","h") = "Yes" then asp_Write("checked") end if%> ><font color="#000000">Enable</font>		
			<INPUT NAME="landingPageRadio" TYPE="RADIO" VALUE="No" <% If TCWebApi_get("GUI_Entry0","landingPageEnable","h") = "No" then asp_Write("checked") end if%>><font color="#000000">Disable</font>
		</td>
	</tr>
	<tr>
		<td class="light-orange">&nbsp;</td>
...
<table width="760" border="0" align=center cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
	<tr>
		...
		<td width="440" class="orange">
			...
			<INPUT TYPE="BUTTON" NAME="CancelBtn" VALUE="CANCEL" onClick="javascript:window.location='/cgi-bin/tools_landingPage.asp'">        
		</td>
	</tr>
</table>
</div>
