...
<FORM METHOD="POST" name="TimeofDay_URLFilterKeyword_form">
	...
	<table width="560"  height="35" border="0" align=center cellpadding="0" cellspacing="0" class="orange">
		<tr>
			<td width="560" height="35" bgcolor="#FFFFFF" class="headline">
				<font color="#000000">URL Keyword Filter</font>
			</td>
		</tr>
	</table>
	<table width="560" border="0" align=center cellpadding="0" cellspacing="0" color="#FF9933">
		...
		<tr>
			...
			<font color="#FFFFFF">Keyword Editing</font>
			</td>
		...
		<tr>
			...
			<td>
				<div align=right>
				<font color="#000000">Keyword Index</font>
				</div>
			</td>
		...
		<tr>
			...
			<td>
				<div align=right>
				<font color="#000000">Keyword</font>
				</div>
			</td>
			<td><div align=center>:</div></td>
			<td>
	...
	<table width="560" border="0" align=center cellpadding="0" cellspacing="0" color="#FF9933">
		<tr>
			...
			<font color="#000000">Keyword List</font></td>
	...
	<table width="560" border="0" align=center cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
		<tr>
			...
			<td class="orange">
				...
				<INPUT TYPE="BUTTON" NAME="Submit" VALUE="APPLY" onClick="TimeofDay_URLFilterKeywordSave(1)">
				<INPUT TYPE="BUTTON" NAME="Submit" VALUE="DELETE" onClick="TimeofDay_URLFilterKeywordSave(2)">
				<INPUT TYPE="BUTTON" NAME="TimeofDay_URLFilterKeywordClose" VALUE="CLOSE" onClick="window.close()">
			</td>
		</tr>
	</table>
</form>
