...
-->
		...
		<tr>
			...
			<td class="tabdata" align=center>:</td>
			<td class="tabdata">
				<font color="#000000"></font>Highest:<INPUT TYPE="TEXT" NAME="QosWRRweight1" SIZE="1" MAXLENGTH="2" VALUE="<%if TCWebAPI_get("QoS_Common", "WeightHighest", "h") <> "N/A" then TCWebAPI_get("QoS_Common", "WeightHighest", "s") else asp_Write("") end if %>">
