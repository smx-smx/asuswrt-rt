			...
			if (document.ACL_form.Direction.value == "WAN") {
				for (i = 0; i < port_array.length; i++) {
					...
					if (serve_port >= parseInt(port[0]) && serve_port <= parseInt(port[1])) {
						alert("This port has been used by virtual server.");
						return false;
					}
				}
			}
		...
		if (document.ACL_form.SRVACTIVE[0].checked) {
			for (i = 0; i < port_array.length; i++) {
				...
				if (serve_port == parseInt(port_array[i])) {
					alert("This port has been used by other service.");
					return false;
				}
			}
		}
...
function doValidateRange(startIP, endIP, subMK, flag) 
{
	...
	for (i = 0; i < 4; i++) {
		...
		if ((stIPVal & sbMKVal) != (endIPVal & sbMKVal)) {
			if (flag == 1) {
				alert("service allowed ip and account allowed ip must be the same subnet.");
			}
			else {
				alert("Start IP and End IP must be the same subnet");
			}
			return false;
		}
...
<form METHOD="POST" action="/cgi-bin/access_acl.asp" name="ACL_form">
	<table width="760" border="0" align=center cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
		...
		<tr>
			<td width="150" height="25" class="title-main"><font color="#FFFFFF">Access Control Setup</font></td>
		...
		<tr>
			...
			<td class="tabdata">
				<INPUT TYPE="RADIO" NAME="Activate" VALUE="Yes" onClick="aclSwitch(1)"><font color="#000000">Activated</font>
				<INPUT TYPE="RADIO" NAME="Activate" VALUE="No" onClick="aclSwitch(0)"><font color="#000000">Deactivated</font>
		...
		<tr>
			...
			<td class="tabdata"><div align=right><font color="#000000">Service</font></div></td>
			<td class="tabdata"><div align=center>:</div></td>
			<td class="tabdata">
				<SELECT NAME="SRVIndexSEL" SIZE="1" onChange="doSRVIndexChange()">
					<OPTION VALUE="0" <%if TCWebAPI_get("WebCurSet_Entry", "acl_id", "h") = "0" then asp_Write("selected") end if %>>web
					<OPTION VALUE="1" <%if TCWebAPI_get("WebCurSet_Entry", "acl_id", "h") = "1" then asp_Write("selected") end if %>>ftp
					<OPTION VALUE="2" <%if TCWebAPI_get("WebCurSet_Entry", "acl_id", "h") = "2" then asp_Write("selected") end if %>>telnet
				<%if TCWebAPI_get("WebCustom_Entry", "isSSHSupported", "h") = "Yes" then %>
					<OPTION VALUE="3" <%if TCWebAPI_get("WebCurSet_Entry", "acl_id", "h") = "3" then asp_Write("selected") end if %>>ssh
				<%end if%>
					<OPTION VALUE="4" <%if TCWebAPI_get("WebCurSet_Entry", "acl_id", "h") = "4" then asp_Write("selected") end if %>>tftp
					<OPTION VALUE="5" <%if TCWebAPI_get("WebCurSet_Entry", "acl_id", "h") = "5" then asp_Write("selected") end if %>>snmp
					<OPTION VALUE="6" <%if TCWebAPI_get("WebCurSet_Entry", "acl_id", "h") = "6" then asp_Write("selected") end if %>>ping
				</SELECT>
			</td>
		</tr>
		<tr>
			...
			-->
				<SELECT NAME="Direction" SIZE="1" onChange="directSwitch()">
					...
					<OPTION VALUE="WAN" <%if TCWebAPI_get("ACL_Entry", "Direction", "h") = "WAN" then asp_Write("selected") end if %>>WAN
				</SELECT>
			</td>
		</tr>
		<tr>
			<td height="22" class="title-sub"><font color="#000000">Service Setting</font></td>
			<td class="light-orange"></td>
		...
		<tr id="srvport_info">
			<td class="light-orange">&nbsp;</td>
			<td class="light-orange"></td>
			<td class="tabdata"><div align=right><font color="#000000">Service Port</font></div></td>
			<td class="tabdata"><div align=center>:</div></td>
		...
		<tr>
			...
			<td class="tabdata"><div align=center>:</div></td>
			<td class="tabdata">
				<INPUT TYPE="RADIO" NAME="SRVACTIVE" VALUE="Yes" ><font color="#000000">Yes</font>
				<INPUT TYPE="RADIO" NAME="SRVACTIVE" VALUE="No" ><font color="#000000">No</font>
			</td>
		</tr>
		<tr>
			<td class="light-orange">&nbsp;</td>
			<td class="light-orange"></td>
			<td class="tabdata"><div align=right><font color="#000000">Allowed IP </font></div></td>
			<td class="tabdata"><div align=center>:</div></td>
			<td class="tabdata">
				<INPUT TYPE="TEXT" NAME="SRVALLOWEDSTARTIP" SIZE="15" MAXLENGTH="15" VALUE="" >~
				<INPUT TYPE="TEXT" NAME="SRVALLOWEDENDIP" SIZE="15" MAXLENGTH="15" VALUE="" ><font color="#000000">(0.0.0.0 ~ 0.0.0.0 means all IPs)</font>
			</td>
		</tr>
		<tr>
			<td class=light-orange>&nbsp;</td>
	...
	<table width="760" border="0" align=center cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
		<tr>
			<td width="150" height="20" class="title-sub"><font color="#000000">Authorize Setting</font></td>
			<td width="10" class="light-orange"></td>
	...
	<table width="760" border="0" align=center cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
		...
		<tr>
			<td width="150" height="25" class="light-orange">&nbsp;</td>
			<td width="10" class="light-orange"></td>
			<td class="tabdata"><div align=right><font color="#000000">Account</font></div></td>
			<td class="tabdata"><div align=center>:</div></td>
			<td class="tabdata">
		...
		<tr>
			<td class="light-orange">&nbsp;</td>
			<td class="light-orange"></td>
			<td class="tabdata"><div align=right><font color="#000000">Allowed</font></div></td>
			<td class="tabdata"><div align=center>:</div></td>
			<td class="tabdata">
				<INPUT TYPE="RADIO" NAME="ACCALLOWED" VALUE="Yes" ><font color="#000000">Yes</font>
				<INPUT TYPE="RADIO" NAME="ACCALLOWED" VALUE="No" ><font color="#000000">No</font>
			</td>
		</tr>
		<tr>
			<td class="light-orange">&nbsp;</td>
			...
			<td class="tabdata">
				...
				<INPUT TYPE="TEXT" NAME="ACCALLOWEDENDIP" SIZE="15" MAXLENGTH="15" VALUE="" ><font color="#000000">(0.0.0.0 ~ 0.0.0.0 means all IPs)</font>
			</td>
		</tr>
		<!--
		<tr>
	...
	<table width="760" border="0" align=center cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
		<tr>
			<td width="150" height="25" class="title-main"><div align=right><font color="#FFFFFF">Access control listing</font></div></td>
			<td width="10" class="black">&nbsp;</td>
			<td width="150"><hr noshade></td>
			<td width="10"><hr noshade></td>
			<td width="440"><hr noshade></td>
		...
		<tr>
			...
			<td class="tabdata"></td>
			<td class="tabdata"></td>
			<td ><INPUT TYPE="BUTTON" NAME="ACL_Summary" VALUE="ACL_Summary" onClick="onClickACLSummary();"></td>
		</tr>
	</table>
	<table width="760" border="0" align=center cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
		<tr>
			...
			<td width="440" class="orange">
				...
				<INPUT TYPE="BUTTON" NAME="ACLAddBTN" VALUE="SAVE" onClick="doAdd();">
				<INPUT TYPE="RESET"  NAME="ACLCancelBTN" VALUE="CANCEL"onClick="document.forms[0].ACLActionFlag.value = 99; javascript:window.location='access_acl.asp'">
			</td>
		</tr>
	</table>
</form>
