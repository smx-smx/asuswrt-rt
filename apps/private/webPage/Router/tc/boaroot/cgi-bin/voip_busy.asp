...
<FORM METHOD="POST" ACTION="/cgi-bin/Voip_busy.asp" name="Voip_busy">
...
<td class="tabdata"><font color="#000000"><img src=/exclamation.gif>&nbsp;VoIP system is busy now, please try it later.</font>	
</td></tr><tr>
<td class="light-orange">&nbsp;</td><td class="light-orange"></td><td class="tabdata">&nbsp;</td><td class="tabdata">&nbsp;</td><td class="tabdata">
</td></tr><tr>
  ...
  <tr>
    <td width="160" class="black" height="42" >&nbsp;</td><td width="160" class="orange">&nbsp;</td><td width="440" class="orange">
	    <INPUT TYPE="BUTTON" NAME="SaveBtn" VALUE="OK" onClick="window.history.back()">	</td></tr></table></div></form>
</body></html>
