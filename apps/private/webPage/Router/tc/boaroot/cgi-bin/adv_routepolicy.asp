...
function uiTOSCheck(){
	...
	value = document.uiRoutePolicyForm.TOS.value;
		...
		{
			alert('TOS must be in the range 0~5');
			return false;
		}
...
<FORM METHOD="POST" ACTION="/cgi-bin/adv_routepolicy.asp" name="uiRoutePolicyForm">
  <div align=center>
    <table width="760" border="0" align=center cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
      ...
      <tr> 
        <td width="150" height="30" class="title-main"> <font color="#FFFFFF">Router 
          Policy</font> </td>
      ...
      <tr> 
        ...
        <td class="light-orange">&nbsp;</td>
        <td class="tabdata"><div align=right> <font color="#000000">Start Source 
      ...
      <tr> 
        <td class="light-orange">&nbsp;</td>
        <td class="light-orange">&nbsp;</td>
        <td class="tabdata"> <div align=right> <font color="#000000">End Source 
            IP Address</font> </div></td>
        <td class="tabdata"><div align=center>:</div></td>
      ...
      <tr> 
        <td class="light-orange">&nbsp;</td>
        <td class="light-orange">&nbsp;</td>
        <td class="tabdata"> <div align=right> <font color="#000000">TOS</font> 
          </div></td>
        <td class="tabdata"><div align=center>:</div></td>
        <td class="tabdata"> <INPUT TYPE="TEXT" NAME="TOS" SIZE="15" MAXLENGTH="15" VALUE="<%If tcWebApi_get("RoutePolicy_Entry","TOS","h") <> "N/A" then tcWebApi_get("RoutePolicy_Entry","TOS","s") end if%>" >
          0=Don't care; 1=Normal; 2=Min Delay; 3=Max Throughput; 4=Max Reliable; 5=Min Cost
		</td>
      </tr>
    </table>
    <table width="760" border="0" align=center cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
      <tr> 
        <td width="150" height="30" class="title-main"> <font color="#FFFFFF">Packets 
          Forwarding To</font> </td>
        <td width="10" class="black">&nbsp;</td>
      ...
      <tr> 
        <td class="light-orange">&nbsp;</td>
        <td class="light-orange">&nbsp;</td>
        <td class="tabdata"><div align=right> <font color="#000000">Gateway</font> 
          </div></td>
        <td class="tabdata"><div align=center>:</div></td>
  ...
  <tr height="42" >
    <td width="160" class="black">&nbsp;</td><td width="160" class="orange">&nbsp;</td><td width="440" class="orange">
        <INPUT TYPE="button" NAME="SaveBtn" VALUE="SAVE" onClick="uiSave()">
          ...
          <INPUT TYPE="reset" NAME="lan_cancel" VALUE="CANCEL" ></td></tr></table></div></form></body>
</html>
