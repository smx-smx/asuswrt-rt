...
<table width="760" border="0" align=center cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
  ...
  <tr>
    <td width="150" height="30" class="title-main">
   	<font color="#FFFFFF">Transmit Statistics</font></td>
  ...
  <tr>
	...
	<td class="light-orange"></td>
    <td class="tabdata" align="right">Tx Success:</td>
	<td class="tabdata">&nbsp;</td>
  ...
  <tr>
  	<td class="light-orange">&nbsp;</td>
	<td class="light-orange"></td>
    <td class="tabdata" align="right">Tx Retry Count:</td>
	<td class="tabdata">&nbsp;</td>
  ...
  <tr>
  	<td class="light-orange">&nbsp;</td>
	<td class="light-orange"></td>
    <td class="tabdata" align="right">RTS Fail To Receive CTS:</td>
	<td class="tabdata">&nbsp;</td>
  ...
  <tr>
	<td width="150" height="30" class="title-main">
   		<font color="#FFFFFF">Receive Statistics</font></td>
	<td width="10" class="black">&nbsp;</td>
  ...
  <tr>
 	<td class="light-orange">&nbsp;</td>
	<td class="light-orange"></td>
    <td class="tabdata" align="right">Frames Received Successfully:</td>
	<td class="tabdata">&nbsp;</td>
  ...
  <tr>
  	<td class="light-orange">&nbsp;</td>
	<td class="light-orange"></td>
    <td class="tabdata" align="right">SNR:</td>
	<td class="tabdata">&nbsp;</td>
  ...
  <tr>
	...
	<input type=button style="width:90px" value="Reset Counters" onClick="Doreset()">&nbsp;<input type=button value="Back" onClick="Doreturn()"><input type="hidden" name="reset_flag" value="0"></td></tr></table></div></form>
</body></html>
