...
{	
	...
	{
		alert("admin name can not be the same with users name!!");
		return;
	}
	
	if(document.tool_admin.user2_username.value == document.tool_admin.user3_username.value)
	{
		alert("the user2 name can not be the same with user3 name!!");
		return;
	}
...
<table width="760" border="0" align=center cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
	...
	<tr>
		...
		<font color="#FFFFFF">Administrator</font></td>
	...
	<tr>
		...
		<td class="tabdata">
			<div align=right>
			<font color="#000000">User type</font>
			</div>
		</td>
		<td class="tabdata"><div align=center>:</div></td>
		<td class="tabdata">
			<select name="user_Mode" size="1" onchange="doUserModeChange()">
			<option value="0" <% if tcWebApi_get("GUITemp_Entry0","toolsUserMode","h") = "0" then asp_Write("selected") elseif tcWebApi_get("GUITemp_Entry0","toolsUserMode","h") = "N/A" then asp_Write("selected") end if %>>admin</option>
			<option value="1" <% if tcWebApi_staticGet("GUITemp_Entry0","toolsUserMode","h") = "1" then asp_Write("selected") end if %>>user2</option>
			<option value="2" <% if tcWebApi_staticGet("GUITemp_Entry0","toolsUserMode","h") = "2" then asp_Write("selected") end if %>>user3</option>
			</select>
		</td>
	</tr>
</table>
...
<table width="760" border="0" align=center cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
	<tr>
		...
		<td class="tabdata" width="150">
			<div align=right>
			<font color="#000000">admin name</font>    
			</div>
		</td>
	...
	<tr>
		...
		<td class="tabdata">
			<div align=right>
			<font color="#000000">New Password</font>    
			</div>
		</td>
		<td class="tabdata"><div align=center>:</div></td>
		<td class="tabdata">
	...
	<tr>
		...
		<td class="tabdata">
			<div align=right>
			<font color="#000000">Confirm Password</font>    
			</div>
		</td>
		<td class="tabdata"><div align=center>:</div></td>
		<td class="tabdata">
...
<table width="760" border="0" align=center cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
	<tr>
		...
		<td class="tabdata" width="150">
			<div align=right>
			<font color="#000000">user2 name</font>    
			</div>
		</td>
		<td class="tabdata" width="10"><div align=center>:</div></td>
		<td class="tabdata" width="440">
...
<table width="760" border="0" align=center cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
	<tr>
		...
		<td class="tabdata" width="150">
			<div align=right>
			<font color="#000000">user3 name</font>    
			</div>
		</td>
		<td class="tabdata" width="10"><div align=center>:</div></td>
		<td class="tabdata" width="440">
...
<table width="760" border="0" align=center cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
	<tr>
		...
		<td width="440" class="orange">
			...
			<INPUT TYPE="BUTTON" NAME="deleteBtn" VALUE="DELETE" onClick="uiDelete()">    
		</td>
	</tr>
</table>
</form>
