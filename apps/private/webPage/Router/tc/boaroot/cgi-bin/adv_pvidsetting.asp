...
function vlantag_save()
{
	...
	for (i = 4; i <=50+usbNum*4 + bssidNum*4; i+=4) {
		...
		if (!isNumeric(document.VlanTag_Form.elements[i].value)) {
			alert("pvid should be interger.");
			return false;	
		}
		
		pvid = parseInt(document.VlanTag_Form.elements[i].value);
		if (pvid < 0 || pvid > 4095) {
			alert("invalid pvid value, pvid should be between 0~4095");
			return false;
		}
	}
...
<div align="center">
	<table width="760" border="0" align=center cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
      ...
      <tr> 
        <td width="155" height="30" class="title-main"> PVID Assign </td>
        <td width="1" class="black">&nbsp;</td>
        <td colspan="4" align="center" class="tabdata"> <font color="#000000">Active</font>
          ...
          <font color="#000000">Activate</font> 
	  ...
	  <tr> 
       <td class="light-orange">&nbsp;</td>
        ...
        <td colspan="2" align="center" class="tabdata"> <font color="#000000"><B>PORT</B></font>
        </td>
		<td align="center" class="tabdata"> <font color="#000000"><B>PVID</B></font>
        </td>
		<td align="left" class="tabdata"> <font color="#000000"><B>TAG</B></font>
        </td>
      </tr>
	  <tr> 
        <td class="light-orange">&nbsp;</td>
      ...
      <tr> 
        <td class="light-orange">&nbsp;</td>
        <td class="light-orange"></td>
        <td width="199" class="tabdata"><div align="right"><font color="#000000">ATM 
            VC #0</font> 
            ...
            <font color="#000000">No</font></div></td>
      ...
      <tr > 
        <td class="light-orange">&nbsp;</td>
        <td class="light-orange"></td>
        <td class="tabdata"><div align="right"><font color="#000000">VC #1</font>
      ...
      <tr> 
        <td class="light-orange">&nbsp;</td>
        <td class="light-orange"></td>
        <td class="tabdata"><div align="right"> VC #2 
      ...
      <tr> 
        <td class="light-orange">&nbsp;</td>
        <td class="light-orange"></td>
        <td class="tabdata"><div align="right"> VC #3 
      ...
      <tr> 
        <td class="light-orange">&nbsp;</td>
        <td class="light-orange"></td>
        <td class="tabdata"><div align="right"> VC #4 
      ...
      <tr> 
        ...
        <td class="light-orange"></td>
        <td class="tabdata"><div align="right"> VC #5 
      ...
      <tr> 
        <td class="light-orange">&nbsp;</td>
        <td class="light-orange"></td>
        <td class="tabdata"><div align="right"> VC #6 
      ...
      <tr> 
        <td class="light-orange">&nbsp;</td>
        <td class="light-orange"></td>
        <td class="tabdata"><div align="right"> VC #7 
      ...
      <tr> 
        <td class="light-orange">&nbsp;</td>
        <td class="light-orange"></td>
        <td class="tabdata"><div align="right"> Eth Port #1 
      ...
      <tr> 
        <td class="light-orange">&nbsp;</td>
        <td class="light-orange"></td>
        <td class="tabdata"><div align="right"> Port #2 
      ...
      <tr> 
        <td class="light-orange">&nbsp;</td>
        <td class="light-orange"></td>
        <td class="tabdata"><div align="right"> Port #3 
      ...
      <tr> 
        <td class="light-orange">&nbsp;</td>
        <td class="light-orange"></td>
        <td class="tabdata"><div align="right"> Port #4 
...
<%if tcwebApi_get("Info_Ether", "isUSBSupported","h")="Yes" then%>
      ...
      <tr> 
        <td class="light-orange">&nbsp;</td>
        <td class="light-orange"></td>
        <td class="tabdata"><div align="right"> USB 
...
<%end if%>
      ...
      <tr> 
        <td class="light-orange">&nbsp;</td>
        <td class="light-orange"></td>
        <td class="tabdata"><div align="right"> Wlan 
      ...
      <tr> 
        <td class="light-orange">&nbsp;</td>
        <td class="light-orange"></td>
        <td class="tabdata"><div align="right"> Wlan SSID #1 
            <INPUT TYPE="RADIO" NAME="SSID1_Active" VALUE="Yes" <% if tcWebApi_get("VlanTag_Entry", "r0sw", "h") = "Yes" then asp_Write("checked") end if%> onClick="wlan_init(0)">
            Yes 
            <INPUT TYPE="RADIO" NAME="SSID1_Active" VALUE="No" <% if tcWebApi_get("VlanTag_Entry", "r0sw", "h") = "No" then asp_Write("checked") end if%> onClick="wlan_init(1)">
            No </div></td>
...
<%if tcWebApi_get("WebCustom_Entry","isCZTrueSupported","h")<>"Yes" then%>
      <tr> 
        <td class="light-orange">&nbsp;</td>
        <td class="light-orange"></td>
        <td class="tabdata"><div align="right"> SSID #2 
...
<%if tcWebApi_get("WebCustom_Entry","isCZTrueSupported","h")<>"Yes" then%>
      ...
      <tr> 
        <td class="light-orange">&nbsp;</td>
        <td class="light-orange"></td>
        <td class="tabdata"><div align="right"> SSID #3 
...
<%if tcWebApi_get("WebCustom_Entry","isCZTrueSupported","h")<>"Yes" then%>
      ...
      <tr> 
        <td class="light-orange">&nbsp;</td>
        <td class="light-orange"></td>
        <td class="tabdata"><div align="right"> SSID #4 
...
<%if tcWebApi_get("WebCustom_Entry","havePtm","h") = "Yes" then%>
      ...
      <tr> 
        <td class="light-orange">&nbsp;</td>
        <td class="light-orange"></td>
        <td width="199" class="tabdata"><div align="right"><font color="#000000">PTM 
            Barrier #0</font> 
      ...
      <tr> 
        <td class="light-orange">&nbsp;</td>
        <td class="light-orange"></td>
        <td class="tabdata"><div align="right"> Barrier #1 
...
<%if tcWebApi_get("WebCustom_Entry","haveWan0","h") = "Yes" then%>
      ...
      <tr> 
        <td class="light-orange">&nbsp;</td>
        <td class="light-orange"></td>
        <td width="199" class="tabdata"><div align="right"><font color="#000000">WAN0 
            Port #0</font> 
...
<table width="760" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
  <tr>
    ...
    <td width="440" class="orange">
    	<input type="button" name="vlan_pvid_apply" value="APPLY" onClick="vlantag_save();">
        <input type="reset"  name="vlan_pvid_cancel" value="CANCEL">
