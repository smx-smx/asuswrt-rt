...
} const known_service_types[] =
{
    ...
    /*{"urn:schemas-upnp-org:device:WANConnectionDevice:", 1, uuidvalue_wcd},  // Andy Chiu  */
    {"urn:schemas-upnp-org:device:WANConnectionDevice:", WANIPC_VER, uuidvalue_wcd},  // Andy Chiu
    /*{"urn:schemas-upnp-org:device:WANDevice:", 1, uuidvalue_wan},  // Andy Chiu  */
    {"urn:schemas-upnp-org:device:WANDevice:", WANIPC_VER, uuidvalue_wan},  // Andy Chiu
    {"urn:schemas-upnp-org:service:WANCommonInterfaceConfig:", 1, uuidvalue_wan},  // Andy Chiu  
    /*{"urn:schemas-upnp-org:service:WANCommonInterfaceConfig:", WANIPC_VER, uuidvalue_wan},  // Andy Chiu */
    ...
    /*{"url:schemas-upnp-org:service:WANIPv6FirewallControl:", 1, uuidvalue_wcd},  // Andy Chiu  */
    {"urn:schemas-upnp-org:service:WANIPv6FirewallControl:",  1, uuidvalue_wcd},   // Andy Chiu
#endif
#ifdef ENABLE_DP_SERVICE  // Andy Chiu
    {"urn:schemas-upnp-org:service:DeviceProtection:",  1, uuidvalue_igd},  // Andy Chiu
#endif    // Andy Chiu
	...
	else if(memcmp(bufr, "M-SEARCH", 8) == 0)
	{
		...
		/* only answer for service version lower or equal of supported one */
				   ...
				   )
				{
					 ...
					 * device implements ?œurn:schemas-upnporg:service:xyz:2??
					 * it MUST respond to search requests for both that type
					 * and ?œurn:schemas-upnp-org:service:xyz:1?? The response
