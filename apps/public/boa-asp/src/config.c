...
/* $Id: //BBN_Linux/Branch/Branch_for_SDK_Release_MultiChip_20111013/tclinux_phoenix/apps/public/boa-asp/src/config.c#2 $*/
...
struct ccommand clist[] = {
    ...
    /*pork 20090309 added*/
    {"Charset", S1A, c_set_string, &charset},
