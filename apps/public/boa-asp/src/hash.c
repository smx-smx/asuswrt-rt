...
/* $Id: //BBN_Linux/Branch/Branch_for_SDK_Release_MultiChip_20111013/tclinux_phoenix/apps/public/boa-asp/src/hash.c#1 $*/
...
char *get_mime_type(char *filename)
{
    ...
    /*Support romfile.cfg content-type*/	
    if(strcmp(extension,"cfg") == 0){
		return CFG_TYPE;
    }
	
#ifdef TCSUPPORT_SYSLOG_ENHANCE
	if(strcmp(extension,"xlog") == 0){
		return CFG_TYPE;
    }
#endif
