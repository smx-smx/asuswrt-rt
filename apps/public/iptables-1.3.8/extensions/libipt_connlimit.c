...
#include "../include/linux/netfilter_ipv4/ipt_connlimit.h"

#define xt_entry_match ipt_entry_match
#define xtables_rule_match iptables_rule_match
#define xtables_match iptables_match
#define xtables_target iptables_target
#define xt_tryload ipt_tryload
#define xt_connlimit_info ipt_connlimit_info
...
static void connlimit_init(struct xt_entry_match *match, unsigned int *nfcache)
{
...
*/
static void connlimit_print4(const struct ipt_ip *ip,
...
*/
static void connlimit_save4(const struct ipt_ip *ip, const struct xt_entry_match *match)
{
	const struct xt_connlimit_info *info = (const void *)match->data;
