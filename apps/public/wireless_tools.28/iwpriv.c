...
#include <linux/byteorder/big_endian.h> //Ren

//for tcapi_get series function
#include "libtcapi.h" //Ren
#include "tcapi.h" //Ren
#include "tcutils.h" //Ren
...
//Ren.B
#define WIFI_TRAFFIC_PATH "/tmp/wifi_traffic"
int showtraffic()
{
	struct iwreq wrq;
	int sfd, ret, i;
