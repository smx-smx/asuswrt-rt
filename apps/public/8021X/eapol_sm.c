...
#ifdef TCSUPPORT_WLAN_8021X_EXT
#ifdef TCSUPPORT_WLAN_8021X_EXT_SHOW_MAC
	sprintf(macaddress, MACSTR, MAC2STR(sm->sta->addr));
	syslog(LOG_INFO,LOG_8021X_EAP_FAIL,macaddress);
#else
	syslog(LOG_INFO,LOG_8021X_EAP_FAIL);
#endif
#endif
}
...
#ifdef TCSUPPORT_WLAN_8021X_EXT_SHOW_MAC
	sprintf(macaddress, MACSTR, MAC2STR(sm->sta->addr));
	syslog(LOG_INFO,LOG_8021X_EAP_REQUEST,macaddress);	
#else
	syslog(LOG_INFO,LOG_8021X_EAP_REQUEST);	
#endif
#endif
}
...
#ifdef TCSUPPORT_WLAN_8021X_EXT_SHOW_MAC
	sprintf(macaddress, MACSTR,MAC2STR(sm->sta->addr));
	syslog(LOG_INFO,LOG_8021X_RADIUS_REQUEST,macaddress);	
#else
	syslog(LOG_INFO,LOG_8021X_RADIUS_REQUEST);
#endif
#endif
}
...
#ifdef TCSUPPORT_WLAN_8021X_EXT_SHOW_MAC
	sprintf(macaddress, MACSTR,MAC2STR(sm->sta->addr));
	syslog(LOG_INFO,LOG_8021X_EAP_SUCCESS,macaddress);
#else
	syslog(LOG_INFO,LOG_8021X_EAP_SUCCESS);
#endif
#endif
}
