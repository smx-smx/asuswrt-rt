...
#ifdef TCSUPPORT_WLAN_8021X_EXT_SHOW_MAC
#define	LOG_8021X_SUPPLICANT_START		"802.1X: Supplicant EAPOL-Start: client mac = %s\n"
#define	LOG_8021X_SUPPLICANT_RESPONSE	"802.1X: Supplicant EAP-Response: client mac = %s\n"
#define	LOG_8021X_EAPOL_LOGOFF			"802.1X: EAPOL-Logoff: client mac = %s\n"
#define	LOG_8021X_RADIUS_REQUEST 		"802.1X: RADIUS Access-Request: client mac = %s\n"
#define	LOG_8021X_RADIUS_ACCEPT 			"802.1X: RADIUS Access-Accept: client mac = %s\n"
#define	LOG_8021X_RADIUS_REJECT			"802.1X: RADIUS Access-Reject: client mac = %s\n"
#define	LOG_8021X_RADIUS_CHALLENGE		"802.1X: RADIUS Access-Challenge: client mac = %s\n"
#define	LOG_8021X_EAP_REQUEST			"802.1X: EAP-Request: client mac = %s\n"
#define	LOG_8021X_EAP_SUCCESS			"802.1X: EAP-Success: client mac = %s\n"
#define	LOG_8021X_EAP_FAIL				"802.1X: EAP-Failure: client mac = %s\n"
#else
#define	LOG_8021X_SUPPLICANT_START		"802.1X: Supplicant EAPOL-Start\n"
#define	LOG_8021X_SUPPLICANT_RESPONSE	"802.1X: Supplicant EAP-Response\n"
#define	LOG_8021X_EAPOL_LOGOFF			"802.1X: EAPOL-Logoff\n"
#define	LOG_8021X_RADIUS_REQUEST		"802.1X: RADIUS Access-Request\n"
#define	LOG_8021X_RADIUS_ACCEPT			"802.1X: RADIUS Access-Accept\n"
#define	LOG_8021X_RADIUS_REJECT			"802.1X: RADIUS Access-Reject\n"
#define	LOG_8021X_RADIUS_CHALLENGE		"802.1X: RADIUS Access-Challenge\n"
#define	LOG_8021X_EAP_REQUEST			"802.1X: EAP-Request\n"
#define	LOG_8021X_EAP_SUCCESS			"802.1X: EAP-Success\n"
#define	LOG_8021X_EAP_FAIL				"802.1X: EAP-Failure\n"
#endif 
#endif
