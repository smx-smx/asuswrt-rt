...
/* for mii pre-auth syncmiimac = 0 */
#define OID_SYNCMIIMAC		                        0x062D
#define OID_SEND_PRE_AUTH   	                    0x062E
#define RT_OID_SEND_PRE_AUTH                  		(OID_GET_SET_TOGGLE | OID_SEND_PRE_AUTH)
