...
extern int32 aes_setup(const unsigned char *key, int32 keylen, int32 rounds,
					   aes_CBC *skey);
extern void	aes_ecb_encrypt(const unsigned char *pt, unsigned char *ct,
							aes_CBC *skey);
extern void	aes_ecb_decrypt(const unsigned char *ct, unsigned char *pt,
							aes_CBC *skey);
