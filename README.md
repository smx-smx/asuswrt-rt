# asuswrt-rt
Asus OpenSource release for Ralink modems

This repository keeps track of ASUS firmware changes

## DSL-N55U-D1 Information ##

N600 Modem/Router with built-in Trendchip modem.
```sh
# cat /proc/cpuinfo 
