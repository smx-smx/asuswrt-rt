...
static int cdrom_read_from_buffer (ide_drive_t *drive)
{
	...
	sectors_per_frame = queue_logical_block_size(q) >> SECTOR_BITS;
...
static ide_startstop_t cdrom_start_read_continuation (ide_drive_t *drive)
{
	...
	sectors_per_frame = queue_logical_block_size(drive->queue) >> SECTOR_BITS;
...
static ide_startstop_t cdrom_start_seek_continuation (ide_drive_t *drive)
{
	...
	sector_div(frame, queue_logical_block_size(drive->queue) >> SECTOR_BITS);
...
static ide_startstop_t cdrom_start_write(ide_drive_t *drive, struct request *rq)
{
	...
	unsigned short sectors_per_frame = queue_logical_block_size(drive->queue) >> SECTOR_BITS;
...
int ide_cdrom_setup (ide_drive_t *drive)
{
	 ...
	 */
	blk_queue_logical_block_size(drive->queue, CD_FRAMESIZE);
