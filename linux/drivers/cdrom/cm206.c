/* cm206.c. A linux-driver for the cm206 cdrom player with cm260 adapter card.
   ...
   $Id: //BBN_Linux/Branch/Branch_for_SDK_Release_MultiChip_20111013/tclinux_phoenix/linux/drivers/cdrom/cm206.c#1 $
...
int __init cm206_init(void)
{
	...
	blk_queue_logical_block_size(cm206_queue, 2048);
