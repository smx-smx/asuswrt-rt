...
/*      $Id: //BBN_Linux/Branch/Branch_for_SDK_Release_MultiChip_20111013/tclinux_phoenix/linux/drivers/cdrom/aztcd.c#1 $
...
static int __init aztcd_init(void)
{
	...
	blk_queue_logical_block_size(azt_queue, 2048);
