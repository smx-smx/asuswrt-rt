/*	linux/drivers/cdrom/optcd.c - Optics Storage 8000 AT CDROM driver
	$Id: //BBN_Linux/Branch/Branch_for_SDK_Release_MultiChip_20111013/tclinux_phoenix/linux/drivers/cdrom/optcd.c#1 $
...
static int __init optcd_init(void)
{
	...
	blk_queue_logical_block_size(opt_queue, 2048);
