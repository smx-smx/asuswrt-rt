...
/*Rodney_20091115 marked*//*#define NUM_NP	6*/		/* Number of NPs. */
 ...
 */
#if 0  /*Rodney_20091115 marked*/  /*move these definition from ppp_generic.c to ppp_channel.h*/
struct ppp_file {
	enum {
		INTERFACE=1, CHANNEL
	}		kind;
