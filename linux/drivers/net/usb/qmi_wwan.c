...
next_desc:
	...
	dev->net->open			= usbnet_open;
	dev->net->stop			= usbnet_stop;
	dev->net->hard_start_xmit	= usbnet_start_xmit;
	dev->net->tx_timeout		= usbnet_tx_timeout;
	dev->net->change_mtu		= usbnet_change_mtu;
	dev->net->set_mac_address	= qmi_wwan_mac_addr;
err:
	return status;
}
