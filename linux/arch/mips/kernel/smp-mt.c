...
void __init plat_prepare_cpus(unsigned int max_cpus)
{
	...
	if (cpu_has_vint) {
#ifdef CONFIG_MIPS_TC3262
		set_vi_handler(SI_SWINT_INT0, ipi_resched_dispatch);
		set_vi_handler(SI_SWINT_INT1, ipi_call_dispatch);
...
#ifdef CONFIG_MIPS_TC3262
	cpu_ipi_resched_irq = SI_SWINT_INT0;
	cpu_ipi_call_irq = SI_SWINT_INT1;
#else
