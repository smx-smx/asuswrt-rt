/* $Id: //BBN_Linux/Branch/Branch_for_SDK_Release_MultiChip_20111013/tclinux_phoenix/linux/arch/cris/arch-v10/kernel/fasttimer.c#1 $
 ...
 *
 * $Log: fasttimer.c,v $
 * Revision 1.1.1.1  2009/12/17 01:43:16  josephxu
