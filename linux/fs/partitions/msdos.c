...
static inline sector_t nr_sects(struct partition *p)
{
	...
	//patch for get_unaligned_le32 is not included, Sam 2013/5/28
	return (sector_t)le32_to_cpu(get_unaligned((__le32 *)&p->nr_sects));
}
...
static inline sector_t start_sect(struct partition *p)
{
	...
	//patch for get_unaligned_le32 is not included, Sam 2013/5/28
	return (sector_t)le32_to_cpu(get_unaligned((__le32 *)&p->start_sect));
}
