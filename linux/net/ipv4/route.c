 ...
 *
 * Version:	$Id: //BBN_Linux/Branch/Branch_for_SDK_Release_MultiChip_20111013/tclinux_phoenix/linux/net/ipv4/route.c#1 $
 *
 * Authors:	Ross Biro
...
__DMEM static struct rt_hash_bucket 	*rt_hash_table;
__DMEM static unsigned			rt_hash_mask;
__DMEM static int			rt_hash_log;
__DMEM static unsigned int		rt_hash_rnd;
...
__IMEM static unsigned int rt_hash_code(u32 daddr, u32 saddr)
{
...
__IMEM int ip_route_input(struct sk_buff *skb, __be32 daddr, __be32 saddr,
		   u8 tos, struct net_device *dev)
{
	struct rtable * rth;
	unsigned	hash;
