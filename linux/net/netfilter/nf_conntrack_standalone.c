...
static ctl_table nf_ct_sysctl_table[] = {
	...
	{
		.ctl_name	= NET_NF_CONNTRACK_FTP_ENABLE,
	...
	{
		.ctl_name	= NET_NF_CONNTRACK_SIP_ENABLE,
	...
	{
		.ctl_name	= NET_NF_CONNTRACK_H323_ENABLE,
	...
	{
		.ctl_name	= NET_NF_CONNTRACK_RTSP_ENABLE,
	...
	{
		.ctl_name	= NET_NF_CONNTRACK_L2TP_ENABLE,
	...
	{
		.ctl_name	= NET_NF_CONNTRACK_IPSEC_ENABLE,
	...
	{
		.ctl_name	= NET_NF_FULLCONE_ENABLE,
		.procname	= "nf_fullcone_enable",
		.data		= &nf_fullcone_enable,
		.maxlen		= sizeof(int),
		.mode		= 0644,
		.proc_handler	= &proc_dointvec,
	},	//for full cone switch	
	{ .ctl_name = 0 }
};
