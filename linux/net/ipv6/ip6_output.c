 ...
 *
 *	$Id: //BBN_Linux/Branch/Branch_for_SDK_Release_MultiChip_20111013/tclinux_phoenix/linux/net/ipv6/ip6_output.c#1 $
 *
...
{
	struct inet6_dev *idev = ip6_dst_idev(skb->dst);
	if (unlikely(idev->cnf.disable_ipv6) || ipv6_devconf.disable_ipv6) {
		IP6_INC_STATS(idev,
