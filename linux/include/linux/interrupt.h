...
#define CONFIG_TC_SOFTIRQ_BASE_RT_PRIO	100
#define CONFIG_TC_SOFTIRQ_BASE_RT_NICE	-5
#define CONFIG_TC_SOFTIRQ_TX_RT_PRIO	1
#define CONFIG_TC_SOFTIRQ_TX_RT_NICE	-18
#define CONFIG_TC_SOFTIRQ_RX_RT_PRIO	100
#define CONFIG_TC_SOFTIRQ_RX_RT_NICE	-20
