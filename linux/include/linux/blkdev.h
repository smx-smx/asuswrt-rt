...
extern void blk_queue_logical_block_size(request_queue_t *, unsigned short);
...
static inline int queue_logical_block_size(request_queue_t *q)
{
	int retval = 512;
...
static inline int bdev_logical_block_size(struct block_device *bdev)
{
